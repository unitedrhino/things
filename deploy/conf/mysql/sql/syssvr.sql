...
INSERT IGNORE INTO sys_api (route, `method`, name, businessType, `desc`, `group`) VALUES('/api/v1/things/product/custom/read',2,'获取产品自定义信息',4,'','产品自定义信息');
INSERT IGNORE INTO sys_api (route, `method`, name, businessType, `desc`, `group`) VALUES('/api/v1/things/product/custom/update',2,'更新产品自定义信息',2,'','产品自定义信息');
...
INSERT IGNORE INTO casbin_rule (p_type, v0, v1, v2, v3, v4, v5) VALUES('p','1','/api/v1/things/product/custom/read',2,'','','');
INSERT IGNORE INTO casbin_rule (p_type, v0, v1, v2, v3, v4, v5) VALUES('p','1','/api/v1/things/product/custom/update',2,'','','');
