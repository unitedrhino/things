...
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/remote-config/lastest-read','POST','获取最新配置','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/msg/property-latest/index','POST','获取最新属性','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/remote-config/push-all','POST','推送配置','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/msg/property-log/index','POST','获取单个id属性历史记录','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/interact/send-property','POST','同步调用设备属性','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/remote-config/create','POST','创建配置','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/remote-config/index','POST','获取配置列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/msg/sdk-log/index','POST','获取设备本地日志','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/msg/hub-log/index','POST','获取云端诊断日志','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/msg/event-log/index','POST','获取物模型事件历史记录','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/interact/send-action','POST','同步调用设备行为','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/interact/send-msg','POST','发送消息给设备','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/gateway/multi-create','POST','批量添加网关子设备','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/gateway/multi-delete','POST','批量解绑网关子设备','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/device/multi-create','POST','添加分组设备(支持批量)','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/device/multi-delete','POST','删除分组设备(支持批量)','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/role/role-menu/update','POST','更新角色对应菜单列表','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/info/update','POST','更新产品','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/info/create','POST','新增产品','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/info/read','POST','获取产品详情','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/info/delete','POST','删除产品','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/info/index','POST','获取产品列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/schema/index','POST','获取产品物模型列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/schema/tsl-import','POST','导入物模型tsl','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/schema/tsl-read','POST','获取产品物模型tsl','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/schema/create','POST','新增物模型功能','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/schema/update','POST','更新物模型功能','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/product/schema/delete','POST','删除物模型功能','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/info/create','POST','创建分组','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/info/index','POST','获取分组列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/info/read','POST','获取分组详情信息','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/info/update','POST','更新分组信息','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/info/delete','POST','删除分组','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/group/device/index','POST','获取分组设备列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/info/index','POST','获取设备列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/info/read','POST','获取设备详情','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/info/create','POST','新增设备','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/info/delete','POST','删除设备','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/info/update','POST','更新设备','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/info/count','POST','设备统计详情','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/auth/login','POST','设备登录认证','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/auth/root-check','POST','鉴定mqtt账号root权限','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/auth/access','POST','设备操作认证','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/things/device/gateway/index','POST','获取子设备列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/log/login/index','POST','获取登录日志列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/log/oper/index','POST','获取操作日志列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/role/create','POST','添加角色','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/role/index','POST','获取角色列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/role/update','POST','更新角色','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/role/delete','POST','删除角色','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/menu/create','POST','添加菜单','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/menu/index','POST','获取菜单列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/menu/update','POST','更新菜单','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/menu/delete','POST','删除菜单','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/create','POST','创建用户信息','1','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/captcha','POST','获取验证码','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/login','POST','登录','5','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/delete','POST','删除用户','3','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/read','POST','获取用户信息','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/update','POST','更新用户基本数据','2','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/index','POST','获取用户信息列表','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/user/resource-read','POST','获取用户资源','4','');
INSERT INTO sys_api (route, `method`, name, businessType, `desc`) VALUES('/api/v1/system/common/config','POST','获取系统配置','4','');