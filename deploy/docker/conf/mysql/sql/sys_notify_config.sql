...
INSERT INTO sys_notify_config (id, `group`, code, name, support_types, `desc`, is_record, params, created_time, updated_time, created_by, deleted_by, updated_by, deleted_time, enable_types) VALUES (1, 'captcha', 'sysUserRegisterCaptcha', '用户注册验证码', '["sms","email"]', '', 2, '{"code":"验证码code"}', '2024-06-17 13:35:58.172', '2024-06-27 22:48:05.925', 0, 0, 1740358057038188544, 0, '["sms"]');
INSERT INTO sys_notify_config (id, `group`, code, name, support_types, `desc`, is_record, params, created_time, updated_time, created_by, deleted_by, updated_by, deleted_time, enable_types) VALUES (2, 'captcha', 'sysUserLoginCaptcha', '用户登录验证码', '["sms","email"]', '', 2, '{"code":"验证码code"}', '2024-06-17 13:35:58.172', '2024-07-29 19:52:55.995', 0, 0, 1740358057038188544, 0, '["sms"]');
INSERT INTO sys_notify_config (id, `group`, code, name, support_types, `desc`, is_record, params, created_time, updated_time, created_by, deleted_by, updated_by, deleted_time, enable_types) VALUES (3, 'device', 'ruleScene', '场景联动通知', '["sms","email","dingTalk"]', '', 1, '{"body":"通知的内容"}', '2024-06-17 13:35:58.172', '2024-06-17 13:35:58.172', 0, 0, 0, 0, '[]');
INSERT INTO sys_notify_config (id, `group`, code, name, support_types, `desc`, is_record, params, created_time, updated_time, created_by, deleted_by, updated_by, deleted_time, enable_types) VALUES (4, 'device', 'ruleDeviceAlarm', '设备告警通知', '["sms","email","dingTalk"]', '', 1, '{"body":"通知的内容"}', '2024-06-17 13:35:58.172', '2024-06-17 13:35:58.172', 0, 0, 0, 0, '[]');
