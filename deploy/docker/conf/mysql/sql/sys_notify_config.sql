...
INSERT INTO iThings.sys_notify_config (id, `group`, code, name, support_types, `desc`, is_record, params, created_time, updated_time, created_by, deleted_by, updated_by, deleted_time, enable_types) VALUES (11, 'captcha', 'sysUserChangePwdCaptcha', '用户修改密码', '["sms","email"]', '', 2, '{"code":"验证码","expr":"过期时间"}', '2024-10-15 17:38:37.035', '2024-10-15 21:39:51.210', 1740358057038188544, 0, 1740358057038188544, 0, '["email"]');
