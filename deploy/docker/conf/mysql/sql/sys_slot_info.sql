...
INSERT INTO iThings.sys_slot_info (id, code, sub_code, slot_code, method, uri, hosts, body, handler, auth_type, `desc`, created_time, created_by, updated_time, updated_by, deleted_time, deleted_by) VALUES (1, 'areaInfo', 'create', 'ithings', 'POST', '/api/v1/things/slot/area/create', '["http://localhost:7777"]', '{"projectID":"{{.ProjectID}}","areaID":"{{.AreaID}}","parentAreaID":"{{.ParentAreaID}}"}', '{}', 'core', '', '2024-04-19 17:48:48.262', 0, '2024-04-19 17:48:48.262', 0, 0, 0);
INSERT INTO iThings.sys_slot_info (id, code, sub_code, slot_code, method, uri, hosts, body, handler, auth_type, `desc`, created_time, created_by, updated_time, updated_by, deleted_time, deleted_by) VALUES (2, 'areaInfo', 'delete', 'ithings', 'POST', '/api/v1/things/slot/area/delete', '["http://localhost:7777"]', '{"projectID":"{{.ProjectID}}","areaID":"{{.AreaID}}","parentAreaID":"{{.ParentAreaID}}"}', '{}', 'core', '', '2024-04-19 17:48:48.262', 0, '2024-04-19 17:48:48.262', 0, 0, 0);
INSERT INTO iThings.sys_slot_info (id, code, sub_code, slot_code, method, uri, hosts, body, handler, auth_type, `desc`, created_time, created_by, updated_time, updated_by, deleted_time, deleted_by) VALUES (3, 'userSubscribe', 'devicePropertyReport', 'ithings', 'POST', '/api/v1/things/slot/user/subscribe', '["http://localhost:7777"]', '', '{}', 'core', '', '2024-04-19 17:48:48.262', 0, '2024-04-19 17:48:48.262', 0, 0, 0);
INSERT INTO iThings.sys_slot_info (id, code, sub_code, slot_code, method, uri, hosts, body, handler, auth_type, `desc`, created_time, created_by, updated_time, updated_by, deleted_time, deleted_by) VALUES (4, 'userSubscribe', 'deviceConn', 'ithings', 'POST', '/api/v1/things/slot/user/subscribe', '["http://localhost:7777"]', '', '{}', 'core', '', '2024-04-19 17:48:48.262', 0, '2024-04-19 17:48:48.262', 0, 0, 0);
INSERT INTO iThings.sys_slot_info (id, code, sub_code, slot_code, method, uri, hosts, body, handler, auth_type, `desc`, created_time, created_by, updated_time, updated_by, deleted_time, deleted_by) VALUES (219, 'userSubscribe', 'deviceOtaReport', 'ithings', 'POST', '/api/v1/things/slot/user/subscribe', '["http://localhost:7777"]', '', '{}', 'core', '', '2024-04-19 17:48:48.000', 0, '2024-04-19 17:48:48.000', 0, 0, 0);
