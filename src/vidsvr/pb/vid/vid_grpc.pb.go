...
func (c *vidmgrConfigMangeClient) VidmgrConfigIndex(ctx context.Context, in *VidmgrConfigIndexReq, opts ...grpc.CallOption) (*VidmgrConfigIndexResp, error) {
...
func (UnimplementedVidmgrConfigMangeServer) VidmgrConfigIndex(context.Context, *VidmgrConfigIndexReq) (*VidmgrConfigIndexResp, error) {
...
func _VidmgrConfigMange_VidmgrConfigIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VidmgrConfigMangeServer).VidmgrConfigIndex(ctx, req.(*VidmgrConfigIndexReq))
	}
	return interceptor(ctx, in, info, handler)
}
