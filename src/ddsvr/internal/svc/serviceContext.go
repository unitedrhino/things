...
func NewServiceContext(c config.Config) *ServiceContext {
	...
	scriptCache := cache.NewScriptRepo(func(ctx context.Context, productID string) (info *script.Info, err error) {
		ret, err := productM.ProductScriptRead(ctx, &dm.ProductScriptReadReq{ProductID: productID})
		if err != nil {
