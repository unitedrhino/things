...
func (m *defaultUserInfoModel) Insert(data UserInfo) (sql.Result, error) {
	...
	ret, err := m.ExecNoCache(query, data.Uid, data.NickName, data.InviterUid, data.InviterId, data.Sex, data.City, data.Country, data.Province, data.Language, data.Headimgurl, data.CreatedTime, data.UpdatedTime, data.DeletedTime)
...
func (m *defaultUserInfoModel) Update(data UserInfo) error {
	...
	_, err := m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.Exec(query, data.NickName, data.InviterUid, data.InviterId, data.Sex, data.City, data.Country, data.Province, data.Language, data.Headimgurl, data.CreatedTime, data.UpdatedTime, data.DeletedTime, data.Uid)
	}, userInfoUidKey)
	return err
}
