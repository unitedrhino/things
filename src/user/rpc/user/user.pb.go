...
type RegisterCoreResp struct {
	...
	Token *JwtToken `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` //用于第二步注册的token
}
...
func (x *RegisterCoreResp) GetToken() *JwtToken {
	if x != nil {
		return x.Token
	}
	return nil
...
type Register2Req struct {
	...
	Token    string    `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"` //注册用的token
...
func (x *Register2Req) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type LoginReq struct {
	...
	UserID    string `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`       //登录账号(支持用户名,手机号登录)
	PwdType   int32  `protobuf:"varint,2,opt,name=pwdType,proto3" json:"pwdType,omitempty"`    //账号密码登录时需要填写.1，明文 2，md5加密 3,无密码
	Password  string `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`   //密码，需要md5转换 短信登录方式为空
	LoginType string `protobuf:"bytes,4,opt,name=loginType,proto3" json:"loginType,omitempty"` //验证类型 sms 短信验证码 img 图形验证码加账号密码登录 wxopen 微信开放平台登录 wxin 微信内登录
...
var file_user_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x22, 0x4a, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f,
	0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x24, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x4a,
	0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x80,
	0x01, 0x0a, 0x0c, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x32, 0x52, 0x65, 0x71, 0x12,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x22, 0x0a,
	0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x22, 0x0f, 0x0a, 0x0d, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x32, 0x52, 0x65,
	0x73, 0x70, 0x22, 0x22, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66,
	...
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x22, 0x0a, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55,
	0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0xa2, 0x01,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x32, 0x9a, 0x02, 0x0a, 0x04, 0x55,
	...
	,
	...
	0x0a, 0x0a, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x13, 0x2e, 0x75,
...
var file_user_proto_depIdxs = []int32{
	0,  // 0: user.RegisterCoreResp.token:type_name -> user.JwtToken
	1,  // 1: user.Register2Req.info:type_name -> user.UserInfo
	1,  // 2: user.GetUserInfoResp.info:type_name -> user.UserInfo
	1,  // 3: user.LoginResp.info:type_name -> user.UserInfo
	0,  // 4: user.LoginResp.token:type_name -> user.JwtToken
	8,  // 5: user.User.login:input_type -> user.LoginReq
	2,  // 6: user.User.registerCore:input_type -> user.RegisterCoreReq
	4,  // 7: user.User.register2:input_type -> user.Register2Req
	6,  // 8: user.User.getUserInfo:input_type -> user.GetUserInfoReq
	10, // 9: user.User.CheckToken:input_type -> user.CheckTokenReq
	9,  // 10: user.User.login:output_type -> user.LoginResp
	3,  // 11: user.User.registerCore:output_type -> user.RegisterCoreResp
	5,  // 12: user.User.register2:output_type -> user.Register2Resp
	7,  // 13: user.User.getUserInfo:output_type -> user.GetUserInfoResp
	11, // 14: user.User.CheckToken:output_type -> user.CheckTokenResp
