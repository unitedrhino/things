...
type DeviceInfoReadReq struct {
	...
	ProductID  string `protobuf:"bytes,1,opt,name=productID,proto3" json:"productID,omitempty"`   //产品id
	DeviceName string `protobuf:"bytes,2,opt,name=deviceName,proto3" json:"deviceName,omitempty"` //设备名称
	Coordinate string `protobuf:"bytes,3,opt,name=coordinate,proto3" json:"coordinate,omitempty"` //坐标系
}
...
func (x *DeviceInfoReadReq) GetCoordinate() string {
	if x != nil {
		return x.Coordinate
	}
	return ""
...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x22, 0x71, 0x0a, 0x11, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e,
	0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6f, 0x72, 0x64,
	0x69, 0x6e, 0x61, 0x74, 0x65, 0x22, 0xa0, 0x02, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	...
	0x32, 0xe1, 0x05, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4d, 0x61, 0x6e, 0x61,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	7,  // 24: dm.ProductInfoIndexReq.page:type_name -> dm.PageInfo
	...
	7,  // 27: dm.DeviceInfoIndexReq.page:type_name -> dm.PageInfo
	...
	7,  // 33: dm.ProductSchemaIndexReq.page:type_name -> dm.PageInfo
	...
	1,  // 70: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	2,  // 71: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	4,  // 72: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	5,  // 73: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	8,  // 74: dm.DeviceAuth.loginAuth:output_type -> dm.Response
	8,  // 75: dm.DeviceAuth.accessAuth:output_type -> dm.Response
	8,  // 76: dm.DeviceAuth.rootCheck:output_type -> dm.Response
	8,  // 77: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Response
	8,  // 78: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Response
	8,  // 79: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Response
	...
	8,  // 82: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Response
	11, // 83: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	8,  // 84: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Response
	...
	8,  // 87: dm.ProductManage.productInfoCreate:output_type -> dm.Response
	8,  // 88: dm.ProductManage.productInfoUpdate:output_type -> dm.Response
	8,  // 89: dm.ProductManage.productInfoDelete:output_type -> dm.Response
	...
	8,  // 92: dm.ProductManage.productSchemaUpdate:output_type -> dm.Response
	8,  // 93: dm.ProductManage.productSchemaCreate:output_type -> dm.Response
	8,  // 94: dm.ProductManage.productSchemaDelete:output_type -> dm.Response
	43, // 95: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	8,  // 96: dm.ProductManage.productSchemaTslImport:output_type -> dm.Response
	47, // 97: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	8,  // 98: dm.DeviceGroup.groupInfoCreate:output_type -> dm.Response
	...
	8,  // 101: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Response
	8,  // 102: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Response
	8,  // 103: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Response
	22, // 104: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	8,  // 105: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Response
	8,  // 106: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Response
	3,  // 107: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	8,  // 108: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Response
	6,  // 109: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
