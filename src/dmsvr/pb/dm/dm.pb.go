...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x82, 0x01, 0x0a, 0x17, 0x44, 0x65, 0x76,
	...
	0x73, 0x70, 0x32, 0xe1, 0x05, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4d, 0x61,
	...
	0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x32, 0x84, 0x04, 0x0a, 0x0b, 0x44, 0x65, 0x76, 0x69, 0x63,
	...
	0x61, 0x73, 0x74, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x42, 0x07, 0x5a, 0x05, 0x70,
...
var file_proto_dm_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_proto_dm_proto_goTypes = []interface{}{
	...
	(*PageInfo_OrderBy)(nil),            // 54: dm.PageInfo.OrderBy
	nil,                                 // 55: dm.GroupInfo.TagsEntry
	nil,                                 // 56: dm.GroupInfoIndexReq.TagsEntry
	nil,                                 // 57: dm.GroupInfoUpdateReq.TagsEntry
	nil,                                 // 58: dm.DeviceInfo.TagsEntry
	nil,                                 // 59: dm.ProductInfo.TagsEntry
	nil,                                 // 60: dm.ProductInfoIndexReq.TagsEntry
	nil,                                 // 61: dm.DeviceInfoIndexReq.TagsEntry
	(*wrapperspb.StringValue)(nil),      // 62: google.protobuf.StringValue
}
var file_proto_dm_proto_depIdxs = []int32{
	54, // 0: dm.PageInfo.orders:type_name -> dm.PageInfo.OrderBy
	...
	10, // 4: dm.DeviceGatewayBindDevice.sign:type_name -> dm.DeviceGatewaySign
	9,  // 5: dm.DeviceGatewayMultiCreateReq.list:type_name -> dm.DeviceGatewayBindDevice
	1,  // 6: dm.DeviceGatewayIndexReq.page:type_name -> dm.PageInfo
	27, // 7: dm.DeviceGatewayIndexResp.list:type_name -> dm.DeviceInfo
	34, // 8: dm.DeviceGatewayMultiDeleteReq.list:type_name -> dm.DeviceCore
	55, // 9: dm.GroupInfo.tags:type_name -> dm.GroupInfo.TagsEntry
	1,  // 10: dm.GroupInfoIndexReq.page:type_name -> dm.PageInfo
	56, // 11: dm.GroupInfoIndexReq.tags:type_name -> dm.GroupInfoIndexReq.TagsEntry
	15, // 12: dm.GroupInfoIndexResp.list:type_name -> dm.GroupInfo
	15, // 13: dm.GroupInfoIndexResp.listAll:type_name -> dm.GroupInfo
	57, // 14: dm.GroupInfoUpdateReq.tags:type_name -> dm.GroupInfoUpdateReq.TagsEntry
	34, // 15: dm.GroupDeviceMultiCreateReq.list:type_name -> dm.DeviceCore
	1,  // 16: dm.GroupDeviceIndexReq.page:type_name -> dm.PageInfo
	27, // 17: dm.GroupDeviceIndexResp.list:type_name -> dm.DeviceInfo
	34, // 18: dm.GroupDeviceMultiDeleteReq.list:type_name -> dm.DeviceCore
	62, // 19: dm.DeviceInfo.version:type_name -> google.protobuf.StringValue
	58, // 20: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	62, // 21: dm.DeviceInfo.address:type_name -> google.protobuf.StringValue
	26, // 22: dm.DeviceInfo.Position:type_name -> dm.Point
	62, // 23: dm.ProductInfo.desc:type_name -> google.protobuf.StringValue
	62, // 24: dm.ProductInfo.devStatus:type_name -> google.protobuf.StringValue
	59, // 25: dm.ProductInfo.tags:type_name -> dm.ProductInfo.TagsEntry
	1,  // 26: dm.ProductInfoIndexReq.page:type_name -> dm.PageInfo
	60, // 27: dm.ProductInfoIndexReq.tags:type_name -> dm.ProductInfoIndexReq.TagsEntry
	28, // 28: dm.ProductInfoIndexResp.list:type_name -> dm.ProductInfo
	1,  // 29: dm.DeviceInfoIndexReq.page:type_name -> dm.PageInfo
	61, // 30: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	26, // 31: dm.DeviceInfoIndexReq.Position:type_name -> dm.Point
	27, // 32: dm.DeviceInfoIndexResp.list:type_name -> dm.DeviceInfo
	46, // 33: dm.ProductSchemaUpdateReq.info:type_name -> dm.ProductSchemaInfo
	46, // 34: dm.ProductSchemaCreateReq.info:type_name -> dm.ProductSchemaInfo
	1,  // 35: dm.ProductSchemaIndexReq.page:type_name -> dm.PageInfo
	46, // 36: dm.ProductSchemaIndexResp.list:type_name -> dm.ProductSchemaInfo
	62, // 37: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	62, // 38: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	62, // 39: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	38, // 40: dm.DeviceAuth.loginAuth:input_type -> dm.LoginAuthReq
	39, // 41: dm.DeviceAuth.accessAuth:input_type -> dm.AccessAuthReq
	40, // 42: dm.DeviceAuth.rootCheck:input_type -> dm.RootCheckReq
	27, // 43: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	27, // 44: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	33, // 45: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	36, // 46: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	35, // 47: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	11, // 48: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	12, // 49: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	14, // 50: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiDeleteReq
	50, // 51: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	51, // 52: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	28, // 53: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	28, // 54: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	29, // 55: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	31, // 56: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	30, // 57: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	41, // 58: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	42, // 59: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	43, // 60: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	44, // 61: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	47, // 62: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	48, // 63: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	16, // 64: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfoCreateReq
	17, // 65: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	19, // 66: dm.DeviceGroup.groupInfoRead:input_type -> dm.GroupInfoReadReq
	20, // 67: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfoUpdateReq
	21, // 68: dm.DeviceGroup.groupInfoDelete:input_type -> dm.GroupInfoDeleteReq
	22, // 69: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiCreateReq
	23, // 70: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	25, // 71: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	3,  // 72: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	4,  // 73: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	6,  // 74: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	7,  // 75: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	0,  // 76: dm.DeviceAuth.loginAuth:output_type -> dm.Response
	0,  // 77: dm.DeviceAuth.accessAuth:output_type -> dm.Response
	0,  // 78: dm.DeviceAuth.rootCheck:output_type -> dm.Response
	0,  // 79: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Response
	0,  // 80: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Response
	0,  // 81: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Response
	37, // 82: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	27, // 83: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,  // 84: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Response
	13, // 85: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,  // 86: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Response
	52, // 87: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCountResp
	53, // 88: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	0,  // 89: dm.ProductManage.productInfoCreate:output_type -> dm.Response
	0,  // 90: dm.ProductManage.productInfoUpdate:output_type -> dm.Response
	0,  // 91: dm.ProductManage.productInfoDelete:output_type -> dm.Response
	32, // 92: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	28, // 93: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	...
	18, // 101: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	15, // 102: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	...
	24, // 106: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
