...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x0a, 0x0d, 0x4f, 0x74, 0x61, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x32,
	0xc2, 0x05, 0x0a, 0x0c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x12, 0x2b, 0x0a, 0x09, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x10, 0x2e,
	...
	0x73, 0x65, 0x32, 0x5a, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x4d, 0x61,
	...
	0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73, 0x70, 0x32, 0x84,
	0x04, 0x0a, 0x0b, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x37,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0e, 0x67, 0x72, 0x6f, 0x75, 0x70,
	...
	0x0d, 0x2e, 0x64, 0x6d, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x37,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x0f, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x49, 0x6e, 0x66, 0x6f, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x16, 0x2e, 0x64, 0x6d, 0x2e,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52,
	0x65, 0x71, 0x1a, 0x0c, 0x2e, 0x64, 0x6d, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x45, 0x0a, 0x16, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d,
	0x75, 0x6c, 0x74, 0x69, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x2e, 0x64, 0x6d, 0x2e,
	...
	0x73, 0x70, 0x42, 0x07, 0x5a, 0x05, 0x70, 0x62, 0x2f, 0x64, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	59,  // 115: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiCreateReq
	60,  // 116: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	62,  // 117: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	37,  // 118: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	38,  // 119: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	40,  // 120: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	41,  // 121: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	20,  // 122: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	17,  // 123: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	11,  // 124: dm.DeviceMsg.propertyLatestIndex:input_type -> dm.PropertyLatestIndexReq
	10,  // 125: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	14,  // 126: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	11,  // 127: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLatestIndexReq
	34,  // 128: dm.DeviceMsg.otaPromptIndex:input_type -> dm.OtaPromptIndexReq
	23,  // 129: dm.DeviceInteract.sendAction:input_type -> dm.SendActionReq
	25,  // 130: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	27,  // 131: dm.DeviceInteract.respAction:input_type -> dm.RespActionReq
	8,   // 132: dm.DeviceInteract.getPropertyReply:input_type -> dm.GetPropertyReplyReq
	26,  // 133: dm.DeviceInteract.sendProperty:input_type -> dm.SendPropertyReq
	31,  // 134: dm.DeviceInteract.multiSendProperty:input_type -> dm.MultiSendPropertyReq
	25,  // 135: dm.DeviceInteract.propertyRead:input_type -> dm.RespReadReq
	29,  // 136: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	89,  // 137: dm.FirmwareManage.FirmwareInfoCreate:input_type -> dm.Firmware
	91,  // 138: dm.FirmwareManage.FirmwareInfoUpdate:input_type -> dm.FirmwareInfo
	93,  // 139: dm.FirmwareManage.FirmwareInfoDelete:input_type -> dm.FirmwareInfoDeleteReq
	95,  // 140: dm.FirmwareManage.FirmwareInfoIndex:input_type -> dm.FirmwareInfoIndexReq
	97,  // 141: dm.FirmwareManage.FirmwareInfoRead:input_type -> dm.FirmwareInfoReadReq
	98,  // 142: dm.FirmwareManage.OtaFirmwareFileUpdate:input_type -> dm.OtaFirmwareFileReq
	101, // 143: dm.FirmwareManage.OtaFirmwareFileIndex:input_type -> dm.OtaFirmwareFileIndexReq
	104, // 144: dm.FirmwareManage.OtaFirmwareDeviceInfo:input_type -> dm.OtaFirmwareDeviceInfoReq
	106, // 145: dm.OtaTaskManage.OtaTaskCreate:input_type -> dm.OtaTaskCreateReq
	108, // 146: dm.OtaTaskManage.OtaTaskUpdate:input_type -> dm.OtaTaskInfo
	109, // 147: dm.OtaTaskManage.OtaTaskCancle:input_type -> dm.OtaTaskCancleReq
	110, // 148: dm.OtaTaskManage.OtaTaskIndex:input_type -> dm.OtaTaskIndexReq
	112, // 149: dm.OtaTaskManage.OtaTaskRead:input_type -> dm.OtaTaskReadReq
	114, // 150: dm.OtaTaskManage.OtaTaskDeviceIndex:input_type -> dm.OtaTaskDeviceIndexReq
	117, // 151: dm.OtaTaskManage.OtaTaskDeviceRead:input_type -> dm.OtaTaskDeviceReadReq
	118, // 152: dm.OtaTaskManage.OtaTaskDeviceEnableBatch:input_type -> dm.OtaTaskBatchReq
	120, // 153: dm.OtaTaskManage.OtaTaskDeviceProcess:input_type -> dm.OtaTaskDeviceProcessReq
	121, // 154: dm.OtaTaskManage.OtaTaskDeviceCancle:input_type -> dm.OtaTaskDeviceCancleReq
	0,   // 155: dm.DeviceManage.rootCheck:output_type -> dm.Response
	0,   // 156: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Response
	0,   // 157: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Response
	0,   // 158: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Response
	74,  // 159: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	64,  // 160: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 161: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Response
	50,  // 162: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 163: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Response
	87,  // 164: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCountResp
	88,  // 165: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	0,   // 166: dm.ProductManage.productInfoCreate:output_type -> dm.Response
	0,   // 167: dm.ProductManage.productInfoUpdate:output_type -> dm.Response
	0,   // 168: dm.ProductManage.productInfoDelete:output_type -> dm.Response
	69,  // 169: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	65,  // 170: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 171: dm.ProductManage.productSchemaUpdate:output_type -> dm.Response
	0,   // 172: dm.ProductManage.productSchemaCreate:output_type -> dm.Response
	0,   // 173: dm.ProductManage.productSchemaDelete:output_type -> dm.Response
	80,  // 174: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 175: dm.ProductManage.productSchemaTslImport:output_type -> dm.Response
	84,  // 176: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	44,  // 177: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 178: dm.ProductManage.productCustomUpdate:output_type -> dm.Response
	4,   // 179: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	0,   // 180: dm.DeviceGroup.groupInfoCreate:output_type -> dm.Response
	55,  // 181: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	52,  // 182: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	...
	61,  // 186: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	...
	39,  // 189: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 190: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Response
	42,  // 191: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	21,  // 192: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	18,  // 193: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	13,  // 194: dm.DeviceMsg.propertyLatestIndex:output_type -> dm.PropertyIndexResp
	13,  // 195: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyIndexResp
	16,  // 196: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventIndexResp
	6,   // 197: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	35,  // 198: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	24,  // 199: dm.DeviceInteract.sendAction:output_type -> dm.SendActionResp
	24,  // 200: dm.DeviceInteract.actionRead:output_type -> dm.SendActionResp
	0,   // 201: dm.DeviceInteract.respAction:output_type -> dm.Response
	9,   // 202: dm.DeviceInteract.getPropertyReply:output_type -> dm.GetPropertyReplyResp
	28,  // 203: dm.DeviceInteract.sendProperty:output_type -> dm.SendPropertyResp
	33,  // 204: dm.DeviceInteract.multiSendProperty:output_type -> dm.MultiSendPropertyResp
	28,  // 205: dm.DeviceInteract.propertyRead:output_type -> dm.SendPropertyResp
	30,  // 206: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	...
	155, // [155:225] is the sub-list for method output_type
	85,  // [85:155] is the sub-list for method input_type
