...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x49, 0x44, 0x22, 0x89, 0x02, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xa0, 0x02, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69,
	...
	0x74, 0x61, 0x67, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x25, 0x0a, 0x08, 0x50, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x64,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	29, // 8: dm.DeviceGatewayIndexResp.list:type_name -> dm.DeviceInfo
	36, // 9: dm.DeviceGatewayMultiDeleteReq.list:type_name -> dm.DeviceCore
	57, // 10: dm.GroupInfo.tags:type_name -> dm.GroupInfo.TagsEntry
	1,  // 11: dm.GroupInfoIndexReq.page:type_name -> dm.PageInfo
	58, // 12: dm.GroupInfoIndexReq.tags:type_name -> dm.GroupInfoIndexReq.TagsEntry
	17, // 13: dm.GroupInfoIndexResp.list:type_name -> dm.GroupInfo
	17, // 14: dm.GroupInfoIndexResp.listAll:type_name -> dm.GroupInfo
	59, // 15: dm.GroupInfoUpdateReq.tags:type_name -> dm.GroupInfoUpdateReq.TagsEntry
	36, // 16: dm.GroupDeviceMultiCreateReq.list:type_name -> dm.DeviceCore
	1,  // 17: dm.GroupDeviceIndexReq.page:type_name -> dm.PageInfo
	29, // 18: dm.GroupDeviceIndexResp.list:type_name -> dm.DeviceInfo
	36, // 19: dm.GroupDeviceMultiDeleteReq.list:type_name -> dm.DeviceCore
	64, // 20: dm.DeviceInfo.version:type_name -> google.protobuf.StringValue
	60, // 21: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	64, // 22: dm.DeviceInfo.address:type_name -> google.protobuf.StringValue
	28, // 23: dm.DeviceInfo.Position:type_name -> dm.Point
	64, // 24: dm.ProductInfo.desc:type_name -> google.protobuf.StringValue
	64, // 25: dm.ProductInfo.devStatus:type_name -> google.protobuf.StringValue
	61, // 26: dm.ProductInfo.tags:type_name -> dm.ProductInfo.TagsEntry
	1,  // 27: dm.ProductInfoIndexReq.page:type_name -> dm.PageInfo
	62, // 28: dm.ProductInfoIndexReq.tags:type_name -> dm.ProductInfoIndexReq.TagsEntry
	30, // 29: dm.ProductInfoIndexResp.list:type_name -> dm.ProductInfo
	1,  // 30: dm.DeviceInfoIndexReq.page:type_name -> dm.PageInfo
	63, // 31: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	28, // 32: dm.DeviceInfoIndexReq.Position:type_name -> dm.Point
	29, // 33: dm.DeviceInfoIndexResp.list:type_name -> dm.DeviceInfo
	48, // 34: dm.ProductSchemaUpdateReq.info:type_name -> dm.ProductSchemaInfo
	48, // 35: dm.ProductSchemaCreateReq.info:type_name -> dm.ProductSchemaInfo
	1,  // 36: dm.ProductSchemaIndexReq.page:type_name -> dm.PageInfo
	48, // 37: dm.ProductSchemaIndexResp.list:type_name -> dm.ProductSchemaInfo
	64, // 38: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	64, // 39: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	64, // 40: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	40, // 41: dm.DeviceAuth.loginAuth:input_type -> dm.LoginAuthReq
	41, // 42: dm.DeviceAuth.accessAuth:input_type -> dm.AccessAuthReq
	42, // 43: dm.DeviceAuth.rootCheck:input_type -> dm.RootCheckReq
	29, // 44: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	29, // 45: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	35, // 46: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	38, // 47: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	37, // 48: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	13, // 49: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	14, // 50: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	16, // 51: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiDeleteReq
	52, // 52: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	53, // 53: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	30, // 54: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	30, // 55: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	31, // 56: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	33, // 57: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	32, // 58: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	43, // 59: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	44, // 60: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	45, // 61: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	46, // 62: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	49, // 63: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	50, // 64: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	9,  // 65: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	10, // 66: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	18, // 67: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfoCreateReq
	19, // 68: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	21, // 69: dm.DeviceGroup.groupInfoRead:input_type -> dm.GroupInfoReadReq
	22, // 70: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfoUpdateReq
	23, // 71: dm.DeviceGroup.groupInfoDelete:input_type -> dm.GroupInfoDeleteReq
	24, // 72: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiCreateReq
	25, // 73: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	27, // 74: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	3,  // 75: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	4,  // 76: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	6,  // 77: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	7,  // 78: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	0,  // 79: dm.DeviceAuth.loginAuth:output_type -> dm.Response
	0,  // 80: dm.DeviceAuth.accessAuth:output_type -> dm.Response
	0,  // 81: dm.DeviceAuth.rootCheck:output_type -> dm.Response
	0,  // 82: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Response
	0,  // 83: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Response
	0,  // 84: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Response
	39, // 85: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	29, // 86: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,  // 87: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Response
	15, // 88: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,  // 89: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Response
	54, // 90: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCountResp
	55, // 91: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	0,  // 92: dm.ProductManage.productInfoCreate:output_type -> dm.Response
	0,  // 93: dm.ProductManage.productInfoUpdate:output_type -> dm.Response
	0,  // 94: dm.ProductManage.productInfoDelete:output_type -> dm.Response
	34, // 95: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	30, // 96: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,  // 97: dm.ProductManage.productSchemaUpdate:output_type -> dm.Response
	0,  // 98: dm.ProductManage.productSchemaCreate:output_type -> dm.Response
	0,  // 99: dm.ProductManage.productSchemaDelete:output_type -> dm.Response
	47, // 100: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,  // 101: dm.ProductManage.productSchemaTslImport:output_type -> dm.Response
	51, // 102: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	10, // 103: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,  // 104: dm.ProductManage.productCustomUpdate:output_type -> dm.Response
	0,  // 105: dm.DeviceGroup.groupInfoCreate:output_type -> dm.Response
	20, // 106: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	17, // 107: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,  // 108: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Response
	0,  // 109: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Response
	0,  // 110: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Response
	26, // 111: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,  // 112: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Response
	0,  // 113: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Response
	5,  // 114: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,  // 115: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Response
	8,  // 116: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
