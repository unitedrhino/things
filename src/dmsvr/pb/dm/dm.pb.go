...
type DeviceInfoCountResp struct {
	...
	Unknown int64 `protobuf:"varint,3,opt,name=unknown,proto3" json:"unknown,omitempty"`
}
...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x52, 0x09, 0x64, 0x65, 0x76, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x34,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x22, 0x99, 0x01, 0x0a, 0x13, 0x50, 0x72, 0x6f,
	...
	0x74, 0x49, 0x44, 0x73, 0x22, 0x51, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49,
	...
	0x61, 0x0a, 0x13, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x43, 0x6f, 0x75,
	...
	0x07, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x6e, 0x6b, 0x6e,
	0x6f, 0x77, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x75, 0x6e, 0x6b, 0x6e, 0x6f,
	...
	0x54, 0x79, 0x70, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x32, 0xe1, 0x05,
	...
	0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x42, 0x07, 0x5a, 0x05, 0x70, 0x62, 0x2f, 0x64, 0x6d, 0x62,
...
var file_proto_dm_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_proto_dm_proto_goTypes = []interface{}{
	...
	nil,                                 // 55: dm.DeviceInfoIndexReq.TagsEntry
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	56, // 17: dm.DeviceInfo.version:type_name -> google.protobuf.StringValue
	54, // 18: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	56, // 19: dm.ProductInfo.desc:type_name -> google.protobuf.StringValue
	56, // 20: dm.ProductInfo.devStatus:type_name -> google.protobuf.StringValue
	...
	55, // 24: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	...
	56, // 30: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	56, // 31: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	56, // 32: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	...
	47, // 44: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	48, // 45: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	25, // 46: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	25, // 47: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	26, // 48: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	28, // 49: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	27, // 50: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	38, // 51: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	39, // 52: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	40, // 53: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	41, // 54: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	44, // 55: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	45, // 56: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	14, // 57: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfoCreateReq
	15, // 58: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	17, // 59: dm.DeviceGroup.groupInfoRead:input_type -> dm.GroupInfoReadReq
	18, // 60: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfoUpdateReq
	19, // 61: dm.DeviceGroup.groupInfoDelete:input_type -> dm.GroupInfoDeleteReq
	20, // 62: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiCreateReq
	21, // 63: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	23, // 64: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	1,  // 65: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	2,  // 66: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	4,  // 67: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	5,  // 68: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	8,  // 69: dm.DeviceAuth.loginAuth:output_type -> dm.Response
	8,  // 70: dm.DeviceAuth.accessAuth:output_type -> dm.Response
	8,  // 71: dm.DeviceAuth.rootCheck:output_type -> dm.Response
	8,  // 72: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Response
	8,  // 73: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Response
	8,  // 74: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Response
	34, // 75: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	24, // 76: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	8,  // 77: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Response
	11, // 78: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	8,  // 79: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Response
	49, // 80: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCountResp
	50, // 81: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	8,  // 82: dm.ProductManage.productInfoCreate:output_type -> dm.Response
	8,  // 83: dm.ProductManage.productInfoUpdate:output_type -> dm.Response
	8,  // 84: dm.ProductManage.productInfoDelete:output_type -> dm.Response
	29, // 85: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	25, // 86: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	8,  // 87: dm.ProductManage.productSchemaUpdate:output_type -> dm.Response
	8,  // 88: dm.ProductManage.productSchemaCreate:output_type -> dm.Response
	8,  // 89: dm.ProductManage.productSchemaDelete:output_type -> dm.Response
	42, // 90: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	8,  // 91: dm.ProductManage.productSchemaTslImport:output_type -> dm.Response
	46, // 92: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	8,  // 93: dm.DeviceGroup.groupInfoCreate:output_type -> dm.Response
	16, // 94: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	13, // 95: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	8,  // 96: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Response
	8,  // 97: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Response
	8,  // 98: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Response
	22, // 99: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	8,  // 100: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Response
	8,  // 101: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Response
	3,  // 102: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	8,  // 103: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Response
	6,  // 104: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
