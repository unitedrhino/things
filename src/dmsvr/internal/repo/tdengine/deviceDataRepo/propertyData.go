...
func (d *DeviceDataRepo) InsertPropertyData(ctx context.Context, t *thing.Template, productID string, deviceName string, property *deviceData.PropertyData) error {
...
func (d *DeviceDataRepo) InsertPropertiesData(ctx context.Context, t *thing.Template, productID string, deviceName string, params map[string]interface{}, timestamp time.Time) error {
