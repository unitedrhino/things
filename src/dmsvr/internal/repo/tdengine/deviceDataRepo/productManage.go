...
func (d *DeviceDataRepo) DropProduct(ctx context.Context, t *templateModel.Template, productID string) error {
...
func (d *DeviceDataRepo) InitProduct(ctx context.Context, t *templateModel.Template, productID string) error {
	if t != nil {
...
func (d *DeviceDataRepo) ModifyProperty(
	oldP *templateModel.Property,
	newP *templateModel.Property,
	productID string) error {
	if newP.Define.Type != templateModel.STRUCT {
		//不需要修改数据库
		return nil
	}
...
func (d *DeviceDataRepo) ModifyProduct(
	ctx context.Context, oldT *templateModel.Template, newt *templateModel.Template, productID string) error {
...
func (d *DeviceDataRepo) createPropertyStable(
	ctx context.Context, p *templateModel.Property, productID string) error {
	var sql string
	if p.Define.Type != templateModel.STRUCT {
