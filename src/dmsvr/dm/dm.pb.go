...
var file_dm_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x70, 0x22, 0xb9, 0x03, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x31, 0x0a, 0x11, 0x47,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x22, 0x39,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0xc2, 0x01, 0x0a, 0x0a, 0x44, 0x65,
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x6c, 0x61, 0x73, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x22, 0x47,
	...
	0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x50, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x44, 0x65,
	...
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x22, 0x37, 0x0a, 0x11, 0x47, 0x65, 0x74,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x22,
	0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x64,
	0x6d, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e,
	0x66, 0x6f, 0x32, 0xcc, 0x02, 0x0a, 0x02, 0x44, 0x6d, 0x12, 0x2b, 0x0a, 0x09, 0x6c, 0x6f, 0x67,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x2e, 0x64, 0x6d, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x1a, 0x15, 0x2e, 0x64, 0x6d, 0x2e,
...
var file_dm_proto_depIdxs = []int32{
	...
	4,  // 2: dm.ManageProductReq.info:type_name -> dm.ProductInfo
	4,  // 3: dm.GetProductInfoResp.info:type_name -> dm.ProductInfo
	8,  // 4: dm.ManageDeviceReq.info:type_name -> dm.DeviceInfo
	8,  // 5: dm.GetDeviceInfoResp.info:type_name -> dm.DeviceInfo
	2,  // 6: dm.Dm.loginAuth:input_type -> dm.LoginAuthReq
	3,  // 7: dm.Dm.accessAuth:input_type -> dm.AccessAuthReq
	9,  // 8: dm.Dm.manageDevice:input_type -> dm.ManageDeviceReq
	5,  // 9: dm.Dm.manageProduct:input_type -> dm.ManageProductReq
	6,  // 10: dm.Dm.getProductInfo:input_type -> dm.GetProductInfoReq
	10, // 11: dm.Dm.getDeviceInfo:input_type -> dm.GetDeviceInfoReq
	0,  // 12: dm.Dm.loginAuth:output_type -> dm.Response
	0,  // 13: dm.Dm.accessAuth:output_type -> dm.Response
	8,  // 14: dm.Dm.manageDevice:output_type -> dm.DeviceInfo
	4,  // 15: dm.Dm.manageProduct:output_type -> dm.ProductInfo
	7,  // 16: dm.Dm.getProductInfo:output_type -> dm.GetProductInfoResp
	11, // 17: dm.Dm.getDeviceInfo:output_type -> dm.GetDeviceInfoResp
