...
func ToVidmgrConfigRpc(pi *types.IndexApiServerConfig) *vid.VidmgrConfig {
...
func ToVidmgrConfigApi(pi *vid.VidmgrConfig) *types.IndexApiServerConfig {
	dpi := &types.IndexApiServerConfig{
		GeneralMediaServerId:           pi.GeneralMediaServerId,
		ApiDebug:                       pi.ApiDebug,
		ApiDefaultSnap:                 pi.ApiDefaultSnap,
		ApiSecret:                      pi.ApiSecret,
