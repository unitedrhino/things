...
func (n *NatsClient) ReqToDeviceSync(ctx context.Context, reqTopic, respTopic string, req *msgThing2.Req,
	productID, deviceName string) (*msgThing2.Resp, error) {
