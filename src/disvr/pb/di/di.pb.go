...
type SendPropertyMsg struct {
	...
	ClientToken string `protobuf:"bytes,3,opt,name=clientToken,proto3" json:"clientToken,omitempty"` //调用id
	Data        string `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`               //返回信息
	ErrMsg      string `protobuf:"bytes,5,opt,name=errMsg,proto3" json:"errMsg,omitempty"`           //系统错误信息
	ErrCode     int64  `protobuf:"varint,6,opt,name=errCode,proto3" json:"errCode,omitempty"`        //系统错误码
}
...
func (x *SendPropertyMsg) GetErrMsg() string {
	if x != nil {
		return x.ErrMsg
	}
	return ""
...
func (x *SendPropertyMsg) GetErrCode() int64 {
	if x != nil {
		return x.ErrCode
	}
	return 0
...
var file_proto_di_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x65,
	0x72, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x65, 0x72,
	0x72, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x6a, 0x0a, 0x14, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x65,
