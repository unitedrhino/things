...
func (m *apiModel) FindApiByFilter(ctx context.Context, f ApiFilter, page *def.PageInfo) ([]*SysApiInfo, error) {
	var resp []*SysApiInfo
...
func (m *apiModel) Index(ctx context.Context, in *ApiFilter) ([]*SysApiInfo, int64, error) {
	page := def.PageInfo{}
