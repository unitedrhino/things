...
type SysProjectInfo struct {
	ProjectID   stores.ProjectID `gorm:"column:projectID;type:bigint(20);NOT NULL"`     // 项目ID(雪花ID)
	...
	UserID      int64            `gorm:"column:userID;type:bigint(20);NOT NULL"`        // 管理员用户id
...
type SysAreaInfo struct {
	ProjectID    stores.ProjectID `gorm:"column:projectID;type:bigint(20);NOT NULL"`    // 所属项目ID(雪花ID)
	AreaID       stores.AreaID    `gorm:"column:areaID;type:bigint(20);NOT NULL"`       // 区域ID(雪花ID)
	ParentAreaID int64            `gorm:"column:parentAreaID;type:bigint(20);NOT NULL"` // 上级区域ID(雪花ID)
...
type SysUserAuthArea struct {
	...
	UserID    int64 `gorm:"column:userID;type:bigint(20);NOT NULL"`    // 用户ID(雪花id)
	ProjectID int64 `gorm:"column:projectID;type:bigint(20);NOT NULL"` // 所属项目ID(雪花ID)
	AreaID    int64 `gorm:"column:areaID;type:bigint(20);NOT NULL"`    // 区域ID(雪花ID) 5 是共享设备
	stores.Time
}
