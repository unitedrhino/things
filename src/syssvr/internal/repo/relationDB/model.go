...
type SysUserInfo struct {
	...
	IsAllData  int64          `gorm:"column:is_all_data;type:tinyint(1) unsigned;default:2;NOT NULL"` // 是否所有数据权限（1是，2否）
	stores.Time
}
...
type SysRoleMenu struct {
	ID     int64 `gorm:"column:id;type:bigint(20);primary_key;AUTO_INCREMENT"` // id编号
	RoleID int64 `gorm:"column:role_id;NOT NULL;type:int(11)"`                 // 角色ID
	MenuID int64 `gorm:"column:menu_id;NOT NULL;type:int(11)"`                 // 菜单ID
	stores.Time
}
...
type SysMenuInfo struct {
	...
	ParentID      int64  `gorm:"column:parent_id;type:int(11);default:1;NOT NULL"`     // 父菜单ID，一级菜单为1
	Type          int64  `gorm:"column:type;type:int(11);default:1;NOT NULL"`          // 类型   1：目录   2：菜单   3：按钮
	Order         int64  `gorm:"column:order_num;type:int(11);default:1;NOT NULL"`     // 左侧table排序序号
	...
	HideInMenu    int64  `gorm:"column:hide_in_menu;type:int(11);default:2;NOT NULL"`  // 是否隐藏菜单 1-是 2-否
	stores.Time
}
...
type SysLoginLog struct {
	...
	CreatedTime   time.Time `gorm:"column:created_time;type:datetime;default:CURRENT_TIMESTAMP;NOT NULL"` // 登录时间
}
...
type SysOperLog struct {
	ID           int64          `gorm:"column:id;type:bigint(20);primary_key;AUTO_INCREMENT"`                 // 编号
	OperUserID   int64          `gorm:"column:oper_user_id;type:bigint(20);NOT NULL"`                         // 用户id
	...
	BusinessType int64          `gorm:"column:business_type;type:int(11);NOT NULL"`                           // 业务类型（1新增 2修改 3删除 4查询 5其它）
	...
	Msg          string         `gorm:"column:msg;type:varchar(255)"`                                         // 提示消息
	CreatedTime  time.Time      `gorm:"column:created_time;type:datetime;default:CURRENT_TIMESTAMP;NOT NULL"` // 操作时间
}
