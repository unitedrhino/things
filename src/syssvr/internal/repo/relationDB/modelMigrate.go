...
var (
	...
	MigrateMenuInfo = []SysMenuInfo{
		...
		{ID: 66, ParentID: 63, Type: 1, Order: 2, Name: "接入管理", Path: "/videoManagers/vdevice/index", Component: "./videoManagers/vdevice/index.tsx", Icon: "icon_heat", Redirect: "", BackgroundUrl: "", HideInMenu: 2},
