...
func (l *UserInfoCreateLogic) CheckPwd(in *sys.UserInfo) error {
...
func (l *UserInfoCreateLogic) handlePassword(in *sys.UserInfo) (*sys.UserCreateResp, error) {
...
func (l *UserInfoCreateLogic) UserInfoCreate(in *sys.UserInfo) (*sys.UserCreateResp, error) {
