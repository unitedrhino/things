...
func (l *CoreCreateLogic) getRet(uc *mysql.UserCore) (*sys.UserCoreCreateResp, error) {
	l.Infof("register_core|register one success|user_core=%#v", uc)
	return &sys.UserCoreCreateResp{
		Uid: uc.Uid,
	}, nil
}

func (l *CoreCreateLogic) handlePhone(in *sys.UserCoreCreateReq) (*sys.UserCoreCreateResp, error) {
...
func (l *CoreCreateLogic) handleWxminip(in *sys.UserCoreCreateReq) (*sys.UserCoreCreateResp, error) {
...
func (l *CoreCreateLogic) CheckPwd(in *sys.UserCoreCreateReq) error {
...
func (l *CoreCreateLogic) handlePassword(in *sys.UserCoreCreateReq) (*sys.UserCoreCreateResp, error) {
	...
	case mysql.ErrNotFound: //如果没有注册过,那么注册账号并进入下一步
		...
		return &sys.UserCoreCreateResp{Uid: uc.Uid}, nil
	default:
		break
	}

	return &sys.UserCoreCreateResp{}, nil
}

func (l *CoreCreateLogic) CoreCreate(in *sys.UserCoreCreateReq) (*sys.UserCoreCreateResp, error) {
