...
var file_proto_sys_proto_rawDesc = []byte{
	...
	0x22, 0x0a, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xcf, 0x02, 0x0a,
	...
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x42, 0x08,
...
var file_proto_sys_proto_depIdxs = []int32{
	...
	1,  // 4: sys.User.create:input_type -> sys.UserCreateReq
	6,  // 5: sys.User.index:input_type -> sys.UserIndexReq
	8,  // 6: sys.User.update:input_type -> sys.UserUpdateReq
	9,  // 7: sys.User.read:input_type -> sys.UserReadReq
	11, // 8: sys.User.delete:input_type -> sys.UserDeleteReq
	13, // 9: sys.User.login:input_type -> sys.LoginReq
	3,  // 10: sys.User.checkToken:input_type -> sys.CheckTokenReq
	2,  // 11: sys.User.create:output_type -> sys.UserCreateResp
	7,  // 12: sys.User.index:output_type -> sys.UserIndexResp
	15, // 13: sys.User.update:output_type -> sys.Response
	10, // 14: sys.User.read:output_type -> sys.UserReadResp
	15, // 15: sys.User.delete:output_type -> sys.Response
	14, // 16: sys.User.login:output_type -> sys.LoginResp
	4,  // 17: sys.User.checkToken:output_type -> sys.CheckTokenResp
