...
var file_proto_sys_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x32, 0xb1, 0x09, 0x0a, 0x0c, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74,
	...
	,
...
var file_proto_sys_proto_depIdxs = []int32{
	...
	18,  // 143: sys.TenantManage.tenantAppModuleCreate:input_type -> sys.TenantModuleCreateReq
	10,  // 144: sys.TenantManage.tenantAppModuleIndex:input_type -> sys.TenantModuleIndexReq
	19,  // 145: sys.TenantManage.tenantAppModuleDelete:input_type -> sys.TenantModuleWithIDOrCode
	14,  // 146: sys.TenantManage.tenantAppMenuCreate:input_type -> sys.TenantAppMenu
	12,  // 147: sys.TenantManage.tenantAppMenuIndex:input_type -> sys.TenantAppMenuIndexReq
	14,  // 148: sys.TenantManage.tenantAppMenuUpdate:input_type -> sys.TenantAppMenu
	25,  // 149: sys.TenantManage.tenantAppMenuDelete:input_type -> sys.WithAppCodeID
	15,  // 150: sys.TenantManage.tenantAppApiCreate:input_type -> sys.TenantApiInfo
	16,  // 151: sys.TenantManage.tenantAppApiIndex:input_type -> sys.TenantAppApiIndexReq
	15,  // 152: sys.TenantManage.tenantAppApiUpdate:input_type -> sys.TenantApiInfo
	25,  // 153: sys.TenantManage.tenantAppApiDelete:input_type -> sys.WithAppCodeID
	56,  // 154: sys.UserManage.userInfoCreate:output_type -> sys.UserCreateResp
	65,  // 155: sys.UserManage.userInfoIndex:output_type -> sys.UserInfoIndexResp
	21,  // 156: sys.UserManage.userInfoUpdate:output_type -> sys.Response
	55,  // 157: sys.UserManage.userInfoRead:output_type -> sys.UserInfo
	21,  // 158: sys.UserManage.userInfoDelete:output_type -> sys.Response
	73,  // 159: sys.UserManage.userLogin:output_type -> sys.UserLoginResp
	21,  // 160: sys.UserManage.userForgetPwd:output_type -> sys.Response
	70,  // 161: sys.UserManage.userCaptcha:output_type -> sys.UserCaptchaResp
	58,  // 162: sys.UserManage.userCheckToken:output_type -> sys.UserCheckTokenResp
	75,  // 163: sys.UserManage.userRegister:output_type -> sys.UserRegisterResp
	...
	86,  // 169: sys.UserManage.userAreaIndex:output_type -> sys.UserAreaIndexResp
	23,  // 170: sys.MenuManage.menuInfoCreate:output_type -> sys.WithID
	102, // 171: sys.MenuManage.menuInfoIndex:output_type -> sys.MenuInfoIndexResp
	21,  // 172: sys.MenuManage.menuInfoUpdate:output_type -> sys.Response
	21,  // 173: sys.MenuManage.menuInfoDelete:output_type -> sys.Response
	23,  // 174: sys.RoleManage.roleInfoCreate:output_type -> sys.WithID
	97,  // 175: sys.RoleManage.roleInfoIndex:output_type -> sys.RoleInfoIndexResp
	21,  // 176: sys.RoleManage.roleInfoUpdate:output_type -> sys.Response
	21,  // 177: sys.RoleManage.roleInfoDelete:output_type -> sys.Response
	41,  // 178: sys.RoleManage.roleMenuIndex:output_type -> sys.RoleMenuIndexResp
	21,  // 179: sys.RoleManage.roleMenuMultiUpdate:output_type -> sys.Response
	43,  // 180: sys.RoleManage.roleAppIndex:output_type -> sys.RoleAppIndexResp
	21,  // 181: sys.RoleManage.roleAppMultiUpdate:output_type -> sys.Response
	45,  // 182: sys.RoleManage.roleModuleIndex:output_type -> sys.RoleModuleIndexResp
	21,  // 183: sys.RoleManage.roleModuleMultiUpdate:output_type -> sys.Response
	21,  // 184: sys.RoleManage.roleApiAuth:output_type -> sys.Response
	21,  // 185: sys.RoleManage.roleApiMultiUpdate:output_type -> sys.Response
	39,  // 186: sys.RoleManage.roleApiIndex:output_type -> sys.RoleApiIndexResp
	23,  // 187: sys.AppManage.appInfoCreate:output_type -> sys.WithID
	92,  // 188: sys.AppManage.appInfoIndex:output_type -> sys.AppInfoIndexResp
	21,  // 189: sys.AppManage.appInfoUpdate:output_type -> sys.Response
	21,  // 190: sys.AppManage.appInfoDelete:output_type -> sys.Response
	90,  // 191: sys.AppManage.appInfoRead:output_type -> sys.AppInfo
	95,  // 192: sys.AppManage.appModuleIndex:output_type -> sys.AppModuleIndexResp
	21,  // 193: sys.AppManage.appModuleMultiUpdate:output_type -> sys.Response
	23,  // 194: sys.ModuleManage.moduleInfoCreate:output_type -> sys.WithID
	89,  // 195: sys.ModuleManage.moduleInfoIndex:output_type -> sys.ModuleInfoIndexResp
	21,  // 196: sys.ModuleManage.moduleInfoUpdate:output_type -> sys.Response
	21,  // 197: sys.ModuleManage.moduleInfoDelete:output_type -> sys.Response
	87,  // 198: sys.ModuleManage.moduleInfoRead:output_type -> sys.ModuleInfo
	23,  // 199: sys.ModuleManage.moduleMenuCreate:output_type -> sys.WithID
	102, // 200: sys.ModuleManage.moduleMenuIndex:output_type -> sys.MenuInfoIndexResp
	21,  // 201: sys.ModuleManage.moduleMenuUpdate:output_type -> sys.Response
	21,  // 202: sys.ModuleManage.moduleMenuDelete:output_type -> sys.Response
	23,  // 203: sys.ModuleManage.moduleApiCreate:output_type -> sys.WithID
	107, // 204: sys.ModuleManage.moduleApiIndex:output_type -> sys.ApiInfoIndexResp
	21,  // 205: sys.ModuleManage.moduleApiUpdate:output_type -> sys.Response
	21,  // 206: sys.ModuleManage.moduleApiDelete:output_type -> sys.Response
	104, // 207: sys.Common.config:output_type -> sys.configResp
	49,  // 208: sys.Log.loginLogIndex:output_type -> sys.LoginLogIndexResp
	52,  // 209: sys.Log.operLogIndex:output_type -> sys.OperLogIndexResp
	21,  // 210: sys.Log.loginLogCreate:output_type -> sys.Response
	21,  // 211: sys.Log.operLogCreate:output_type -> sys.Response
	23,  // 212: sys.ApiManage.apiInfoCreate:output_type -> sys.WithID
	107, // 213: sys.ApiManage.apiInfoIndex:output_type -> sys.ApiInfoIndexResp
	21,  // 214: sys.ApiManage.apiInfoUpdate:output_type -> sys.Response
	21,  // 215: sys.ApiManage.apiInfoDelete:output_type -> sys.Response
	...
	33,  // 225: sys.AreaManage.areaInfoIndex:output_type -> sys.AreaInfoIndexResp
	35,  // 226: sys.AreaManage.areaInfoTree:output_type -> sys.AreaInfoTreeResp
	23,  // 227: sys.TenantManage.tenantInfoCreate:output_type -> sys.WithID
	21,  // 228: sys.TenantManage.tenantInfoUpdate:output_type -> sys.Response
	21,  // 229: sys.TenantManage.tenantInfoDelete:output_type -> sys.Response
	1,   // 230: sys.TenantManage.tenantInfoRead:output_type -> sys.TenantInfo
	3,   // 231: sys.TenantManage.tenantInfoIndex:output_type -> sys.TenantInfoIndexResp
	8,   // 232: sys.TenantManage.tenantAppIndex:output_type -> sys.TenantAppIndexResp
	21,  // 233: sys.TenantManage.tenantAppCreate:output_type -> sys.Response
	21,  // 234: sys.TenantManage.tenantAppDelete:output_type -> sys.Response
	21,  // 235: sys.TenantManage.tenantAppModuleCreate:output_type -> sys.Response
	11,  // 236: sys.TenantManage.tenantAppModuleIndex:output_type -> sys.TenantModuleIndexResp
	21,  // 237: sys.TenantManage.tenantAppModuleDelete:output_type -> sys.Response
	23,  // 238: sys.TenantManage.tenantAppMenuCreate:output_type -> sys.WithID
	13,  // 239: sys.TenantManage.tenantAppMenuIndex:output_type -> sys.TenantAppMenuIndexResp
	21,  // 240: sys.TenantManage.tenantAppMenuUpdate:output_type -> sys.Response
	21,  // 241: sys.TenantManage.tenantAppMenuDelete:output_type -> sys.Response
	23,  // 242: sys.TenantManage.tenantAppApiCreate:output_type -> sys.WithID
	17,  // 243: sys.TenantManage.tenantAppApiIndex:output_type -> sys.TenantAppApiIndexResp
	21,  // 244: sys.TenantManage.tenantAppApiUpdate:output_type -> sys.Response
	21,  // 245: sys.TenantManage.tenantAppApiDelete:output_type -> sys.Response
	154, // [154:246] is the sub-list for method output_type
	62,  // [62:154] is the sub-list for method input_type
