...
const (
	WeatherTypeSunUp    WeatherType = "sunUp"    //太阳升起
	WeatherTypeSunDown  WeatherType = "sunDown"  //太阳落下
	WeatherTypeTemp     WeatherType = "temp"     //温度
	WeatherTypeHumidity WeatherType = "humidity" //湿度
)
...
func (t *TriggerWeather) Validate() error {
	if t == nil {
...
func (t TriggerWeathers) Validate() error {
	if len(t) == 0 {
		return nil
	}
	for _, v := range t {
