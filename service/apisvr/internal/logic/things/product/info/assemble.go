...
import (
	...
	"github.com/i-Things/things/service/apisvr/internal/logic/things/protocol/info"
...
func productInfoToApi(v *dm.ProductInfo) *types.ProductInfo {
	...
	return &types.ProductInfo{
		...
		ProtocolCode: v.ProtocolCode,             //数据协议:0:自定义,1:数据模板
		...
		Category:     category.ProductCategoryToApi(v.Category),
		Protocol:     info.ToInfoTypes(v.Protocol),
	}
}
