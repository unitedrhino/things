...
func ToVidmgrConfigRpc(pi *relationDB.VidmgrConfig) *vid.VidmgrConfig {
...
func ToVidmgrConfigDB2(pi *types.HooksApiServerStartedReq) *relationDB.VidmgrConfig {
	dpi := &relationDB.VidmgrConfig{
		VidmgrID:                       pi.GeneralMediaServerId,
		ApiDebug:                       pi.ApiDebug,
		ApiDefaultSnap:                 pi.ApiDefaultSnap,
...
func ToVidmgrConfigDB1(pi *types.ServerConfig) *relationDB.VidmgrConfig {
	dpi := &relationDB.VidmgrConfig{
		VidmgrID:                       pi.GeneralMediaServerId,
		ApiDebug:                       pi.ApiDebug,
		ApiDefaultSnap:                 pi.ApiDefaultSnap,
