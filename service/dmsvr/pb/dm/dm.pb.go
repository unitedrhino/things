...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x87, 0x07, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x73, 0x18, 0x14, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a,
	...
	0x69, 0x74, 0x68, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0xf9, 0x04, 0x0a, 0x13,
	...
	0x03, 0x28, 0x03, 0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x1a, 0x37, 0x0a,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0x51, 0x0a, 0x11, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	114, // 6: dm.DeviceTransferReq.devices:type_name -> dm.DeviceCore
	114, // 7: dm.UserDeviceShareReadReq.device:type_name -> dm.DeviceCore
	2,   // 8: dm.UserDeviceShareIndexReq.page:type_name -> dm.PageInfo
	114, // 9: dm.UserDeviceShareIndexReq.device:type_name -> dm.DeviceCore
	24,  // 10: dm.UserDeviceShareIndexResp.list:type_name -> dm.UserDeviceShareInfo
	114, // 11: dm.UserDeviceShareInfo.device:type_name -> dm.DeviceCore
	182, // 12: dm.UserDeviceShareInfo.schemaPerm:type_name -> dm.UserDeviceShareInfo.SchemaPermEntry
	183, // 13: dm.UserDeviceShareInfo.accessPerm:type_name -> dm.UserDeviceShareInfo.AccessPermEntry
	197, // 14: dm.UserDeviceShareInfo.expTime:type_name -> google.protobuf.Int64Value
	114, // 15: dm.UserDeviceCollectSave.devices:type_name -> dm.DeviceCore
	...
	184, // 24: dm.ProtocolConfigInfo.config:type_name -> dm.ProtocolConfigInfo.ConfigEntry
	...
	114, // 40: dm.GatewayNotifyBindSendReq.gateway:type_name -> dm.DeviceCore
	114, // 41: dm.GatewayNotifyBindSendReq.subDevices:type_name -> dm.DeviceCore
	114, // 42: dm.PropertyControlMultiSendReq.devices:type_name -> dm.DeviceCore
	...
	114, // 51: dm.DeviceGatewayMultiCreateReq.gateway:type_name -> dm.DeviceCore
	...
	114, // 54: dm.DeviceGatewayIndexReq.gateway:type_name -> dm.DeviceCore
	114, // 55: dm.DeviceGatewayIndexReq.subDevice:type_name -> dm.DeviceCore
	114, // 56: dm.DeviceGatewayIndexResp.list:type_name -> dm.DeviceCore
	114, // 57: dm.DeviceGatewayMultiSaveReq.gateway:type_name -> dm.DeviceCore
	114, // 58: dm.DeviceGatewayMultiSaveReq.list:type_name -> dm.DeviceCore
	114, // 59: dm.GatewayCanBindIndexReq.gateway:type_name -> dm.DeviceCore
	114, // 60: dm.GatewayCanBindIndexResp.subDevices:type_name -> dm.DeviceCore
	185, // 61: dm.GroupInfo.tags:type_name -> dm.GroupInfo.TagsEntry
	114, // 62: dm.GroupInfo.devices:type_name -> dm.DeviceCore
	95,  // 63: dm.GroupInfo.children:type_name -> dm.GroupInfo
	2,   // 64: dm.GroupInfoIndexReq.page:type_name -> dm.PageInfo
	186, // 65: dm.GroupInfoIndexReq.tags:type_name -> dm.GroupInfoIndexReq.TagsEntry
	95,  // 66: dm.GroupInfoIndexResp.list:type_name -> dm.GroupInfo
	187, // 67: dm.GroupInfoUpdateReq.tags:type_name -> dm.GroupInfoUpdateReq.TagsEntry
	114, // 68: dm.GroupDeviceMultiSaveReq.list:type_name -> dm.DeviceCore
	2,   // 69: dm.GroupDeviceIndexReq.page:type_name -> dm.PageInfo
	105, // 70: dm.GroupDeviceIndexResp.list:type_name -> dm.DeviceInfo
	114, // 71: dm.GroupDeviceMultiDeleteReq.list:type_name -> dm.DeviceCore
	...
	188, // 75: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	...
	189, // 79: dm.DeviceInfo.schemaAlias:type_name -> dm.DeviceInfo.SchemaAliasEntry
	197, // 80: dm.DeviceInfo.rssi:type_name -> google.protobuf.Int64Value
	190, // 81: dm.DeviceInfo.protocolConf:type_name -> dm.DeviceInfo.ProtocolConfEntry
	...
	191, // 85: dm.ProductInfo.tags:type_name -> dm.ProductInfo.TagsEntry
	35,  // 86: dm.ProductInfo.protocol:type_name -> dm.ProtocolInfo
	27,  // 87: dm.ProductInfo.category:type_name -> dm.ProductCategory
	192, // 88: dm.ProductInfo.protocolConf:type_name -> dm.ProductInfo.ProtocolConfEntry
	...
	193, // 91: dm.ProductInfoIndexReq.tags:type_name -> dm.ProductInfoIndexReq.TagsEntry
	194, // 92: dm.ProductInfoIndexReq.protocolConf:type_name -> dm.ProductInfoIndexReq.ProtocolConfEntry
	106, // 93: dm.ProductInfoIndexResp.list:type_name -> dm.ProductInfo
	112, // 94: dm.deviceOnlineMultiFixReq.devices:type_name -> dm.deviceOnlineMultiFix
	114, // 95: dm.deviceOnlineMultiFix.device:type_name -> dm.DeviceCore
	114, // 96: dm.DeviceInfoMultiUpdateReq.devices:type_name -> dm.DeviceCore
	4,   // 97: dm.DeviceInfoMultiUpdateReq.FilterDistributorID:type_name -> dm.CompareInt64
	9,   // 98: dm.DeviceInfoMultiUpdateReq.distributor:type_name -> dm.IDPath
	2,   // 99: dm.DeviceInfoIndexReq.page:type_name -> dm.PageInfo
	195, // 100: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	104, // 101: dm.DeviceInfoIndexReq.Position:type_name -> dm.Point
	114, // 102: dm.DeviceInfoIndexReq.devices:type_name -> dm.DeviceCore
	114, // 103: dm.DeviceInfoIndexReq.gateway:type_name -> dm.DeviceCore
	...
	105, // 107: dm.DeviceInfoIndexResp.list:type_name -> dm.DeviceInfo
	124, // 108: dm.CommonSchemaUpdateReq.info:type_name -> dm.CommonSchemaInfo
	124, // 109: dm.CommonSchemaCreateReq.info:type_name -> dm.CommonSchemaInfo
	2,   // 110: dm.CommonSchemaIndexReq.page:type_name -> dm.PageInfo
	124, // 111: dm.CommonSchemaIndexResp.list:type_name -> dm.CommonSchemaInfo
	198, // 112: dm.CommonSchemaInfo.name:type_name -> google.protobuf.StringValue
	198, // 113: dm.CommonSchemaInfo.desc:type_name -> google.protobuf.StringValue
	198, // 114: dm.CommonSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	27,  // 115: dm.CommonSchemaInfo.productCategories:type_name -> dm.ProductCategory
	131, // 116: dm.ProductSchemaUpdateReq.info:type_name -> dm.ProductSchemaInfo
	131, // 117: dm.ProductSchemaMultiCreateReq.list:type_name -> dm.ProductSchemaInfo
	131, // 118: dm.ProductSchemaCreateReq.info:type_name -> dm.ProductSchemaInfo
	2,   // 119: dm.ProductSchemaIndexReq.page:type_name -> dm.PageInfo
	131, // 120: dm.ProductSchemaIndexResp.list:type_name -> dm.ProductSchemaInfo
	198, // 121: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	198, // 122: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	198, // 123: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	114, // 124: dm.DeviceProfile.device:type_name -> dm.DeviceCore
	114, // 125: dm.DeviceProfileReadReq.device:type_name -> dm.DeviceCore
	114, // 126: dm.DeviceInfoCanBindReq.device:type_name -> dm.DeviceCore
	114, // 127: dm.DeviceInfoBindReq.device:type_name -> dm.DeviceCore
	114, // 128: dm.DeviceProfileIndexReq.device:type_name -> dm.DeviceCore
	135, // 129: dm.DeviceProfileIndexResp.profiles:type_name -> dm.DeviceProfile
	143, // 130: dm.DeviceCountResp.list:type_name -> dm.DeviceCountInfo
	196, // 131: dm.DeviceCountInfo.count:type_name -> dm.DeviceCountInfo.CountEntry
	1,   // 132: dm.DeviceInfoCountReq.timeRange:type_name -> dm.TimeRange
	1,   // 133: dm.DeviceTypeCountReq.timeRange:type_name -> dm.TimeRange
	198, // 134: dm.Firmware.desc:type_name -> google.protobuf.StringValue
	198, // 135: dm.Firmware.extData:type_name -> google.protobuf.StringValue
	151, // 136: dm.Firmware.files:type_name -> dm.OtaFirmwareFile
	198, // 137: dm.FirmwareInfo.desc:type_name -> google.protobuf.StringValue
	198, // 138: dm.FirmwareInfo.extData:type_name -> google.protobuf.StringValue
	151, // 139: dm.FirmwareInfo.files:type_name -> dm.OtaFirmwareFile
	2,   // 140: dm.FirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	150, // 141: dm.FirmwareInfoIndexResp.list:type_name -> dm.FirmwareInfo
	2,   // 142: dm.OtaFirmwareFileIndexReq.page:type_name -> dm.PageInfo
	197, // 143: dm.OtaFirmwareFileIndexReq.size:type_name -> google.protobuf.Int64Value
	158, // 144: dm.OtaFirmwareFileIndexResp.list:type_name -> dm.OtaFirmwareFileInfo
	198, // 145: dm.FirmwareInfoReadResp.desc:type_name -> google.protobuf.StringValue
	198, // 146: dm.FirmwareInfoReadResp.extData:type_name -> google.protobuf.StringValue
	159, // 147: dm.FirmwareInfoReadResp.files:type_name -> dm.OtaFirmwareFileResp
	198, // 148: dm.OtaFirmwareInfoCreateReq.extra:type_name -> google.protobuf.StringValue
	198, // 149: dm.OtaFirmwareInfoUpdateReq.extra:type_name -> google.protobuf.StringValue
	2,   // 150: dm.OtaFirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	168, // 151: dm.OtaFirmwareInfoIndexResp.list:type_name -> dm.OtaFirmwareInfo
	163, // 152: dm.OtaFirmwareInfo.fileList:type_name -> dm.FirmwareFile
	170, // 153: dm.OtaFirmwareJobInfo.dynamic:type_name -> dm.OtaJobDynamicInfo
	171, // 154: dm.OtaFirmwareJobInfo.static:type_name -> dm.OtaJobStaticInfo
	2,   // 155: dm.OtaFirmwareJobIndexReq.page:type_name -> dm.PageInfo
	169, // 156: dm.OtaFirmwareJobIndexResp.list:type_name -> dm.OtaFirmwareJobInfo
	2,   // 157: dm.OtaJobByDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	2,   // 158: dm.OtaFirmwareDeviceIndexReq.page:type_name -> dm.PageInfo
	176, // 159: dm.OtaFirmwareDeviceIndexResp.list:type_name -> dm.OtaFirmwareDeviceInfo
	...
	119, // 162: dm.DeviceManage.rootCheck:input_type -> dm.RootCheckReq
	105, // 163: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	105, // 164: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	111, // 165: dm.DeviceManage.deviceOnlineMultiFix:input_type -> dm.deviceOnlineMultiFixReq
	113, // 166: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	117, // 167: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	116, // 168: dm.DeviceManage.DeviceInfoMultiUpdate:input_type -> dm.DeviceInfoMultiUpdateReq
	115, // 169: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	138, // 170: dm.DeviceManage.deviceInfoBind:input_type -> dm.DeviceInfoBindReq
	137, // 171: dm.DeviceManage.deviceInfoCanBind:input_type -> dm.DeviceInfoCanBindReq
	114, // 172: dm.DeviceManage.deviceInfoUnbind:input_type -> dm.DeviceCore
	...
	144, // 180: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	145, // 181: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	141, // 182: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	136, // 183: dm.DeviceManage.deviceProfileRead:input_type -> dm.DeviceProfileReadReq
	136, // 184: dm.DeviceManage.deviceProfileDelete:input_type -> dm.DeviceProfileReadReq
	135, // 185: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	139, // 186: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	14,  // 187: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	106, // 188: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	106, // 189: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	107, // 190: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	109, // 191: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	108, // 192: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	125, // 193: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	127, // 194: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	126, // 195: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	128, // 196: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	129, // 197: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	132, // 198: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	133, // 199: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	...
	120, // 212: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	121, // 213: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	7,   // 214: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	122, // 215: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	...
	164, // 254: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	165, // 255: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	7,   // 256: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	166, // 257: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	7,   // 258: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	169, // 259: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	172, // 260: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	7,   // 261: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	169, // 262: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	175, // 263: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	178, // 264: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	179, // 265: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	180, // 266: dm.OtaManage.otaFirmwareDeviceConfirm:input_type -> dm.OtaFirmwareDeviceConfirmReq
	...
	118, // 287: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 288: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	105, // 289: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	...
	146, // 300: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	147, // 301: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	142, // 302: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	135, // 303: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	...
	140, // 306: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	...
	110, // 311: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	106, // 312: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	...
	130, // 317: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 318: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	134, // 319: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	...
	123, // 335: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	...
	167, // 377: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	168, // 378: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	7,   // 379: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	173, // 380: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	169, // 381: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 382: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	177, // 383: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
