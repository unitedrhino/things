...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x75, 0x6c, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x85, 0x05, 0x0a, 0x12, 0x4f, 0x74,
	...
	0x73, 0x22, 0x35, 0x0a, 0x11, 0x4f, 0x74, 0x61, 0x4a, 0x6f, 0x62, 0x44, 0x79, 0x6e, 0x61, 0x6d,
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0x9e, 0x08, 0x0a, 0x0c, 0x44,
	...
	0x6c, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73, 0x70, 0x32, 0xf7, 0x09, 0x0a, 0x0d,
...
var file_proto_dm_proto_goTypes = []interface{}{
	...
	(*DeviceInfoBindReq)(nil),             // 117: dm.DeviceInfoBindReq
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	94,  // 99: dm.DeviceInfoBindReq.device:type_name -> dm.DeviceCore
	...
	117, // 139: dm.DeviceManage.deviceInfoBind:input_type -> dm.DeviceInfoBindReq
	73,  // 140: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	74,  // 141: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	76,  // 142: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiDeleteReq
	123, // 143: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	124, // 144: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	120, // 145: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	116, // 146: dm.DeviceManage.deviceProfileRead:input_type -> dm.DeviceProfileReadReq
	115, // 147: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	118, // 148: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	...
	0,   // 241: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	0,   // 242: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	75,  // 243: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 244: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	125, // 245: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	126, // 246: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	121, // 247: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	115, // 248: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 249: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	119, // 250: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
