...
var file_proto_dm_proto_depIdxs = []int32{
	...
	246, // 31: dm.ProtocolScript.desc:type_name -> google.protobuf.StringValue
	...
	132, // 35: dm.ProtocolScriptDevice.product:type_name -> dm.ProductInfo
	...
	228, // 47: dm.ProtocolConfigInfo.config:type_name -> dm.ProtocolConfigInfo.ConfigEntry
	57,  // 48: dm.ShadowIndexResp.list:type_name -> dm.ShadowIndex
	141, // 49: dm.PropertyGetReportMultiSendReq.devices:type_name -> dm.DeviceCore
	...
	142, // 52: dm.PropertyLogLatestIndex2Req.devices:type_name -> dm.DeviceData
	...
	141, // 68: dm.GatewayNotifyBindSendReq.gateway:type_name -> dm.DeviceCore
	141, // 69: dm.GatewayNotifyBindSendReq.subDevices:type_name -> dm.DeviceCore
	141, // 70: dm.PropertyControlMultiSendReq.devices:type_name -> dm.DeviceCore
	...
	246, // 75: dm.ProductCustom.transformScript:type_name -> google.protobuf.StringValue
	246, // 76: dm.ProductCustom.loginAuthScript:type_name -> google.protobuf.StringValue
	...
	141, // 79: dm.DeviceGatewayMultiCreateReq.gateway:type_name -> dm.DeviceCore
	...
	141, // 82: dm.DeviceGatewayIndexReq.gateway:type_name -> dm.DeviceCore
	141, // 83: dm.DeviceGatewayIndexReq.subDevice:type_name -> dm.DeviceCore
	141, // 84: dm.DeviceGatewayIndexResp.list:type_name -> dm.DeviceCore
	141, // 85: dm.DeviceGatewayMultiSaveReq.gateway:type_name -> dm.DeviceCore
	141, // 86: dm.DeviceGatewayMultiSaveReq.list:type_name -> dm.DeviceCore
	141, // 87: dm.GatewayCanBindIndexReq.gateway:type_name -> dm.DeviceCore
	141, // 88: dm.GatewayCanBindIndexResp.subDevices:type_name -> dm.DeviceCore
	121, // 89: dm.GroupInfoMultiCreateReq.groups:type_name -> dm.GroupInfo
	229, // 90: dm.GroupInfo.tags:type_name -> dm.GroupInfo.TagsEntry
	141, // 91: dm.GroupInfo.devices:type_name -> dm.DeviceCore
	121, // 92: dm.GroupInfo.children:type_name -> dm.GroupInfo
	2,   // 93: dm.GroupInfoIndexReq.page:type_name -> dm.PageInfo
	230, // 94: dm.GroupInfoIndexReq.tags:type_name -> dm.GroupInfoIndexReq.TagsEntry
	141, // 95: dm.GroupInfoIndexReq.hasDevice:type_name -> dm.DeviceCore
	121, // 96: dm.GroupInfoIndexResp.list:type_name -> dm.GroupInfo
	231, // 97: dm.GroupInfoUpdateReq.tags:type_name -> dm.GroupInfoUpdateReq.TagsEntry
	141, // 98: dm.GroupDeviceMultiSaveReq.list:type_name -> dm.DeviceCore
	141, // 99: dm.GroupDeviceMultiDeleteReq.list:type_name -> dm.DeviceCore
	246, // 100: dm.DeviceInfo.version:type_name -> google.protobuf.StringValue
	130, // 101: dm.DeviceInfo.Position:type_name -> dm.Point
	246, // 102: dm.DeviceInfo.address:type_name -> google.protobuf.StringValue
	246, // 103: dm.DeviceInfo.adcode:type_name -> google.protobuf.StringValue
	232, // 104: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	246, // 105: dm.DeviceInfo.deviceAlias:type_name -> google.protobuf.StringValue
	246, // 106: dm.DeviceInfo.phone:type_name -> google.protobuf.StringValue
	246, // 107: dm.DeviceInfo.iccid:type_name -> google.protobuf.StringValue
	233, // 108: dm.DeviceInfo.schemaAlias:type_name -> dm.DeviceInfo.SchemaAliasEntry
	245, // 109: dm.DeviceInfo.rssi:type_name -> google.protobuf.Int64Value
	234, // 110: dm.DeviceInfo.protocolConf:type_name -> dm.DeviceInfo.ProtocolConfEntry
	235, // 111: dm.DeviceInfo.subProtocolConf:type_name -> dm.DeviceInfo.SubProtocolConfEntry
	10,  // 112: dm.DeviceInfo.distributor:type_name -> dm.IDPathWithUpdate
	245, // 113: dm.DeviceInfo.expTime:type_name -> google.protobuf.Int64Value
	246, // 114: dm.DeviceInfo.desc:type_name -> google.protobuf.StringValue
	131, // 115: dm.DeviceInfo.Gateway:type_name -> dm.DeviceInfo
	246, // 116: dm.ProductInfo.subProtocolCode:type_name -> google.protobuf.StringValue
	246, // 117: dm.ProductInfo.desc:type_name -> google.protobuf.StringValue
	236, // 118: dm.ProductInfo.tags:type_name -> dm.ProductInfo.TagsEntry
	53,  // 119: dm.ProductInfo.protocol:type_name -> dm.ProtocolInfo
	53,  // 120: dm.ProductInfo.subProtocol:type_name -> dm.ProtocolInfo
	34,  // 121: dm.ProductInfo.category:type_name -> dm.ProductCategory
	237, // 122: dm.ProductInfo.protocolConf:type_name -> dm.ProductInfo.ProtocolConfEntry
	238, // 123: dm.ProductInfo.subProtocolConf:type_name -> dm.ProductInfo.SubProtocolConfEntry
	245, // 124: dm.ProductInfo.trialTime:type_name -> google.protobuf.Int64Value
	239, // 125: dm.ProductInfo.customUi:type_name -> dm.ProductInfo.CustomUiEntry
	2,   // 126: dm.ProductInfoIndexReq.page:type_name -> dm.PageInfo
	240, // 127: dm.ProductInfoIndexReq.tags:type_name -> dm.ProductInfoIndexReq.TagsEntry
	241, // 128: dm.ProductInfoIndexReq.protocolConf:type_name -> dm.ProductInfoIndexReq.ProtocolConfEntry
	132, // 129: dm.ProductInfoIndexResp.list:type_name -> dm.ProductInfo
	139, // 130: dm.deviceOnlineMultiFixReq.devices:type_name -> dm.deviceOnlineMultiFix
	141, // 131: dm.deviceOnlineMultiFix.device:type_name -> dm.DeviceCore
	141, // 132: dm.DeviceInfoMultiUpdateReq.devices:type_name -> dm.DeviceCore
	4,   // 133: dm.DeviceInfoMultiUpdateReq.FilterDistributorID:type_name -> dm.CompareInt64
	9,   // 134: dm.DeviceInfoMultiUpdateReq.distributor:type_name -> dm.IDPath
	2,   // 135: dm.DeviceInfoIndexReq.page:type_name -> dm.PageInfo
	242, // 136: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	243, // 137: dm.DeviceInfoIndexReq.tagsLike:type_name -> dm.DeviceInfoIndexReq.TagsLikeEntry
	130, // 138: dm.DeviceInfoIndexReq.Position:type_name -> dm.Point
	141, // 139: dm.DeviceInfoIndexReq.devices:type_name -> dm.DeviceCore
	141, // 140: dm.DeviceInfoIndexReq.gateway:type_name -> dm.DeviceCore
	9,   // 141: dm.DeviceInfoIndexReq.distributor:type_name -> dm.IDPath
	4,   // 142: dm.DeviceInfoIndexReq.ratedPower:type_name -> dm.CompareInt64
	4,   // 143: dm.DeviceInfoIndexReq.expTime:type_name -> dm.CompareInt64
	4,   // 144: dm.DeviceInfoIndexReq.rssi:type_name -> dm.CompareInt64
	131, // 145: dm.DeviceInfoIndexResp.list:type_name -> dm.DeviceInfo
	153, // 146: dm.CommonSchemaUpdateReq.info:type_name -> dm.CommonSchemaInfo
	153, // 147: dm.CommonSchemaCreateReq.info:type_name -> dm.CommonSchemaInfo
	2,   // 148: dm.CommonSchemaIndexReq.page:type_name -> dm.PageInfo
	153, // 149: dm.CommonSchemaIndexResp.list:type_name -> dm.CommonSchemaInfo
	246, // 150: dm.CommonSchemaInfo.name:type_name -> google.protobuf.StringValue
	246, // 151: dm.CommonSchemaInfo.desc:type_name -> google.protobuf.StringValue
	246, // 152: dm.CommonSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	34,  // 153: dm.CommonSchemaInfo.productCategories:type_name -> dm.ProductCategory
	160, // 154: dm.ProductSchemaUpdateReq.info:type_name -> dm.ProductSchemaInfo
	160, // 155: dm.ProductSchemaMultiCreateReq.list:type_name -> dm.ProductSchemaInfo
	160, // 156: dm.ProductSchemaCreateReq.info:type_name -> dm.ProductSchemaInfo
	2,   // 157: dm.ProductSchemaIndexReq.page:type_name -> dm.PageInfo
	160, // 158: dm.ProductSchemaIndexResp.list:type_name -> dm.ProductSchemaInfo
	246, // 159: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	246, // 160: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	246, // 161: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	168, // 162: dm.DeviceSchemaMultiCreateReq.list:type_name -> dm.DeviceSchema
	2,   // 163: dm.DeviceSchemaIndexReq.page:type_name -> dm.PageInfo
	168, // 164: dm.DeviceSchemaIndexResp.list:type_name -> dm.DeviceSchema
	246, // 165: dm.DeviceSchema.name:type_name -> google.protobuf.StringValue
	246, // 166: dm.DeviceSchema.desc:type_name -> google.protobuf.StringValue
	246, // 167: dm.DeviceSchema.affordance:type_name -> google.protobuf.StringValue
	141, // 168: dm.DeviceProfile.device:type_name -> dm.DeviceCore
	141, // 169: dm.DeviceProfileReadReq.device:type_name -> dm.DeviceCore
	141, // 170: dm.DeviceInfoCanBindReq.device:type_name -> dm.DeviceCore
	141, // 171: dm.DeviceInfoMultiBindReq.devices:type_name -> dm.DeviceCore
	143, // 172: dm.DeviceInfoMultiBindResp.errs:type_name -> dm.DeviceError
	141, // 173: dm.DeviceInfoBindReq.device:type_name -> dm.DeviceCore
	141, // 174: dm.DeviceProfileIndexReq.device:type_name -> dm.DeviceCore
	172, // 175: dm.DeviceProfileIndexResp.profiles:type_name -> dm.DeviceProfile
	185, // 176: dm.DeviceCountResp.list:type_name -> dm.DeviceCountInfo
	244, // 177: dm.DeviceCountInfo.count:type_name -> dm.DeviceCountInfo.CountEntry
	1,   // 178: dm.DeviceInfoCountReq.timeRange:type_name -> dm.TimeRange
	1,   // 179: dm.DeviceTypeCountReq.timeRange:type_name -> dm.TimeRange
	246, // 180: dm.Firmware.desc:type_name -> google.protobuf.StringValue
	246, // 181: dm.Firmware.extData:type_name -> google.protobuf.StringValue
	193, // 182: dm.Firmware.files:type_name -> dm.OtaFirmwareFile
	246, // 183: dm.FirmwareInfo.desc:type_name -> google.protobuf.StringValue
	246, // 184: dm.FirmwareInfo.extData:type_name -> google.protobuf.StringValue
	193, // 185: dm.FirmwareInfo.files:type_name -> dm.OtaFirmwareFile
	2,   // 186: dm.FirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	192, // 187: dm.FirmwareInfoIndexResp.list:type_name -> dm.FirmwareInfo
	2,   // 188: dm.OtaFirmwareFileIndexReq.page:type_name -> dm.PageInfo
	245, // 189: dm.OtaFirmwareFileIndexReq.size:type_name -> google.protobuf.Int64Value
	200, // 190: dm.OtaFirmwareFileIndexResp.list:type_name -> dm.OtaFirmwareFileInfo
	246, // 191: dm.FirmwareInfoReadResp.desc:type_name -> google.protobuf.StringValue
	246, // 192: dm.FirmwareInfoReadResp.extData:type_name -> google.protobuf.StringValue
	201, // 193: dm.FirmwareInfoReadResp.files:type_name -> dm.OtaFirmwareFileResp
	246, // 194: dm.OtaFirmwareInfoCreateReq.extra:type_name -> google.protobuf.StringValue
	246, // 195: dm.OtaFirmwareInfoUpdateReq.extra:type_name -> google.protobuf.StringValue
	2,   // 196: dm.OtaFirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	210, // 197: dm.OtaFirmwareInfoIndexResp.list:type_name -> dm.OtaFirmwareInfo
	205, // 198: dm.OtaFirmwareInfo.fileList:type_name -> dm.FirmwareFile
	212, // 199: dm.OtaFirmwareJobInfo.dynamic:type_name -> dm.OtaJobDynamicInfo
	213, // 200: dm.OtaFirmwareJobInfo.static:type_name -> dm.OtaJobStaticInfo
	2,   // 201: dm.OtaFirmwareJobIndexReq.page:type_name -> dm.PageInfo
	211, // 202: dm.OtaFirmwareJobIndexResp.list:type_name -> dm.OtaFirmwareJobInfo
	2,   // 203: dm.OtaJobByDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	2,   // 204: dm.OtaFirmwareDeviceIndexReq.page:type_name -> dm.PageInfo
	218, // 205: dm.OtaFirmwareDeviceIndexResp.list:type_name -> dm.OtaFirmwareDeviceInfo
	28,  // 206: dm.UserDeviceShareInfo.SchemaPermEntry.value:type_name -> dm.SharePerm
	28,  // 207: dm.UserDeviceShareInfo.AccessPermEntry.value:type_name -> dm.SharePerm
	28,  // 208: dm.UserDeviceShareMultiInfo.SchemaPermEntry.value:type_name -> dm.SharePerm
	28,  // 209: dm.UserDeviceShareMultiInfo.AccessPermEntry.value:type_name -> dm.SharePerm
	133, // 210: dm.ProductInfo.CustomUiEntry.value:type_name -> dm.ProductCustomUi
	148, // 211: dm.DeviceManage.rootCheck:input_type -> dm.RootCheckReq
	131, // 212: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	131, // 213: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	138, // 214: dm.DeviceManage.deviceOnlineMultiFix:input_type -> dm.deviceOnlineMultiFixReq
	140, // 215: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	146, // 216: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	145, // 217: dm.DeviceManage.DeviceInfoMultiUpdate:input_type -> dm.DeviceInfoMultiUpdateReq
	144, // 218: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	180, // 219: dm.DeviceManage.deviceInfoBind:input_type -> dm.DeviceInfoBindReq
	178, // 220: dm.DeviceManage.deviceBindTokenRead:input_type -> dm.DeviceBindTokenReadReq
	0,   // 221: dm.DeviceManage.deviceBindTokenCreate:input_type -> dm.Empty
	175, // 222: dm.DeviceManage.deviceInfoMultiBind:input_type -> dm.DeviceInfoMultiBindReq
	174, // 223: dm.DeviceManage.deviceInfoCanBind:input_type -> dm.DeviceInfoCanBindReq
	177, // 224: dm.DeviceManage.deviceInfoUnbind:input_type -> dm.DeviceInfoUnbindReq
	22,  // 225: dm.DeviceManage.deviceTransfer:input_type -> dm.DeviceTransferReq
	21,  // 226: dm.DeviceManage.deviceReset:input_type -> dm.DeviceResetReq
	20,  // 227: dm.DeviceManage.deviceMove:input_type -> dm.DeviceMoveReq
	16,  // 228: dm.DeviceManage.deviceModuleVersionRead:input_type -> dm.DeviceModuleVersionReadReq
	18,  // 229: dm.DeviceManage.deviceModuleVersionIndex:input_type -> dm.DeviceModuleVersionIndexReq
	114, // 230: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	117, // 231: dm.DeviceManage.deviceGatewayMultiUpdate:input_type -> dm.DeviceGatewayMultiSaveReq
	115, // 232: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	117, // 233: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiSaveReq
	186, // 234: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	187, // 235: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	183, // 236: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	173, // 237: dm.DeviceManage.deviceProfileRead:input_type -> dm.DeviceProfileReadReq
	173, // 238: dm.DeviceManage.deviceProfileDelete:input_type -> dm.DeviceProfileReadReq
	172, // 239: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	181, // 240: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	168, // 241: dm.DeviceManage.deviceSchemaUpdate:input_type -> dm.DeviceSchema
	168, // 242: dm.DeviceManage.deviceSchemaCreate:input_type -> dm.DeviceSchema
	164, // 243: dm.DeviceManage.deviceSchemaMultiCreate:input_type -> dm.DeviceSchemaMultiCreateReq
	165, // 244: dm.DeviceManage.deviceSchemaMultiDelete:input_type -> dm.DeviceSchemaMultiDeleteReq
	166, // 245: dm.DeviceManage.deviceSchemaIndex:input_type -> dm.DeviceSchemaIndexReq
	169, // 246: dm.DeviceManage.deviceSchemaTslRead:input_type -> dm.DeviceSchemaTslReadReq
	171, // 247: dm.DeviceManage.deviceGroupMultiCreate:input_type -> dm.DeviceGroupMultiSaveReq
	171, // 248: dm.DeviceManage.deviceGroupMultiUpdate:input_type -> dm.DeviceGroupMultiSaveReq
	171, // 249: dm.DeviceManage.deviceGroupMultiDelete:input_type -> dm.DeviceGroupMultiSaveReq
	15,  // 250: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	132, // 251: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	132, // 252: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	134, // 253: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	136, // 254: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	135, // 255: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	154, // 256: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	156, // 257: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	155, // 258: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	157, // 259: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	158, // 260: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	161, // 261: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	162, // 262: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	109, // 263: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	110, // 264: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	34,  // 265: dm.ProductManage.productCategoryCreate:input_type -> dm.ProductCategory
	34,  // 266: dm.ProductManage.productCategoryUpdate:input_type -> dm.ProductCategory
	7,   // 267: dm.ProductManage.productCategoryDelete:input_type -> dm.WithID
	38,  // 268: dm.ProductManage.productCategoryIndex:input_type -> dm.ProductCategoryIndexReq
	8,   // 269: dm.ProductManage.productCategoryRead:input_type -> dm.WithIDChildren
	36,  // 270: dm.ProductManage.productCategorySchemaIndex:input_type -> dm.ProductCategorySchemaIndexReq
	37,  // 271: dm.ProductManage.productCategorySchemaMultiUpdate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	37,  // 272: dm.ProductManage.productCategorySchemaMultiCreate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	37,  // 273: dm.ProductManage.productCategorySchemaMultiDelete:input_type -> dm.ProductCategorySchemaMultiSaveReq
	0,   // 274: dm.SchemaManage.commonSchemaInit:input_type -> dm.Empty
	149, // 275: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	150, // 276: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	7,   // 277: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	151, // 278: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	48,  // 279: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	6,   // 280: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	53,  // 281: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	53,  // 282: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	7,   // 283: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	52,  // 284: dm.ProtocolManage.protocolServiceUpdate:input_type -> dm.ProtocolService
	7,   // 285: dm.ProtocolManage.protocolServiceDelete:input_type -> dm.WithID
	50,  // 286: dm.ProtocolManage.protocolServiceIndex:input_type -> dm.ProtocolServiceIndexReq
	43,  // 287: dm.ProtocolManage.ProtocolScriptIndex:input_type -> dm.ProtocolScriptIndexReq
	7,   // 288: dm.ProtocolManage.ProtocolScriptRead:input_type -> dm.WithID
	42,  // 289: dm.ProtocolManage.ProtocolScriptCreate:input_type -> dm.ProtocolScript
	42,  // 290: dm.ProtocolManage.ProtocolScriptUpdate:input_type -> dm.ProtocolScript
	7,   // 291: dm.ProtocolManage.ProtocolScriptDelete:input_type -> dm.WithID
	40,  // 292: dm.ProtocolManage.ProtocolScriptDebug:input_type -> dm.ProtocolScriptDebugReq
	46,  // 293: dm.ProtocolManage.ProtocolScriptDeviceIndex:input_type -> dm.ProtocolScriptDeviceIndexReq
	7,   // 294: dm.ProtocolManage.ProtocolScriptDeviceRead:input_type -> dm.WithID
	45,  // 295: dm.ProtocolManage.ProtocolScriptDeviceCreate:input_type -> dm.ProtocolScriptDevice
	45,  // 296: dm.ProtocolManage.ProtocolScriptDeviceUpdate:input_type -> dm.ProtocolScriptDevice
	7,   // 297: dm.ProtocolManage.ProtocolScriptDeviceDelete:input_type -> dm.WithID
	121, // 298: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	120, // 299: dm.DeviceGroup.groupInfoMultiCreate:input_type -> dm.GroupInfoMultiCreateReq
	125, // 300: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	124, // 301: dm.DeviceGroup.groupInfoRead:input_type -> dm.GroupInfoReadReq
	121, // 302: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	7,   // 303: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	128, // 304: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	128, // 305: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	129, // 306: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	103, // 307: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	104, // 308: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	106, // 309: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	107, // 310: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	83,  // 311: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	71,  // 312: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	77,  // 313: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	74,  // 314: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	80,  // 315: dm.DeviceMsg.abnormalLogIndex:input_type -> dm.AbnormalLogIndexReq
	82,  // 316: dm.DeviceMsg.abnormalLogCreate:input_type -> dm.AbnormalLogInfo
	64,  // 317: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	65,  // 318: dm.DeviceMsg.propertyLogLatestIndex2:input_type -> dm.PropertyLogLatestIndex2Req
	63,  // 319: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	68,  // 320: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	64,  // 321: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	118, // 322: dm.DeviceMsg.gatewayCanBindIndex:input_type -> dm.GatewayCanBindIndexReq
	86,  // 323: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	88,  // 324: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	91,  // 325: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	58,  // 326: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	61,  // 327: dm.DeviceInteract.propertyGetReportMultiSend:input_type -> dm.PropertyGetReportMultiSendReq
	89,  // 328: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	99,  // 329: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	88,  // 330: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	97,  // 331: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	93,  // 332: dm.DeviceInteract.gatewayGetFoundSend:input_type -> dm.GatewayGetFoundReq
	96,  // 333: dm.DeviceInteract.gatewayNotifyBindSend:input_type -> dm.GatewayNotifyBindSendReq
	94,  // 334: dm.DeviceInteract.edgeSend:input_type -> dm.EdgeSendReq
	206, // 335: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	207, // 336: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	7,   // 337: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	208, // 338: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	7,   // 339: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	211, // 340: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	214, // 341: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	7,   // 342: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	211, // 343: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	217, // 344: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	220, // 345: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	221, // 346: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	222, // 347: dm.OtaManage.otaFirmwareDeviceConfirm:input_type -> dm.OtaFirmwareDeviceConfirmReq
	14,  // 348: dm.OtaManage.otaModuleInfoCreate:input_type -> dm.OtaModuleInfo
	14,  // 349: dm.OtaManage.otaModuleInfoUpdate:input_type -> dm.OtaModuleInfo
	7,   // 350: dm.OtaManage.otaModuleInfoDelete:input_type -> dm.WithID
	12,  // 351: dm.OtaManage.otaModuleInfoIndex:input_type -> dm.OtaModuleInfoIndexReq
	6,   // 352: dm.OtaManage.otaModuleInfoRead:input_type -> dm.WithIDCode
	33,  // 353: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	33,  // 354: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 355: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	27,  // 356: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	27,  // 357: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	23,  // 358: dm.userDevice.userDeviceShareDelete:input_type -> dm.UserDeviceShareReadReq
	26,  // 359: dm.userDevice.userDeviceShareMultiDelete:input_type -> dm.UserDeviceShareMultiDeleteReq
	24,  // 360: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	23,  // 361: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	22,  // 362: dm.userDevice.userDeviceTransfer:input_type -> dm.DeviceTransferReq
	30,  // 363: dm.userDevice.userDeviceShareMultiCreate:input_type -> dm.UserDeviceShareMultiInfo
	31,  // 364: dm.userDevice.userDeivceShareMultiIndex:input_type -> dm.UserDeviceShareMultiToken
	32,  // 365: dm.userDevice.userDeivceShareMultiAccept:input_type -> dm.UserDeviceShareMultiAcceptReq
	0,   // 366: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 367: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 368: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 369: dm.DeviceManage.deviceOnlineMultiFix:output_type -> dm.Empty
	0,   // 370: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	147, // 371: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 372: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	131, // 373: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 374: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	179, // 375: dm.DeviceManage.deviceBindTokenRead:output_type -> dm.DeviceBindTokenInfo
	179, // 376: dm.DeviceManage.deviceBindTokenCreate:output_type -> dm.DeviceBindTokenInfo
	176, // 377: dm.DeviceManage.deviceInfoMultiBind:output_type -> dm.DeviceInfoMultiBindResp
	0,   // 378: dm.DeviceManage.deviceInfoCanBind:output_type -> dm.Empty
	0,   // 379: dm.DeviceManage.deviceInfoUnbind:output_type -> dm.Empty
	0,   // 380: dm.DeviceManage.deviceTransfer:output_type -> dm.Empty
	0,   // 381: dm.DeviceManage.deviceReset:output_type -> dm.Empty
	0,   // 382: dm.DeviceManage.deviceMove:output_type -> dm.Empty
	17,  // 383: dm.DeviceManage.deviceModuleVersionRead:output_type -> dm.DeviceModuleVersion
	19,  // 384: dm.DeviceManage.deviceModuleVersionIndex:output_type -> dm.DeviceModuleVersionIndexResp
	0,   // 385: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	0,   // 386: dm.DeviceManage.deviceGatewayMultiUpdate:output_type -> dm.Empty
	116, // 387: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 388: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	188, // 389: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	189, // 390: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	184, // 391: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	172, // 392: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 393: dm.DeviceManage.deviceProfileDelete:output_type -> dm.Empty
	0,   // 394: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	182, // 395: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	0,   // 396: dm.DeviceManage.deviceSchemaUpdate:output_type -> dm.Empty
	0,   // 397: dm.DeviceManage.deviceSchemaCreate:output_type -> dm.Empty
	0,   // 398: dm.DeviceManage.deviceSchemaMultiCreate:output_type -> dm.Empty
	0,   // 399: dm.DeviceManage.deviceSchemaMultiDelete:output_type -> dm.Empty
	167, // 400: dm.DeviceManage.deviceSchemaIndex:output_type -> dm.DeviceSchemaIndexResp
	170, // 401: dm.DeviceManage.deviceSchemaTslRead:output_type -> dm.DeviceSchemaTslReadResp
	0,   // 402: dm.DeviceManage.deviceGroupMultiCreate:output_type -> dm.Empty
	0,   // 403: dm.DeviceManage.deviceGroupMultiUpdate:output_type -> dm.Empty
	0,   // 404: dm.DeviceManage.deviceGroupMultiDelete:output_type -> dm.Empty
	0,   // 405: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 406: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 407: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 408: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	137, // 409: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	132, // 410: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 411: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 412: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 413: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 414: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	159, // 415: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 416: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	163, // 417: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	110, // 418: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 419: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	7,   // 420: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 421: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 422: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	39,  // 423: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	34,  // 424: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	35,  // 425: dm.ProductManage.productCategorySchemaIndex:output_type -> dm.ProductCategorySchemaIndexResp
	0,   // 426: dm.ProductManage.productCategorySchemaMultiUpdate:output_type -> dm.Empty
	0,   // 427: dm.ProductManage.productCategorySchemaMultiCreate:output_type -> dm.Empty
	0,   // 428: dm.ProductManage.productCategorySchemaMultiDelete:output_type -> dm.Empty
	0,   // 429: dm.SchemaManage.commonSchemaInit:output_type -> dm.Empty
	0,   // 430: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 431: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 432: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	152, // 433: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	49,  // 434: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	53,  // 435: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	7,   // 436: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 437: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 438: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	0,   // 439: dm.ProtocolManage.protocolServiceUpdate:output_type -> dm.Empty
	0,   // 440: dm.ProtocolManage.protocolServiceDelete:output_type -> dm.Empty
	51,  // 441: dm.ProtocolManage.protocolServiceIndex:output_type -> dm.ProtocolServiceIndexResp
	44,  // 442: dm.ProtocolManage.ProtocolScriptIndex:output_type -> dm.ProtocolScriptIndexResp
	42,  // 443: dm.ProtocolManage.ProtocolScriptRead:output_type -> dm.ProtocolScript
	7,   // 444: dm.ProtocolManage.ProtocolScriptCreate:output_type -> dm.WithID
	0,   // 445: dm.ProtocolManage.ProtocolScriptUpdate:output_type -> dm.Empty
	0,   // 446: dm.ProtocolManage.ProtocolScriptDelete:output_type -> dm.Empty
	41,  // 447: dm.ProtocolManage.ProtocolScriptDebug:output_type -> dm.ProtocolScriptDebugResp
	47,  // 448: dm.ProtocolManage.ProtocolScriptDeviceIndex:output_type -> dm.ProtocolScriptDeviceIndexResp
	45,  // 449: dm.ProtocolManage.ProtocolScriptDeviceRead:output_type -> dm.ProtocolScriptDevice
	7,   // 450: dm.ProtocolManage.ProtocolScriptDeviceCreate:output_type -> dm.WithID
	0,   // 451: dm.ProtocolManage.ProtocolScriptDeviceUpdate:output_type -> dm.Empty
	0,   // 452: dm.ProtocolManage.ProtocolScriptDeviceDelete:output_type -> dm.Empty
	7,   // 453: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	0,   // 454: dm.DeviceGroup.groupInfoMultiCreate:output_type -> dm.Empty
	126, // 455: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	121, // 456: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 457: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 458: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 459: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 460: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	0,   // 461: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 462: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	105, // 463: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 464: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	108, // 465: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	84,  // 466: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	72,  // 467: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	78,  // 468: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	75,  // 469: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	81,  // 470: dm.DeviceMsg.abnormalLogIndex:output_type -> dm.AbnormalLogIndexResp
	0,   // 471: dm.DeviceMsg.abnormalLogCreate:output_type -> dm.Empty
	67,  // 472: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	67,  // 473: dm.DeviceMsg.propertyLogLatestIndex2:output_type -> dm.PropertyLogIndexResp
	67,  // 474: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	70,  // 475: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	56,  // 476: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	119, // 477: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	87,  // 478: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	87,  // 479: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 480: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	59,  // 481: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	62,  // 482: dm.DeviceInteract.propertyGetReportMultiSend:output_type -> dm.PropertyGetReportMultiSendResp
	92,  // 483: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	101, // 484: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	92,  // 485: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	98,  // 486: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 487: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 488: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	95,  // 489: dm.DeviceInteract.edgeSend:output_type -> dm.EdgeSendResp
	7,   // 490: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	7,   // 491: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 492: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	209, // 493: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	210, // 494: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	7,   // 495: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	215, // 496: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	211, // 497: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 498: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	219, // 499: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 500: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 501: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	0,   // 502: dm.OtaManage.otaFirmwareDeviceConfirm:output_type -> dm.Empty
	7,   // 503: dm.OtaManage.otaModuleInfoCreate:output_type -> dm.WithID
	0,   // 504: dm.OtaManage.otaModuleInfoUpdate:output_type -> dm.Empty
	0,   // 505: dm.OtaManage.otaModuleInfoDelete:output_type -> dm.Empty
	13,  // 506: dm.OtaManage.otaModuleInfoIndex:output_type -> dm.OtaModuleInfoIndexResp
	14,  // 507: dm.OtaManage.otaModuleInfoRead:output_type -> dm.OtaModuleInfo
	0,   // 508: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 509: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	33,  // 510: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	7,   // 511: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 512: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 513: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	0,   // 514: dm.userDevice.userDeviceShareMultiDelete:output_type -> dm.Empty
	25,  // 515: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	27,  // 516: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
	0,   // 517: dm.userDevice.userDeviceTransfer:output_type -> dm.Empty
	31,  // 518: dm.userDevice.userDeviceShareMultiCreate:output_type -> dm.UserDeviceShareMultiToken
	30,  // 519: dm.userDevice.userDeivceShareMultiIndex:output_type -> dm.UserDeviceShareMultiInfo
	0,   // 520: dm.userDevice.userDeivceShareMultiAccept:output_type -> dm.Empty
	366, // [366:521] is the sub-list for method output_type
	211, // [211:366] is the sub-list for method input_type
