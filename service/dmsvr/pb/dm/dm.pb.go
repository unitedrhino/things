...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x09, 0x2e, 0x64, 0x6d, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xc5, 0x09, 0x0a, 0x09, 0x4f,
	...
	0x61, 0x46, 0x69, 0x72, 0x6d, 0x77, 0x61, 0x72, 0x65, 0x4a, 0x6f, 0x62, 0x49, 0x6e, 0x64, 0x65,
	0x78, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2d, 0x0a, 0x14, 0x6f, 0x74, 0x61, 0x46, 0x69, 0x72, 0x6d,
	0x77, 0x61, 0x72, 0x65, 0x4a, 0x6f, 0x62, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x0a, 0x2e,
	0x64, 0x6d, 0x2e, 0x57, 0x69, 0x74, 0x68, 0x49, 0x44, 0x1a, 0x09, 0x2e, 0x64, 0x6d, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x38, 0x0a, 0x12, 0x6f, 0x74, 0x61, 0x46, 0x69, 0x72, 0x6d, 0x77,
	...
	0x66, 0x6f, 0x32, 0xb6, 0x05, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76, 0x69, 0x63,
	...
	0x1a, 0x09, 0x2e, 0x64, 0x6d, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x07, 0x5a, 0x05, 0x70,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	7,   // 261: dm.OtaManage.otaFirmwareJobCancel:input_type -> dm.WithID
	7,   // 262: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	169, // 263: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	175, // 264: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	178, // 265: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	179, // 266: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	180, // 267: dm.OtaManage.otaFirmwareDeviceConfirm:input_type -> dm.OtaFirmwareDeviceConfirmReq
	...
	118, // 288: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 289: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	105, // 290: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	...
	91,  // 299: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 300: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	146, // 301: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	147, // 302: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	142, // 303: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	135, // 304: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	...
	140, // 307: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	...
	110, // 312: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	106, // 313: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	...
	130, // 318: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 319: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	134, // 320: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	85,  // 321: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	...
	123, // 336: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	...
	98,  // 343: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	95,  // 344: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	...
	102, // 349: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	...
	80,  // 352: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 353: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	83,  // 354: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	...
	76,  // 363: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	94,  // 364: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	62,  // 365: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	62,  // 366: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 367: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	41,  // 368: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	67,  // 369: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	74,  // 370: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	67,  // 371: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	71,  // 372: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 373: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 374: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	7,   // 375: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	7,   // 376: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 377: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	167, // 378: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	168, // 379: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	7,   // 380: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	173, // 381: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	0,   // 382: dm.OtaManage.otaFirmwareJobCancel:output_type -> dm.Empty
	169, // 383: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 384: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	177, // 385: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	...
	283, // [283:404] is the sub-list for method output_type
	162, // [162:283] is the sub-list for method input_type
