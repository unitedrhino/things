...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x61, 0x49, 0x44, 0x22, 0xce, 0x04, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e,
	...
	0x09, 0x52, 0x08, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x37, 0x0a, 0x09, 0x54,
	...
	0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0xff, 0x08, 0x0a, 0x0c, 0x44, 0x65,
	...
	0x63, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x33, 0x0a, 0x13, 0x64, 0x65, 0x76,
	...
	0x71, 0x1a, 0x09, 0x2e, 0x64, 0x6d, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xfd, 0x01, 0x0a,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	81,  // 156: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	83,  // 157: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiSaveReq
	133, // 158: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	134, // 159: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	130, // 160: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	126, // 161: dm.DeviceManage.deviceProfileRead:input_type -> dm.DeviceProfileReadReq
	125, // 162: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	128, // 163: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	9,   // 164: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	98,  // 165: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	98,  // 166: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	99,  // 167: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	101, // 168: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	100, // 169: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	115, // 170: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	117, // 171: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	116, // 172: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	118, // 173: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	119, // 174: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	122, // 175: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	123, // 176: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	75,  // 177: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	76,  // 178: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	18,  // 179: dm.ProductManage.productCategoryCreate:input_type -> dm.ProductCategory
	18,  // 180: dm.ProductManage.productCategoryUpdate:input_type -> dm.ProductCategory
	5,   // 181: dm.ProductManage.productCategoryDelete:input_type -> dm.WithID
	23,  // 182: dm.ProductManage.productCategoryIndex:input_type -> dm.ProductCategoryIndexReq
	19,  // 183: dm.ProductManage.productCategoryRead:input_type -> dm.ProductCategoryReadReq
	21,  // 184: dm.ProductManage.productCategorySchemaIndex:input_type -> dm.ProductCategorySchemaIndexReq
	22,  // 185: dm.ProductManage.productCategorySchemaMultiUpdate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	22,  // 186: dm.ProductManage.productCategorySchemaMultiCreate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	22,  // 187: dm.ProductManage.productCategorySchemaMultiDelete:input_type -> dm.ProductCategorySchemaMultiSaveReq
	110, // 188: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	111, // 189: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	5,   // 190: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	112, // 191: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	25,  // 192: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	4,   // 193: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	27,  // 194: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	27,  // 195: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	5,   // 196: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	86,  // 197: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	88,  // 198: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	5,   // 199: dm.DeviceGroup.groupInfoRead:input_type -> dm.WithID
	86,  // 200: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	5,   // 201: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	91,  // 202: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	91,  // 203: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	92,  // 204: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	94,  // 205: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	69,  // 206: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	70,  // 207: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	72,  // 208: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	73,  // 209: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	50,  // 210: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	41,  // 211: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	47,  // 212: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	44,  // 213: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	35,  // 214: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	34,  // 215: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	38,  // 216: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	35,  // 217: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	66,  // 218: dm.DeviceMsg.otaPromptIndex:input_type -> dm.OtaPromptIndexReq
	84,  // 219: dm.DeviceMsg.gatewayCanBindIndex:input_type -> dm.GatewayCanBindIndexReq
	53,  // 220: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	55,  // 221: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	57,  // 222: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	32,  // 223: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	56,  // 224: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	63,  // 225: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	55,  // 226: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	61,  // 227: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	59,  // 228: dm.DeviceInteract.gatewayGetFoundSend:input_type -> dm.GatewayGetFoundReq
	60,  // 229: dm.DeviceInteract.gatewayNotifyBindSend:input_type -> dm.GatewayNotifyBindSendReq
	153, // 230: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	154, // 231: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	5,   // 232: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	155, // 233: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	5,   // 234: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	158, // 235: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	161, // 236: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	5,   // 237: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	158, // 238: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	164, // 239: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	167, // 240: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	168, // 241: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	8,   // 242: dm.OtaManage.otaModuleInfoCreate:input_type -> dm.OtaModuleInfo
	8,   // 243: dm.OtaManage.otaModuleInfoUpdate:input_type -> dm.OtaModuleInfo
	5,   // 244: dm.OtaManage.otaModuleInfoDelete:input_type -> dm.WithID
	6,   // 245: dm.OtaManage.otaModuleInfoIndex:input_type -> dm.OtaModuleInfoIndexReq
	4,   // 246: dm.OtaManage.otaModuleInfoRead:input_type -> dm.WithIDCode
	17,  // 247: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	17,  // 248: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 249: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	15,  // 250: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	15,  // 251: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	5,   // 252: dm.userDevice.userDeviceShareDelete:input_type -> dm.WithID
	14,  // 253: dm.userDevice.userDeviceShareMultiDelete:input_type -> dm.UserDeviceShareMultiDeleteReq
	12,  // 254: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	11,  // 255: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	10,  // 256: dm.userDevice.userDeviceTransfer:input_type -> dm.deviceTransferReq
	0,   // 257: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 258: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 259: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 260: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	108, // 261: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 262: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	97,  // 263: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 264: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	0,   // 265: dm.DeviceManage.deviceInfoUnbind:output_type -> dm.Empty
	0,   // 266: dm.DeviceManage.deviceTransfer:output_type -> dm.Empty
	0,   // 267: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	82,  // 268: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 269: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	135, // 270: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	136, // 271: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	131, // 272: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	125, // 273: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 274: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	129, // 275: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	0,   // 276: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 277: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 278: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 279: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	102, // 280: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	98,  // 281: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 282: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 283: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 284: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 285: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	120, // 286: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 287: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	124, // 288: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	76,  // 289: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 290: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	5,   // 291: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 292: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 293: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	24,  // 294: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	18,  // 295: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	20,  // 296: dm.ProductManage.productCategorySchemaIndex:output_type -> dm.ProductCategorySchemaIndexResp
	0,   // 297: dm.ProductManage.productCategorySchemaMultiUpdate:output_type -> dm.Empty
	0,   // 298: dm.ProductManage.productCategorySchemaMultiCreate:output_type -> dm.Empty
	0,   // 299: dm.ProductManage.productCategorySchemaMultiDelete:output_type -> dm.Empty
	0,   // 300: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 301: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 302: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	113, // 303: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	26,  // 304: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	27,  // 305: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	5,   // 306: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 307: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 308: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	5,   // 309: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	89,  // 310: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	86,  // 311: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 312: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 313: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 314: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 315: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	93,  // 316: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,   // 317: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 318: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	71,  // 319: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 320: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	74,  // 321: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	51,  // 322: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	42,  // 323: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	48,  // 324: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	45,  // 325: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	37,  // 326: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	37,  // 327: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	40,  // 328: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	30,  // 329: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	67,  // 330: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	85,  // 331: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	54,  // 332: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	54,  // 333: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 334: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	33,  // 335: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	58,  // 336: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	65,  // 337: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	58,  // 338: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	62,  // 339: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 340: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 341: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	5,   // 342: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	5,   // 343: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 344: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	156, // 345: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	157, // 346: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	5,   // 347: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	162, // 348: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	158, // 349: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 350: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	166, // 351: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 352: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 353: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	5,   // 354: dm.OtaManage.otaModuleInfoCreate:output_type -> dm.WithID
	0,   // 355: dm.OtaManage.otaModuleInfoUpdate:output_type -> dm.Empty
	0,   // 356: dm.OtaManage.otaModuleInfoDelete:output_type -> dm.Empty
	7,   // 357: dm.OtaManage.otaModuleInfoIndex:output_type -> dm.OtaModuleInfoIndexResp
	8,   // 358: dm.OtaManage.otaModuleInfoRead:output_type -> dm.OtaModuleInfo
	0,   // 359: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 360: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	17,  // 361: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	5,   // 362: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 363: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 364: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	0,   // 365: dm.userDevice.userDeviceShareMultiDelete:output_type -> dm.Empty
	13,  // 366: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	15,  // 367: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
	0,   // 368: dm.userDevice.userDeviceTransfer:output_type -> dm.Empty
