...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x61, 0x49, 0x44, 0x22, 0x98, 0x05, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e,
	...
	0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x28, 0x0a, 0x07, 0x67,
	...
	0x6d, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0xa8, 0x03, 0x0a,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x69,
	...
	0x73, 0x65, 0x72, 0x50, 0x65, 0x72, 0x6d, 0x22, 0x57, 0x0a, 0x15, 0x43, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x22, 0x97, 0x04, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x41, 0x0a, 0x11, 0x70, 0x72, 0x6f, 0x64, 0x75,
	...
	0x66, 0x69, 0x65, 0x72, 0x22, 0x9b, 0x02, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	0x72, 0x6d, 0x22, 0x59, 0x0a, 0x16, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x63, 0x68,
	...
	0x64, 0x65, 0x22, 0x77, 0x0a, 0x11, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x6d, 0x65, 0x73, 0x32, 0xc5, 0x09, 0x0a, 0x0c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x61,
	...
	0x6f, 0x1a, 0x09, 0x2e, 0x64, 0x6d, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x36, 0x0a, 0x10,
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x64, 0x6d, 0x2e, 0x64, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x52, 0x65, 0x71, 0x1a,
	0x09, 0x2e, 0x64, 0x6d, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x46, 0x0a, 0x18, 0x64, 0x65,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	104, // 91: dm.DeviceInfoIndexReq.gateway:type_name -> dm.DeviceCore
	97,  // 92: dm.DeviceInfoIndexResp.list:type_name -> dm.DeviceInfo
	114, // 93: dm.CommonSchemaUpdateReq.info:type_name -> dm.CommonSchemaInfo
	114, // 94: dm.CommonSchemaCreateReq.info:type_name -> dm.CommonSchemaInfo
	2,   // 95: dm.CommonSchemaIndexReq.page:type_name -> dm.PageInfo
	114, // 96: dm.CommonSchemaIndexResp.list:type_name -> dm.CommonSchemaInfo
	185, // 97: dm.CommonSchemaInfo.name:type_name -> google.protobuf.StringValue
	185, // 98: dm.CommonSchemaInfo.desc:type_name -> google.protobuf.StringValue
	185, // 99: dm.CommonSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	18,  // 100: dm.CommonSchemaInfo.productCategories:type_name -> dm.ProductCategory
	121, // 101: dm.ProductSchemaUpdateReq.info:type_name -> dm.ProductSchemaInfo
	121, // 102: dm.ProductSchemaMultiCreateReq.list:type_name -> dm.ProductSchemaInfo
	121, // 103: dm.ProductSchemaCreateReq.info:type_name -> dm.ProductSchemaInfo
	2,   // 104: dm.ProductSchemaIndexReq.page:type_name -> dm.PageInfo
	121, // 105: dm.ProductSchemaIndexResp.list:type_name -> dm.ProductSchemaInfo
	185, // 106: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	185, // 107: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	185, // 108: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	104, // 109: dm.DeviceProfile.device:type_name -> dm.DeviceCore
	104, // 110: dm.DeviceProfileReadReq.device:type_name -> dm.DeviceCore
	104, // 111: dm.DeviceInfoBindReq.device:type_name -> dm.DeviceCore
	104, // 112: dm.DeviceProfileIndexReq.device:type_name -> dm.DeviceCore
	125, // 113: dm.DeviceProfileIndexResp.profiles:type_name -> dm.DeviceProfile
	132, // 114: dm.DeviceCountResp.list:type_name -> dm.DeviceCountInfo
	184, // 115: dm.DeviceCountInfo.count:type_name -> dm.DeviceCountInfo.CountEntry
	1,   // 116: dm.DeviceInfoCountReq.timeRange:type_name -> dm.TimeRange
	1,   // 117: dm.DeviceTypeCountReq.timeRange:type_name -> dm.TimeRange
	185, // 118: dm.Firmware.desc:type_name -> google.protobuf.StringValue
	185, // 119: dm.Firmware.extData:type_name -> google.protobuf.StringValue
	140, // 120: dm.Firmware.files:type_name -> dm.OtaFirmwareFile
	185, // 121: dm.FirmwareInfo.desc:type_name -> google.protobuf.StringValue
	185, // 122: dm.FirmwareInfo.extData:type_name -> google.protobuf.StringValue
	140, // 123: dm.FirmwareInfo.files:type_name -> dm.OtaFirmwareFile
	2,   // 124: dm.FirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	139, // 125: dm.FirmwareInfoIndexResp.list:type_name -> dm.FirmwareInfo
	2,   // 126: dm.OtaFirmwareFileIndexReq.page:type_name -> dm.PageInfo
	186, // 127: dm.OtaFirmwareFileIndexReq.size:type_name -> google.protobuf.Int64Value
	147, // 128: dm.OtaFirmwareFileIndexResp.list:type_name -> dm.OtaFirmwareFileInfo
	185, // 129: dm.FirmwareInfoReadResp.desc:type_name -> google.protobuf.StringValue
	185, // 130: dm.FirmwareInfoReadResp.extData:type_name -> google.protobuf.StringValue
	148, // 131: dm.FirmwareInfoReadResp.files:type_name -> dm.OtaFirmwareFileResp
	185, // 132: dm.OtaFirmwareInfoCreateReq.extra:type_name -> google.protobuf.StringValue
	185, // 133: dm.OtaFirmwareInfoUpdateReq.extra:type_name -> google.protobuf.StringValue
	2,   // 134: dm.OtaFirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	157, // 135: dm.OtaFirmwareInfoIndexResp.list:type_name -> dm.OtaFirmwareInfo
	152, // 136: dm.OtaFirmwareInfo.fileList:type_name -> dm.FirmwareFile
	159, // 137: dm.OtaFirmwareJobInfo.dynamic:type_name -> dm.OtaJobDynamicInfo
	160, // 138: dm.OtaFirmwareJobInfo.static:type_name -> dm.OtaJobStaticInfo
	2,   // 139: dm.OtaFirmwareJobIndexReq.pageInfo:type_name -> dm.PageInfo
	158, // 140: dm.OtaFirmwareJobIndexResp.list:type_name -> dm.OtaFirmwareJobInfo
	2,   // 141: dm.OtaJobByDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	2,   // 142: dm.OtaFirmwareDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	165, // 143: dm.OtaFirmwareDeviceIndexResp.list:type_name -> dm.OtaFirmwareDeviceInfo
	16,  // 144: dm.UserDeviceShareInfo.SchemaPermEntry.value:type_name -> dm.SharePerm
	16,  // 145: dm.UserDeviceShareInfo.AccessPermEntry.value:type_name -> dm.SharePerm
	109, // 146: dm.DeviceManage.rootCheck:input_type -> dm.RootCheckReq
	97,  // 147: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	97,  // 148: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	103, // 149: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	107, // 150: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	106, // 151: dm.DeviceManage.DeviceInfoMultiUpdate:input_type -> dm.DeviceInfoMultiUpdateReq
	105, // 152: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	127, // 153: dm.DeviceManage.deviceInfoBind:input_type -> dm.DeviceInfoBindReq
	104, // 154: dm.DeviceManage.deviceInfoUnbind:input_type -> dm.DeviceCore
	10,  // 155: dm.DeviceManage.deviceTransfer:input_type -> dm.deviceTransferReq
	80,  // 156: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	83,  // 157: dm.DeviceManage.deviceGatewayMultiUpdate:input_type -> dm.DeviceGatewayMultiSaveReq
	81,  // 158: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	83,  // 159: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiSaveReq
	133, // 160: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	134, // 161: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	130, // 162: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	126, // 163: dm.DeviceManage.deviceProfileRead:input_type -> dm.DeviceProfileReadReq
	125, // 164: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	128, // 165: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	9,   // 166: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	98,  // 167: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	98,  // 168: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	99,  // 169: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	101, // 170: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	100, // 171: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	115, // 172: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	117, // 173: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	116, // 174: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	118, // 175: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	119, // 176: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	122, // 177: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	123, // 178: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	75,  // 179: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	76,  // 180: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	18,  // 181: dm.ProductManage.productCategoryCreate:input_type -> dm.ProductCategory
	18,  // 182: dm.ProductManage.productCategoryUpdate:input_type -> dm.ProductCategory
	5,   // 183: dm.ProductManage.productCategoryDelete:input_type -> dm.WithID
	23,  // 184: dm.ProductManage.productCategoryIndex:input_type -> dm.ProductCategoryIndexReq
	19,  // 185: dm.ProductManage.productCategoryRead:input_type -> dm.ProductCategoryReadReq
	21,  // 186: dm.ProductManage.productCategorySchemaIndex:input_type -> dm.ProductCategorySchemaIndexReq
	22,  // 187: dm.ProductManage.productCategorySchemaMultiUpdate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	22,  // 188: dm.ProductManage.productCategorySchemaMultiCreate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	22,  // 189: dm.ProductManage.productCategorySchemaMultiDelete:input_type -> dm.ProductCategorySchemaMultiSaveReq
	0,   // 190: dm.SchemaManage.commonSchemaInit:input_type -> dm.Empty
	110, // 191: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	111, // 192: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	5,   // 193: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	112, // 194: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	25,  // 195: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	4,   // 196: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	27,  // 197: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	27,  // 198: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	5,   // 199: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	86,  // 200: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	88,  // 201: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	5,   // 202: dm.DeviceGroup.groupInfoRead:input_type -> dm.WithID
	86,  // 203: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	5,   // 204: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	91,  // 205: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	91,  // 206: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	92,  // 207: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	94,  // 208: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	69,  // 209: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	70,  // 210: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	72,  // 211: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	73,  // 212: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	50,  // 213: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	41,  // 214: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	47,  // 215: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	44,  // 216: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	35,  // 217: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	34,  // 218: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	38,  // 219: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	35,  // 220: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	66,  // 221: dm.DeviceMsg.otaPromptIndex:input_type -> dm.OtaPromptIndexReq
	84,  // 222: dm.DeviceMsg.gatewayCanBindIndex:input_type -> dm.GatewayCanBindIndexReq
	53,  // 223: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	55,  // 224: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	57,  // 225: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	32,  // 226: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	56,  // 227: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	63,  // 228: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	55,  // 229: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	61,  // 230: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	59,  // 231: dm.DeviceInteract.gatewayGetFoundSend:input_type -> dm.GatewayGetFoundReq
	60,  // 232: dm.DeviceInteract.gatewayNotifyBindSend:input_type -> dm.GatewayNotifyBindSendReq
	153, // 233: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	154, // 234: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	5,   // 235: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	155, // 236: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	5,   // 237: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	158, // 238: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	161, // 239: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	5,   // 240: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	158, // 241: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	164, // 242: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	167, // 243: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	168, // 244: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	8,   // 245: dm.OtaManage.otaModuleInfoCreate:input_type -> dm.OtaModuleInfo
	8,   // 246: dm.OtaManage.otaModuleInfoUpdate:input_type -> dm.OtaModuleInfo
	5,   // 247: dm.OtaManage.otaModuleInfoDelete:input_type -> dm.WithID
	6,   // 248: dm.OtaManage.otaModuleInfoIndex:input_type -> dm.OtaModuleInfoIndexReq
	4,   // 249: dm.OtaManage.otaModuleInfoRead:input_type -> dm.WithIDCode
	17,  // 250: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	17,  // 251: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 252: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	15,  // 253: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	15,  // 254: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	5,   // 255: dm.userDevice.userDeviceShareDelete:input_type -> dm.WithID
	14,  // 256: dm.userDevice.userDeviceShareMultiDelete:input_type -> dm.UserDeviceShareMultiDeleteReq
	12,  // 257: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	11,  // 258: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	10,  // 259: dm.userDevice.userDeviceTransfer:input_type -> dm.deviceTransferReq
	0,   // 260: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 261: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 262: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 263: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	108, // 264: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 265: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	97,  // 266: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 267: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	0,   // 268: dm.DeviceManage.deviceInfoUnbind:output_type -> dm.Empty
	0,   // 269: dm.DeviceManage.deviceTransfer:output_type -> dm.Empty
	0,   // 270: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	0,   // 271: dm.DeviceManage.deviceGatewayMultiUpdate:output_type -> dm.Empty
	82,  // 272: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 273: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	135, // 274: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	136, // 275: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	131, // 276: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	125, // 277: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 278: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	129, // 279: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	0,   // 280: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 281: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 282: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 283: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	102, // 284: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	98,  // 285: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 286: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 287: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 288: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 289: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	120, // 290: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 291: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	124, // 292: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	76,  // 293: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 294: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	5,   // 295: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 296: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 297: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	24,  // 298: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	18,  // 299: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	20,  // 300: dm.ProductManage.productCategorySchemaIndex:output_type -> dm.ProductCategorySchemaIndexResp
	0,   // 301: dm.ProductManage.productCategorySchemaMultiUpdate:output_type -> dm.Empty
	0,   // 302: dm.ProductManage.productCategorySchemaMultiCreate:output_type -> dm.Empty
	0,   // 303: dm.ProductManage.productCategorySchemaMultiDelete:output_type -> dm.Empty
	0,   // 304: dm.SchemaManage.commonSchemaInit:output_type -> dm.Empty
	0,   // 305: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 306: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 307: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	113, // 308: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	26,  // 309: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	27,  // 310: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	5,   // 311: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 312: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 313: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	5,   // 314: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	89,  // 315: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	86,  // 316: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 317: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 318: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 319: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 320: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	93,  // 321: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,   // 322: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 323: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	71,  // 324: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 325: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	74,  // 326: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	51,  // 327: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	42,  // 328: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	48,  // 329: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	45,  // 330: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	37,  // 331: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	37,  // 332: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	40,  // 333: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	30,  // 334: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	67,  // 335: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	85,  // 336: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	54,  // 337: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	54,  // 338: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 339: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	33,  // 340: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	58,  // 341: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	65,  // 342: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	58,  // 343: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	62,  // 344: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 345: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 346: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	5,   // 347: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	5,   // 348: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 349: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	156, // 350: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	157, // 351: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	5,   // 352: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	162, // 353: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	158, // 354: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 355: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	166, // 356: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 357: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 358: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	5,   // 359: dm.OtaManage.otaModuleInfoCreate:output_type -> dm.WithID
	0,   // 360: dm.OtaManage.otaModuleInfoUpdate:output_type -> dm.Empty
	0,   // 361: dm.OtaManage.otaModuleInfoDelete:output_type -> dm.Empty
	7,   // 362: dm.OtaManage.otaModuleInfoIndex:output_type -> dm.OtaModuleInfoIndexResp
	8,   // 363: dm.OtaManage.otaModuleInfoRead:output_type -> dm.OtaModuleInfo
	0,   // 364: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 365: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	17,  // 366: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	5,   // 367: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 368: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 369: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	0,   // 370: dm.userDevice.userDeviceShareMultiDelete:output_type -> dm.Empty
	13,  // 371: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	15,  // 372: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
	0,   // 373: dm.userDevice.userDeviceTransfer:output_type -> dm.Empty
	260, // [260:374] is the sub-list for method output_type
	146, // [146:260] is the sub-list for method input_type
