...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x32, 0xfd, 0x01, 0x0a, 0x0c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x4d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x12, 0x3a, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x53, 0x63, 0x68,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	110, // 189: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	111, // 190: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	5,   // 191: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	112, // 192: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	25,  // 193: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	4,   // 194: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	27,  // 195: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	27,  // 196: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	5,   // 197: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	86,  // 198: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	88,  // 199: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	5,   // 200: dm.DeviceGroup.groupInfoRead:input_type -> dm.WithID
	86,  // 201: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	5,   // 202: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	91,  // 203: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	91,  // 204: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	92,  // 205: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	94,  // 206: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	69,  // 207: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	70,  // 208: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	72,  // 209: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	73,  // 210: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	50,  // 211: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	41,  // 212: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	47,  // 213: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	44,  // 214: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	35,  // 215: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	34,  // 216: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	38,  // 217: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	35,  // 218: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	66,  // 219: dm.DeviceMsg.otaPromptIndex:input_type -> dm.OtaPromptIndexReq
	84,  // 220: dm.DeviceMsg.gatewayCanBindIndex:input_type -> dm.GatewayCanBindIndexReq
	53,  // 221: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	55,  // 222: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	57,  // 223: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	32,  // 224: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	56,  // 225: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	63,  // 226: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	55,  // 227: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	61,  // 228: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	59,  // 229: dm.DeviceInteract.gatewayGetFoundSend:input_type -> dm.GatewayGetFoundReq
	60,  // 230: dm.DeviceInteract.gatewayNotifyBindSend:input_type -> dm.GatewayNotifyBindSendReq
	153, // 231: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	154, // 232: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	5,   // 233: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	155, // 234: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	5,   // 235: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	158, // 236: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	161, // 237: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	5,   // 238: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	158, // 239: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	164, // 240: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	167, // 241: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	168, // 242: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	8,   // 243: dm.OtaManage.otaModuleInfoCreate:input_type -> dm.OtaModuleInfo
	8,   // 244: dm.OtaManage.otaModuleInfoUpdate:input_type -> dm.OtaModuleInfo
	5,   // 245: dm.OtaManage.otaModuleInfoDelete:input_type -> dm.WithID
	6,   // 246: dm.OtaManage.otaModuleInfoIndex:input_type -> dm.OtaModuleInfoIndexReq
	4,   // 247: dm.OtaManage.otaModuleInfoRead:input_type -> dm.WithIDCode
	17,  // 248: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	17,  // 249: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 250: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	15,  // 251: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	15,  // 252: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	5,   // 253: dm.userDevice.userDeviceShareDelete:input_type -> dm.WithID
	14,  // 254: dm.userDevice.userDeviceShareMultiDelete:input_type -> dm.UserDeviceShareMultiDeleteReq
	12,  // 255: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	11,  // 256: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	10,  // 257: dm.userDevice.userDeviceTransfer:input_type -> dm.deviceTransferReq
	0,   // 258: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 259: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 260: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 261: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	108, // 262: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 263: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	97,  // 264: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 265: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	0,   // 266: dm.DeviceManage.deviceInfoUnbind:output_type -> dm.Empty
	0,   // 267: dm.DeviceManage.deviceTransfer:output_type -> dm.Empty
	0,   // 268: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	0,   // 269: dm.DeviceManage.deviceGatewayMultiUpdate:output_type -> dm.Empty
	82,  // 270: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 271: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	135, // 272: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	136, // 273: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	131, // 274: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	125, // 275: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 276: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	129, // 277: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	0,   // 278: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 279: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 280: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 281: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	102, // 282: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	98,  // 283: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 284: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 285: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 286: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 287: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	120, // 288: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 289: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	124, // 290: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	76,  // 291: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 292: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	5,   // 293: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 294: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 295: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	24,  // 296: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	18,  // 297: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	20,  // 298: dm.ProductManage.productCategorySchemaIndex:output_type -> dm.ProductCategorySchemaIndexResp
	0,   // 299: dm.ProductManage.productCategorySchemaMultiUpdate:output_type -> dm.Empty
	0,   // 300: dm.ProductManage.productCategorySchemaMultiCreate:output_type -> dm.Empty
	0,   // 301: dm.ProductManage.productCategorySchemaMultiDelete:output_type -> dm.Empty
	0,   // 302: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 303: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 304: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	113, // 305: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	26,  // 306: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	27,  // 307: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	5,   // 308: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 309: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 310: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	5,   // 311: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	89,  // 312: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	86,  // 313: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 314: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 315: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 316: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 317: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	93,  // 318: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,   // 319: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 320: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	71,  // 321: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 322: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	74,  // 323: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	51,  // 324: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	42,  // 325: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	48,  // 326: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	45,  // 327: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	37,  // 328: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	37,  // 329: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	40,  // 330: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	30,  // 331: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	67,  // 332: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	85,  // 333: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	54,  // 334: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	54,  // 335: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 336: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	33,  // 337: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	58,  // 338: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	65,  // 339: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	58,  // 340: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	62,  // 341: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 342: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 343: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	5,   // 344: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	5,   // 345: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 346: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	156, // 347: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	157, // 348: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	5,   // 349: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	162, // 350: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	158, // 351: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 352: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	166, // 353: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 354: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 355: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	5,   // 356: dm.OtaManage.otaModuleInfoCreate:output_type -> dm.WithID
	0,   // 357: dm.OtaManage.otaModuleInfoUpdate:output_type -> dm.Empty
	0,   // 358: dm.OtaManage.otaModuleInfoDelete:output_type -> dm.Empty
	7,   // 359: dm.OtaManage.otaModuleInfoIndex:output_type -> dm.OtaModuleInfoIndexResp
	8,   // 360: dm.OtaManage.otaModuleInfoRead:output_type -> dm.OtaModuleInfo
	0,   // 361: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 362: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	17,  // 363: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	5,   // 364: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 365: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 366: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	0,   // 367: dm.userDevice.userDeviceShareMultiDelete:output_type -> dm.Empty
	13,  // 368: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	15,  // 369: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
	0,   // 370: dm.userDevice.userDeviceTransfer:output_type -> dm.Empty
	258, // [258:371] is the sub-list for method output_type
	145, // [145:258] is the sub-list for method input_type
