...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x0b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0x85, 0x0a, 0x0a,
	...
	0x6c, 0x65, 0x12, 0x33, 0x0a, 0x13, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x66,
...
var file_proto_dm_proto_depIdxs = []int32{
	...
	127, // 167: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	130, // 168: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	9,   // 169: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	98,  // 170: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	98,  // 171: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	99,  // 172: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	101, // 173: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	100, // 174: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	117, // 175: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	119, // 176: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	118, // 177: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	120, // 178: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	121, // 179: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	124, // 180: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	125, // 181: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	75,  // 182: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	76,  // 183: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	18,  // 184: dm.ProductManage.productCategoryCreate:input_type -> dm.ProductCategory
	18,  // 185: dm.ProductManage.productCategoryUpdate:input_type -> dm.ProductCategory
	5,   // 186: dm.ProductManage.productCategoryDelete:input_type -> dm.WithID
	23,  // 187: dm.ProductManage.productCategoryIndex:input_type -> dm.ProductCategoryIndexReq
	19,  // 188: dm.ProductManage.productCategoryRead:input_type -> dm.ProductCategoryReadReq
	21,  // 189: dm.ProductManage.productCategorySchemaIndex:input_type -> dm.ProductCategorySchemaIndexReq
	22,  // 190: dm.ProductManage.productCategorySchemaMultiUpdate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	22,  // 191: dm.ProductManage.productCategorySchemaMultiCreate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	22,  // 192: dm.ProductManage.productCategorySchemaMultiDelete:input_type -> dm.ProductCategorySchemaMultiSaveReq
	0,   // 193: dm.SchemaManage.commonSchemaInit:input_type -> dm.Empty
	112, // 194: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	113, // 195: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	5,   // 196: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	114, // 197: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	25,  // 198: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	4,   // 199: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	27,  // 200: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	27,  // 201: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	5,   // 202: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	86,  // 203: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	88,  // 204: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	5,   // 205: dm.DeviceGroup.groupInfoRead:input_type -> dm.WithID
	86,  // 206: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	5,   // 207: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	91,  // 208: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	91,  // 209: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	92,  // 210: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	94,  // 211: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	69,  // 212: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	70,  // 213: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	72,  // 214: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	73,  // 215: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	50,  // 216: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	41,  // 217: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	47,  // 218: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	44,  // 219: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	35,  // 220: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	34,  // 221: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	38,  // 222: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	35,  // 223: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	66,  // 224: dm.DeviceMsg.otaPromptIndex:input_type -> dm.OtaPromptIndexReq
	84,  // 225: dm.DeviceMsg.gatewayCanBindIndex:input_type -> dm.GatewayCanBindIndexReq
	53,  // 226: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	55,  // 227: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	57,  // 228: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	32,  // 229: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	56,  // 230: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	63,  // 231: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	55,  // 232: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	61,  // 233: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	59,  // 234: dm.DeviceInteract.gatewayGetFoundSend:input_type -> dm.GatewayGetFoundReq
	60,  // 235: dm.DeviceInteract.gatewayNotifyBindSend:input_type -> dm.GatewayNotifyBindSendReq
	155, // 236: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	156, // 237: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	5,   // 238: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	157, // 239: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	5,   // 240: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	160, // 241: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	163, // 242: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	5,   // 243: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	160, // 244: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	166, // 245: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	169, // 246: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	170, // 247: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	8,   // 248: dm.OtaManage.otaModuleInfoCreate:input_type -> dm.OtaModuleInfo
	8,   // 249: dm.OtaManage.otaModuleInfoUpdate:input_type -> dm.OtaModuleInfo
	5,   // 250: dm.OtaManage.otaModuleInfoDelete:input_type -> dm.WithID
	6,   // 251: dm.OtaManage.otaModuleInfoIndex:input_type -> dm.OtaModuleInfoIndexReq
	4,   // 252: dm.OtaManage.otaModuleInfoRead:input_type -> dm.WithIDCode
	17,  // 253: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	17,  // 254: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 255: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	15,  // 256: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	15,  // 257: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	5,   // 258: dm.userDevice.userDeviceShareDelete:input_type -> dm.WithID
	14,  // 259: dm.userDevice.userDeviceShareMultiDelete:input_type -> dm.UserDeviceShareMultiDeleteReq
	12,  // 260: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	11,  // 261: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	10,  // 262: dm.userDevice.userDeviceTransfer:input_type -> dm.deviceTransferReq
	0,   // 263: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 264: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 265: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 266: dm.DeviceManage.deviceOnlineMultiFix:output_type -> dm.Empty
	0,   // 267: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	110, // 268: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 269: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	97,  // 270: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 271: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	0,   // 272: dm.DeviceManage.deviceInfoUnbind:output_type -> dm.Empty
	0,   // 273: dm.DeviceManage.deviceTransfer:output_type -> dm.Empty
	0,   // 274: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	0,   // 275: dm.DeviceManage.deviceGatewayMultiUpdate:output_type -> dm.Empty
	82,  // 276: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 277: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	137, // 278: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	138, // 279: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	133, // 280: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	127, // 281: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 282: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	131, // 283: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	0,   // 284: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 285: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 286: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 287: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	102, // 288: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	98,  // 289: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 290: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 291: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 292: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 293: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	122, // 294: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 295: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	126, // 296: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	76,  // 297: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 298: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	5,   // 299: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 300: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 301: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	24,  // 302: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	18,  // 303: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	20,  // 304: dm.ProductManage.productCategorySchemaIndex:output_type -> dm.ProductCategorySchemaIndexResp
	0,   // 305: dm.ProductManage.productCategorySchemaMultiUpdate:output_type -> dm.Empty
	0,   // 306: dm.ProductManage.productCategorySchemaMultiCreate:output_type -> dm.Empty
	0,   // 307: dm.ProductManage.productCategorySchemaMultiDelete:output_type -> dm.Empty
	0,   // 308: dm.SchemaManage.commonSchemaInit:output_type -> dm.Empty
	0,   // 309: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 310: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 311: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	115, // 312: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	26,  // 313: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	27,  // 314: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	5,   // 315: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 316: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 317: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	5,   // 318: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	89,  // 319: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	86,  // 320: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 321: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 322: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 323: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 324: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	93,  // 325: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,   // 326: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 327: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	71,  // 328: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 329: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	74,  // 330: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	51,  // 331: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	42,  // 332: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	48,  // 333: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	45,  // 334: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	37,  // 335: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	37,  // 336: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	40,  // 337: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	30,  // 338: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	67,  // 339: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	85,  // 340: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	54,  // 341: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	54,  // 342: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 343: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	33,  // 344: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	58,  // 345: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	65,  // 346: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	58,  // 347: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	62,  // 348: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 349: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 350: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	5,   // 351: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	5,   // 352: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 353: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	158, // 354: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	159, // 355: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	5,   // 356: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	164, // 357: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	160, // 358: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 359: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	168, // 360: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 361: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 362: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	5,   // 363: dm.OtaManage.otaModuleInfoCreate:output_type -> dm.WithID
	0,   // 364: dm.OtaManage.otaModuleInfoUpdate:output_type -> dm.Empty
	0,   // 365: dm.OtaManage.otaModuleInfoDelete:output_type -> dm.Empty
	7,   // 366: dm.OtaManage.otaModuleInfoIndex:output_type -> dm.OtaModuleInfoIndexResp
	8,   // 367: dm.OtaManage.otaModuleInfoRead:output_type -> dm.OtaModuleInfo
	0,   // 368: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 369: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	17,  // 370: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	5,   // 371: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 372: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 373: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	0,   // 374: dm.userDevice.userDeviceShareMultiDelete:output_type -> dm.Empty
	13,  // 375: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	15,  // 376: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
	0,   // 377: dm.userDevice.userDeviceTransfer:output_type -> dm.Empty
	263, // [263:378] is the sub-list for method output_type
	148, // [148:263] is the sub-list for method input_type
