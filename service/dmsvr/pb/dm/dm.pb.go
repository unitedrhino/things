...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x65, 0x61, 0x49, 0x44, 0x22, 0xca, 0x04, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69, 0x63,
	...
	0x6f, 0x22, 0xa2, 0x01, 0x0a, 0x14, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x57, 0x0a, 0x15, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	...
	0xc4, 0x03, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	...
	0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x43, 0x0a, 0x16, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x65, 0x4d, 0x64, 0x35, 0x22, 0xcc, 0x02, 0x0a,
	...
	0x52, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x73, 0x22, 0x86, 0x01, 0x0a, 0x18,
	...
	0x66, 0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61,
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x81,
	...
	0x66, 0x79, 0x22, 0x85, 0x05, 0x0a, 0x12, 0x4f, 0x74, 0x61, 0x46, 0x69, 0x72, 0x6d, 0x77, 0x61,
	...
	0x65, 0x6e, 0x61, 0x6e, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x73, 0x22, 0x35, 0x0a, 0x11, 0x4f, 0x74,
...
var file_proto_dm_proto_msgTypes = make([]protoimpl.MessageInfo, 161)
var file_proto_dm_proto_goTypes = []interface{}{
	...
	(*OtaFirmwareInfoCreateReq)(nil),     // 134: dm.OtaFirmwareInfoCreateReq
	(*OtaFirmwareInfoUpdateReq)(nil),     // 135: dm.OtaFirmwareInfoUpdateReq
	(*OtaFirmwareInfoIndexReq)(nil),      // 136: dm.OtaFirmwareInfoIndexReq
	(*OtaFirmwareInfoIndexResp)(nil),     // 137: dm.OtaFirmwareInfoIndexResp
	(*OtaFirmwareInfo)(nil),              // 138: dm.OtaFirmwareInfo
	(*OtaFirmwareJobInfo)(nil),           // 139: dm.OtaFirmwareJobInfo
	(*OtaJobDynamicInfo)(nil),            // 140: dm.OtaJobDynamicInfo
	(*OtaJobStaticInfo)(nil),             // 141: dm.OtaJobStaticInfo
	(*OtaFirmwareJobIndexReq)(nil),       // 142: dm.OtaFirmwareJobIndexReq
	(*OtaFirmwareJobIndexResp)(nil),      // 143: dm.OtaFirmwareJobIndexResp
	(*OtaJobByDeviceIndexReq)(nil),       // 144: dm.OtaJobByDeviceIndexReq
	(*OtaFirmwareDeviceIndexReq)(nil),    // 145: dm.OtaFirmwareDeviceIndexReq
	(*OtaFirmwareDeviceInfo)(nil),        // 146: dm.OtaFirmwareDeviceInfo
	(*OtaFirmwareDeviceIndexResp)(nil),   // 147: dm.OtaFirmwareDeviceIndexResp
	(*OtaFirmwareDeviceCancelReq)(nil),   // 148: dm.OtaFirmwareDeviceCancelReq
	(*OtaFirmwareDeviceRetryReq)(nil),    // 149: dm.OtaFirmwareDeviceRetryReq
	(*PageInfo_OrderBy)(nil),             // 150: dm.PageInfo.OrderBy
	nil,                                  // 151: dm.ProtocolConfigInfo.ConfigEntry
	nil,                                  // 152: dm.GroupInfo.TagsEntry
	nil,                                  // 153: dm.GroupInfoIndexReq.TagsEntry
	nil,                                  // 154: dm.GroupInfoUpdateReq.TagsEntry
	nil,                                  // 155: dm.DeviceInfo.TagsEntry
	nil,                                  // 156: dm.DeviceInfo.SchemaAliasEntry
	nil,                                  // 157: dm.ProductInfo.TagsEntry
	nil,                                  // 158: dm.ProductInfoIndexReq.TagsEntry
	nil,                                  // 159: dm.DeviceInfoIndexReq.TagsEntry
	nil,                                  // 160: dm.DeviceCountInfo.CountEntry
...
var file_proto_dm_proto_depIdxs = []int32{
	150, // 0: dm.PageInfo.orders:type_name -> dm.PageInfo.OrderBy
	...
	161, // 7: dm.ProductCategory.desc:type_name -> google.protobuf.StringValue
	...
	151, // 15: dm.ProtocolConfigInfo.config:type_name -> dm.ProtocolConfigInfo.ConfigEntry
	...
	161, // 35: dm.ProductCustom.transformScript:type_name -> google.protobuf.StringValue
	161, // 36: dm.ProductCustom.loginAuthScript:type_name -> google.protobuf.StringValue
	...
	152, // 45: dm.GroupInfo.tags:type_name -> dm.GroupInfo.TagsEntry
	2,   // 46: dm.GroupInfoIndexReq.page:type_name -> dm.PageInfo
	153, // 47: dm.GroupInfoIndexReq.tags:type_name -> dm.GroupInfoIndexReq.TagsEntry
	73,  // 48: dm.GroupInfoIndexResp.list:type_name -> dm.GroupInfo
	154, // 49: dm.GroupInfoUpdateReq.tags:type_name -> dm.GroupInfoUpdateReq.TagsEntry
	...
	161, // 54: dm.DeviceInfo.version:type_name -> google.protobuf.StringValue
	82,  // 55: dm.DeviceInfo.Position:type_name -> dm.Point
	161, // 56: dm.DeviceInfo.address:type_name -> google.protobuf.StringValue
	155, // 57: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	161, // 58: dm.DeviceInfo.deviceAlias:type_name -> google.protobuf.StringValue
	161, // 59: dm.DeviceInfo.phone:type_name -> google.protobuf.StringValue
	161, // 60: dm.DeviceInfo.iccid:type_name -> google.protobuf.StringValue
	156, // 61: dm.DeviceInfo.schemaAlias:type_name -> dm.DeviceInfo.SchemaAliasEntry
	162, // 62: dm.DeviceInfo.rssi:type_name -> google.protobuf.Int64Value
	161, // 63: dm.ProductInfo.desc:type_name -> google.protobuf.StringValue
	161, // 64: dm.ProductInfo.devStatus:type_name -> google.protobuf.StringValue
	157, // 65: dm.ProductInfo.tags:type_name -> dm.ProductInfo.TagsEntry
	...
	158, // 69: dm.ProductInfoIndexReq.tags:type_name -> dm.ProductInfoIndexReq.TagsEntry
	...
	159, // 73: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	...
	161, // 81: dm.CommonSchemaInfo.name:type_name -> google.protobuf.StringValue
	161, // 82: dm.CommonSchemaInfo.desc:type_name -> google.protobuf.StringValue
	161, // 83: dm.CommonSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	...
	161, // 89: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	161, // 90: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	161, // 91: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	113, // 92: dm.DeviceCountResp.list:type_name -> dm.DeviceCountInfo
	160, // 93: dm.DeviceCountInfo.count:type_name -> dm.DeviceCountInfo.CountEntry
	1,   // 94: dm.DeviceInfoCountReq.timeRange:type_name -> dm.TimeRange
	1,   // 95: dm.DeviceTypeCountReq.timeRange:type_name -> dm.TimeRange
	161, // 96: dm.Firmware.desc:type_name -> google.protobuf.StringValue
	161, // 97: dm.Firmware.extData:type_name -> google.protobuf.StringValue
	121, // 98: dm.Firmware.files:type_name -> dm.OtaFirmwareFile
	161, // 99: dm.FirmwareInfo.desc:type_name -> google.protobuf.StringValue
	161, // 100: dm.FirmwareInfo.extData:type_name -> google.protobuf.StringValue
	121, // 101: dm.FirmwareInfo.files:type_name -> dm.OtaFirmwareFile
	2,   // 102: dm.FirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	120, // 103: dm.FirmwareInfoIndexResp.list:type_name -> dm.FirmwareInfo
	2,   // 104: dm.OtaFirmwareFileIndexReq.page:type_name -> dm.PageInfo
	162, // 105: dm.OtaFirmwareFileIndexReq.size:type_name -> google.protobuf.Int64Value
	128, // 106: dm.OtaFirmwareFileIndexResp.list:type_name -> dm.OtaFirmwareFileInfo
	161, // 107: dm.FirmwareInfoReadResp.desc:type_name -> google.protobuf.StringValue
	161, // 108: dm.FirmwareInfoReadResp.extData:type_name -> google.protobuf.StringValue
	129, // 109: dm.FirmwareInfoReadResp.files:type_name -> dm.OtaFirmwareFileResp
	161, // 110: dm.OtaFirmwareInfoCreateReq.extra:type_name -> google.protobuf.StringValue
	161, // 111: dm.OtaFirmwareInfoUpdateReq.extra:type_name -> google.protobuf.StringValue
	2,   // 112: dm.OtaFirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	138, // 113: dm.OtaFirmwareInfoIndexResp.list:type_name -> dm.OtaFirmwareInfo
	133, // 114: dm.OtaFirmwareInfo.fileList:type_name -> dm.FirmwareFile
	140, // 115: dm.OtaFirmwareJobInfo.dynamic:type_name -> dm.OtaJobDynamicInfo
	141, // 116: dm.OtaFirmwareJobInfo.static:type_name -> dm.OtaJobStaticInfo
	2,   // 117: dm.OtaFirmwareJobIndexReq.pageInfo:type_name -> dm.PageInfo
	139, // 118: dm.OtaFirmwareJobIndexResp.list:type_name -> dm.OtaFirmwareJobInfo
	2,   // 119: dm.OtaJobByDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	2,   // 120: dm.OtaFirmwareDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	146, // 121: dm.OtaFirmwareDeviceIndexResp.list:type_name -> dm.OtaFirmwareDeviceInfo
	95,  // 122: dm.DeviceManage.rootCheck:input_type -> dm.RootCheckReq
	83,  // 123: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	83,  // 124: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	89,  // 125: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	93,  // 126: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	92,  // 127: dm.DeviceManage.DeviceInfoMultiUpdate:input_type -> dm.DeviceInfoMultiUpdateReq
	91,  // 128: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	69,  // 129: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	70,  // 130: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	72,  // 131: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiDeleteReq
	114, // 132: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	115, // 133: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	111, // 134: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	6,   // 135: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	84,  // 136: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	84,  // 137: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	85,  // 138: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	87,  // 139: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	86,  // 140: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	101, // 141: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	103, // 142: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	102, // 143: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	104, // 144: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	105, // 145: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	108, // 146: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	109, // 147: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	64,  // 148: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	65,  // 149: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	12,  // 150: dm.ProductManage.productCategoryCreate:input_type -> dm.ProductCategory
	12,  // 151: dm.ProductManage.productCategoryUpdate:input_type -> dm.ProductCategory
	5,   // 152: dm.ProductManage.productCategoryDelete:input_type -> dm.WithID
	14,  // 153: dm.ProductManage.productCategoryIndex:input_type -> dm.ProductCategoryIndexReq
	13,  // 154: dm.ProductManage.productCategoryRead:input_type -> dm.ProductCategoryReadReq
	96,  // 155: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	97,  // 156: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	5,   // 157: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	98,  // 158: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	16,  // 159: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	4,   // 160: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	18,  // 161: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	18,  // 162: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	5,   // 163: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	73,  // 164: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	75,  // 165: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	5,   // 166: dm.DeviceGroup.groupInfoRead:input_type -> dm.WithID
	73,  // 167: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	5,   // 168: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	78,  // 169: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	78,  // 170: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	79,  // 171: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	81,  // 172: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	58,  // 173: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	59,  // 174: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	61,  // 175: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	62,  // 176: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	41,  // 177: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	32,  // 178: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	38,  // 179: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	35,  // 180: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	26,  // 181: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	25,  // 182: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	29,  // 183: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	26,  // 184: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	55,  // 185: dm.DeviceMsg.otaPromptIndex:input_type -> dm.OtaPromptIndexReq
	44,  // 186: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	46,  // 187: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	48,  // 188: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	23,  // 189: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	47,  // 190: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	52,  // 191: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	46,  // 192: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	50,  // 193: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	134, // 194: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	135, // 195: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	5,   // 196: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	136, // 197: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	5,   // 198: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	139, // 199: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	142, // 200: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	5,   // 201: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	139, // 202: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	145, // 203: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	148, // 204: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	149, // 205: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	11,  // 206: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	11,  // 207: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 208: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	10,  // 209: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	10,  // 210: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	5,   // 211: dm.userDevice.userDeviceShareDelete:input_type -> dm.WithID
	8,   // 212: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	7,   // 213: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	0,   // 214: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 215: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 216: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 217: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	94,  // 218: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 219: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	83,  // 220: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 221: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	71,  // 222: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 223: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	116, // 224: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	117, // 225: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	112, // 226: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	0,   // 227: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 228: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 229: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 230: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	88,  // 231: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	84,  // 232: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 233: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 234: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 235: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 236: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	106, // 237: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 238: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	110, // 239: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	65,  // 240: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 241: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	5,   // 242: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 243: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 244: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	15,  // 245: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	12,  // 246: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	0,   // 247: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 248: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 249: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	99,  // 250: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	17,  // 251: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	18,  // 252: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	5,   // 253: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 254: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 255: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	5,   // 256: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	76,  // 257: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	73,  // 258: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 259: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 260: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 261: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 262: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	80,  // 263: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,   // 264: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 265: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	60,  // 266: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 267: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	63,  // 268: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	42,  // 269: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	33,  // 270: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	39,  // 271: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	36,  // 272: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	28,  // 273: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	28,  // 274: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	31,  // 275: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	21,  // 276: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	56,  // 277: dm.DeviceMsg.otaPromptIndex:output_type -> dm.OtaPromptIndexResp
	45,  // 278: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	45,  // 279: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 280: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	24,  // 281: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	49,  // 282: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	54,  // 283: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	49,  // 284: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	51,  // 285: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	5,   // 286: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	5,   // 287: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 288: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	137, // 289: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	138, // 290: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	5,   // 291: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	143, // 292: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	139, // 293: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 294: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	147, // 295: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 296: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 297: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	0,   // 298: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 299: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	11,  // 300: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	5,   // 301: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 302: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 303: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	9,   // 304: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	10,  // 305: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
