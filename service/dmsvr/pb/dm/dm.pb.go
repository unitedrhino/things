...
type UserDeviceShareInfo struct {
	...
	NormalPerm        int64       `protobuf:"varint,4,opt,name=normalPerm,proto3" json:"normalPerm,omitempty"`              //普通功能权限 1:r(只读) 3:rw(可读可写)
	SystemPerm        int64       `protobuf:"varint,5,opt,name=systemPerm,proto3" json:"systemPerm,omitempty"`              //系统功能权限 1:r(只读) 3:rw(可读可写)
...
func (x *UserDeviceShareInfo) GetNormalPerm() int64 {
	if x != nil {
		return x.NormalPerm
	}
	return 0
...
func (x *UserDeviceShareInfo) GetSystemPerm() int64 {
	if x != nil {
		return x.SystemPerm
	}
	return 0
...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x6e, 0x6f, 0x72, 0x6d, 0x61, 0x6c, 0x50, 0x65, 0x72, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0a, 0x6e, 0x6f, 0x72, 0x6d, 0x61, 0x6c, 0x50, 0x65, 0x72, 0x6d, 0x12, 0x1e, 0x0a, 0x0a,
	0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x50, 0x65, 0x72, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0a, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x50, 0x65, 0x72, 0x6d, 0x12, 0x1c, 0x0a, 0x09,
