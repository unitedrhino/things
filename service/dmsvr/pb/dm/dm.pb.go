...
var file_proto_dm_proto_rawDesc = []byte{
	...
	0x44, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d,
	0x65, 0x32, 0xaa, 0x0d, 0x0a, 0x0c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x61, 0x6e, 0x61,
	...
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73, 0x70, 0x32, 0xd6,
	...
	0x64, 0x52, 0x65, 0x73, 0x70, 0x32, 0xe2, 0x04, 0x0a, 0x09, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
...
var file_proto_dm_proto_msgTypes = make([]protoimpl.MessageInfo, 210)
var file_proto_dm_proto_goTypes = []interface{}{
	...
	(*DeviceProfile)(nil),                     // 143: dm.DeviceProfile
	(*DeviceProfileReadReq)(nil),              // 144: dm.DeviceProfileReadReq
	(*DeviceInfoCanBindReq)(nil),              // 145: dm.DeviceInfoCanBindReq
	(*DeviceInfoMultiBindReq)(nil),            // 146: dm.DeviceInfoMultiBindReq
	(*DeviceInfoMultiBindResp)(nil),           // 147: dm.DeviceInfoMultiBindResp
	(*DeviceInfoBindReq)(nil),                 // 148: dm.DeviceInfoBindReq
	(*DeviceProfileIndexReq)(nil),             // 149: dm.DeviceProfileIndexReq
	(*DeviceProfileIndexResp)(nil),            // 150: dm.DeviceProfileIndexResp
	(*DeviceCountReq)(nil),                    // 151: dm.DeviceCountReq
	(*DeviceCountResp)(nil),                   // 152: dm.DeviceCountResp
	(*DeviceCountInfo)(nil),                   // 153: dm.DeviceCountInfo
	(*DeviceInfoCountReq)(nil),                // 154: dm.DeviceInfoCountReq
	(*DeviceTypeCountReq)(nil),                // 155: dm.DeviceTypeCountReq
	(*DeviceInfoCount)(nil),                   // 156: dm.DeviceInfoCount
	(*DeviceTypeCountResp)(nil),               // 157: dm.DeviceTypeCountResp
	(*Firmware)(nil),                          // 158: dm.Firmware
	(*FirmwareResp)(nil),                      // 159: dm.FirmwareResp
	(*FirmwareInfo)(nil),                      // 160: dm.FirmwareInfo
	(*OtaFirmwareFile)(nil),                   // 161: dm.OtaFirmwareFile
	(*FirmwareInfoDeleteReq)(nil),             // 162: dm.FirmwareInfoDeleteReq
	(*FirmwareInfoDeleteResp)(nil),            // 163: dm.FirmwareInfoDeleteResp
	(*FirmwareInfoIndexReq)(nil),              // 164: dm.FirmwareInfoIndexReq
	(*FirmwareInfoIndexResp)(nil),             // 165: dm.FirmwareInfoIndexResp
	(*FirmwareInfoReadReq)(nil),               // 166: dm.FirmwareInfoReadReq
	(*OtaFirmwareFileReq)(nil),                // 167: dm.OtaFirmwareFileReq
	(*OtaFirmwareFileInfo)(nil),               // 168: dm.OtaFirmwareFileInfo
	(*OtaFirmwareFileResp)(nil),               // 169: dm.OtaFirmwareFileResp
	(*OtaFirmwareFileIndexReq)(nil),           // 170: dm.OtaFirmwareFileIndexReq
	(*OtaFirmwareFileIndexResp)(nil),          // 171: dm.OtaFirmwareFileIndexResp
	(*FirmwareInfoReadResp)(nil),              // 172: dm.FirmwareInfoReadResp
	(*FirmwareFile)(nil),                      // 173: dm.FirmwareFile
	(*OtaFirmwareInfoCreateReq)(nil),          // 174: dm.OtaFirmwareInfoCreateReq
	(*OtaFirmwareInfoUpdateReq)(nil),          // 175: dm.OtaFirmwareInfoUpdateReq
	(*OtaFirmwareInfoIndexReq)(nil),           // 176: dm.OtaFirmwareInfoIndexReq
	(*OtaFirmwareInfoIndexResp)(nil),          // 177: dm.OtaFirmwareInfoIndexResp
	(*OtaFirmwareInfo)(nil),                   // 178: dm.OtaFirmwareInfo
	(*OtaFirmwareJobInfo)(nil),                // 179: dm.OtaFirmwareJobInfo
	(*OtaJobDynamicInfo)(nil),                 // 180: dm.OtaJobDynamicInfo
	(*OtaJobStaticInfo)(nil),                  // 181: dm.OtaJobStaticInfo
	(*OtaFirmwareJobIndexReq)(nil),            // 182: dm.OtaFirmwareJobIndexReq
	(*OtaFirmwareJobIndexResp)(nil),           // 183: dm.OtaFirmwareJobIndexResp
	(*OtaJobByDeviceIndexReq)(nil),            // 184: dm.OtaJobByDeviceIndexReq
	(*OtaFirmwareDeviceIndexReq)(nil),         // 185: dm.OtaFirmwareDeviceIndexReq
	(*OtaFirmwareDeviceInfo)(nil),             // 186: dm.OtaFirmwareDeviceInfo
	(*OtaFirmwareDeviceIndexResp)(nil),        // 187: dm.OtaFirmwareDeviceIndexResp
	(*OtaFirmwareDeviceCancelReq)(nil),        // 188: dm.OtaFirmwareDeviceCancelReq
	(*OtaFirmwareDeviceRetryReq)(nil),         // 189: dm.OtaFirmwareDeviceRetryReq
	(*OtaFirmwareDeviceConfirmReq)(nil),       // 190: dm.OtaFirmwareDeviceConfirmReq
	(*PageInfo_OrderBy)(nil),                  // 191: dm.PageInfo.OrderBy
	nil,                                       // 192: dm.UserDeviceShareInfo.SchemaPermEntry
	nil,                                       // 193: dm.UserDeviceShareInfo.AccessPermEntry
	nil,                                       // 194: dm.UserDeviceShareMultiInfo.SchemaPermEntry
	nil,                                       // 195: dm.UserDeviceShareMultiInfo.AccessPermEntry
	nil,                                       // 196: dm.ProtocolConfigInfo.ConfigEntry
	nil,                                       // 197: dm.GroupInfo.TagsEntry
	nil,                                       // 198: dm.GroupInfoIndexReq.TagsEntry
	nil,                                       // 199: dm.GroupInfoUpdateReq.TagsEntry
	nil,                                       // 200: dm.DeviceInfo.TagsEntry
	nil,                                       // 201: dm.DeviceInfo.SchemaAliasEntry
	nil,                                       // 202: dm.DeviceInfo.ProtocolConfEntry
	nil,                                       // 203: dm.ProductInfo.TagsEntry
	nil,                                       // 204: dm.ProductInfo.ProtocolConfEntry
	nil,                                       // 205: dm.ProductInfo.CustomUiEntry
	nil,                                       // 206: dm.ProductInfoIndexReq.TagsEntry
	nil,                                       // 207: dm.ProductInfoIndexReq.ProtocolConfEntry
	nil,                                       // 208: dm.DeviceInfoIndexReq.TagsEntry
	nil,                                       // 209: dm.DeviceCountInfo.CountEntry
...
var file_proto_dm_proto_depIdxs = []int32{
	191, // 0: dm.PageInfo.orders:type_name -> dm.PageInfo.OrderBy
	...
	192, // 14: dm.UserDeviceShareInfo.schemaPerm:type_name -> dm.UserDeviceShareInfo.SchemaPermEntry
	193, // 15: dm.UserDeviceShareInfo.accessPerm:type_name -> dm.UserDeviceShareInfo.AccessPermEntry
	210, // 16: dm.UserDeviceShareInfo.expTime:type_name -> google.protobuf.Int64Value
	211, // 17: dm.DeviceShareInfo.deviceAlias:type_name -> google.protobuf.StringValue
	27,  // 18: dm.UserDeviceShareMultiInfo.devices:type_name -> dm.DeviceShareInfo
	194, // 19: dm.UserDeviceShareMultiInfo.schemaPerm:type_name -> dm.UserDeviceShareMultiInfo.SchemaPermEntry
	195, // 20: dm.UserDeviceShareMultiInfo.accessPerm:type_name -> dm.UserDeviceShareMultiInfo.AccessPermEntry
	...
	211, // 23: dm.ProductCategory.desc:type_name -> google.protobuf.StringValue
	...
	196, // 33: dm.ProtocolConfigInfo.config:type_name -> dm.ProtocolConfigInfo.ConfigEntry
	...
	211, // 56: dm.ProductCustom.transformScript:type_name -> google.protobuf.StringValue
	211, // 57: dm.ProductCustom.loginAuthScript:type_name -> google.protobuf.StringValue
	...
	197, // 70: dm.GroupInfo.tags:type_name -> dm.GroupInfo.TagsEntry
	...
	198, // 74: dm.GroupInfoIndexReq.tags:type_name -> dm.GroupInfoIndexReq.TagsEntry
	101, // 75: dm.GroupInfoIndexResp.list:type_name -> dm.GroupInfo
	199, // 76: dm.GroupInfoUpdateReq.tags:type_name -> dm.GroupInfoUpdateReq.TagsEntry
	...
	211, // 81: dm.DeviceInfo.version:type_name -> google.protobuf.StringValue
	110, // 82: dm.DeviceInfo.Position:type_name -> dm.Point
	211, // 83: dm.DeviceInfo.address:type_name -> google.protobuf.StringValue
	211, // 84: dm.DeviceInfo.adcode:type_name -> google.protobuf.StringValue
	200, // 85: dm.DeviceInfo.tags:type_name -> dm.DeviceInfo.TagsEntry
	211, // 86: dm.DeviceInfo.deviceAlias:type_name -> google.protobuf.StringValue
	211, // 87: dm.DeviceInfo.phone:type_name -> google.protobuf.StringValue
	211, // 88: dm.DeviceInfo.iccid:type_name -> google.protobuf.StringValue
	201, // 89: dm.DeviceInfo.schemaAlias:type_name -> dm.DeviceInfo.SchemaAliasEntry
	210, // 90: dm.DeviceInfo.rssi:type_name -> google.protobuf.Int64Value
	202, // 91: dm.DeviceInfo.protocolConf:type_name -> dm.DeviceInfo.ProtocolConfEntry
	10,  // 92: dm.DeviceInfo.distributor:type_name -> dm.IDPathWithUpdate
	210, // 93: dm.DeviceInfo.expTime:type_name -> google.protobuf.Int64Value
	111, // 94: dm.DeviceInfo.Gateway:type_name -> dm.DeviceInfo
	211, // 95: dm.ProductInfo.desc:type_name -> google.protobuf.StringValue
	203, // 96: dm.ProductInfo.tags:type_name -> dm.ProductInfo.TagsEntry
	43,  // 97: dm.ProductInfo.protocol:type_name -> dm.ProtocolInfo
	32,  // 98: dm.ProductInfo.category:type_name -> dm.ProductCategory
	204, // 99: dm.ProductInfo.protocolConf:type_name -> dm.ProductInfo.ProtocolConfEntry
	210, // 100: dm.ProductInfo.trialTime:type_name -> google.protobuf.Int64Value
	205, // 101: dm.ProductInfo.customUi:type_name -> dm.ProductInfo.CustomUiEntry
	2,   // 102: dm.ProductInfoIndexReq.page:type_name -> dm.PageInfo
	206, // 103: dm.ProductInfoIndexReq.tags:type_name -> dm.ProductInfoIndexReq.TagsEntry
	207, // 104: dm.ProductInfoIndexReq.protocolConf:type_name -> dm.ProductInfoIndexReq.ProtocolConfEntry
	...
	208, // 112: dm.DeviceInfoIndexReq.tags:type_name -> dm.DeviceInfoIndexReq.TagsEntry
	...
	211, // 124: dm.CommonSchemaInfo.name:type_name -> google.protobuf.StringValue
	211, // 125: dm.CommonSchemaInfo.desc:type_name -> google.protobuf.StringValue
	211, // 126: dm.CommonSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	...
	211, // 133: dm.ProductSchemaInfo.name:type_name -> google.protobuf.StringValue
	211, // 134: dm.ProductSchemaInfo.desc:type_name -> google.protobuf.StringValue
	211, // 135: dm.ProductSchemaInfo.affordance:type_name -> google.protobuf.StringValue
	121, // 136: dm.DeviceProfile.device:type_name -> dm.DeviceCore
	121, // 137: dm.DeviceProfileReadReq.device:type_name -> dm.DeviceCore
	121, // 138: dm.DeviceInfoCanBindReq.device:type_name -> dm.DeviceCore
	121, // 139: dm.DeviceInfoMultiBindReq.devices:type_name -> dm.DeviceCore
	122, // 140: dm.DeviceInfoMultiBindResp.errs:type_name -> dm.DeviceError
	121, // 141: dm.DeviceInfoBindReq.device:type_name -> dm.DeviceCore
	121, // 142: dm.DeviceProfileIndexReq.device:type_name -> dm.DeviceCore
	143, // 143: dm.DeviceProfileIndexResp.profiles:type_name -> dm.DeviceProfile
	153, // 144: dm.DeviceCountResp.list:type_name -> dm.DeviceCountInfo
	209, // 145: dm.DeviceCountInfo.count:type_name -> dm.DeviceCountInfo.CountEntry
	1,   // 146: dm.DeviceInfoCountReq.timeRange:type_name -> dm.TimeRange
	1,   // 147: dm.DeviceTypeCountReq.timeRange:type_name -> dm.TimeRange
	211, // 148: dm.Firmware.desc:type_name -> google.protobuf.StringValue
	211, // 149: dm.Firmware.extData:type_name -> google.protobuf.StringValue
	161, // 150: dm.Firmware.files:type_name -> dm.OtaFirmwareFile
	211, // 151: dm.FirmwareInfo.desc:type_name -> google.protobuf.StringValue
	211, // 152: dm.FirmwareInfo.extData:type_name -> google.protobuf.StringValue
	161, // 153: dm.FirmwareInfo.files:type_name -> dm.OtaFirmwareFile
	2,   // 154: dm.FirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	160, // 155: dm.FirmwareInfoIndexResp.list:type_name -> dm.FirmwareInfo
	2,   // 156: dm.OtaFirmwareFileIndexReq.page:type_name -> dm.PageInfo
	210, // 157: dm.OtaFirmwareFileIndexReq.size:type_name -> google.protobuf.Int64Value
	168, // 158: dm.OtaFirmwareFileIndexResp.list:type_name -> dm.OtaFirmwareFileInfo
	211, // 159: dm.FirmwareInfoReadResp.desc:type_name -> google.protobuf.StringValue
	211, // 160: dm.FirmwareInfoReadResp.extData:type_name -> google.protobuf.StringValue
	169, // 161: dm.FirmwareInfoReadResp.files:type_name -> dm.OtaFirmwareFileResp
	211, // 162: dm.OtaFirmwareInfoCreateReq.extra:type_name -> google.protobuf.StringValue
	211, // 163: dm.OtaFirmwareInfoUpdateReq.extra:type_name -> google.protobuf.StringValue
	2,   // 164: dm.OtaFirmwareInfoIndexReq.page:type_name -> dm.PageInfo
	178, // 165: dm.OtaFirmwareInfoIndexResp.list:type_name -> dm.OtaFirmwareInfo
	173, // 166: dm.OtaFirmwareInfo.fileList:type_name -> dm.FirmwareFile
	180, // 167: dm.OtaFirmwareJobInfo.dynamic:type_name -> dm.OtaJobDynamicInfo
	181, // 168: dm.OtaFirmwareJobInfo.static:type_name -> dm.OtaJobStaticInfo
	2,   // 169: dm.OtaFirmwareJobIndexReq.page:type_name -> dm.PageInfo
	179, // 170: dm.OtaFirmwareJobIndexResp.list:type_name -> dm.OtaFirmwareJobInfo
	2,   // 171: dm.OtaJobByDeviceIndexReq.pageInfo:type_name -> dm.PageInfo
	2,   // 172: dm.OtaFirmwareDeviceIndexReq.page:type_name -> dm.PageInfo
	186, // 173: dm.OtaFirmwareDeviceIndexResp.list:type_name -> dm.OtaFirmwareDeviceInfo
	26,  // 174: dm.UserDeviceShareInfo.SchemaPermEntry.value:type_name -> dm.SharePerm
	26,  // 175: dm.UserDeviceShareInfo.AccessPermEntry.value:type_name -> dm.SharePerm
	26,  // 176: dm.UserDeviceShareMultiInfo.SchemaPermEntry.value:type_name -> dm.SharePerm
	26,  // 177: dm.UserDeviceShareMultiInfo.AccessPermEntry.value:type_name -> dm.SharePerm
	113, // 178: dm.ProductInfo.CustomUiEntry.value:type_name -> dm.ProductCustomUi
	127, // 179: dm.DeviceManage.rootCheck:input_type -> dm.RootCheckReq
	111, // 180: dm.DeviceManage.deviceInfoCreate:input_type -> dm.DeviceInfo
	111, // 181: dm.DeviceManage.deviceInfoUpdate:input_type -> dm.DeviceInfo
	118, // 182: dm.DeviceManage.deviceOnlineMultiFix:input_type -> dm.deviceOnlineMultiFixReq
	120, // 183: dm.DeviceManage.deviceInfoDelete:input_type -> dm.DeviceInfoDeleteReq
	125, // 184: dm.DeviceManage.deviceInfoIndex:input_type -> dm.DeviceInfoIndexReq
	124, // 185: dm.DeviceManage.DeviceInfoMultiUpdate:input_type -> dm.DeviceInfoMultiUpdateReq
	123, // 186: dm.DeviceManage.deviceInfoRead:input_type -> dm.DeviceInfoReadReq
	148, // 187: dm.DeviceManage.deviceInfoBind:input_type -> dm.DeviceInfoBindReq
	146, // 188: dm.DeviceManage.deviceInfoMultiBind:input_type -> dm.DeviceInfoMultiBindReq
	145, // 189: dm.DeviceManage.deviceInfoCanBind:input_type -> dm.DeviceInfoCanBindReq
	121, // 190: dm.DeviceManage.deviceInfoUnbind:input_type -> dm.DeviceCore
	20,  // 191: dm.DeviceManage.deviceTransfer:input_type -> dm.DeviceTransferReq
	19,  // 192: dm.DeviceManage.deviceMove:input_type -> dm.DeviceMoveReq
	15,  // 193: dm.DeviceManage.deviceModuleVersionRead:input_type -> dm.DeviceModuleVersionReadReq
	17,  // 194: dm.DeviceManage.deviceModuleVersionIndex:input_type -> dm.DeviceModuleVersionIndexReq
	95,  // 195: dm.DeviceManage.deviceGatewayMultiCreate:input_type -> dm.DeviceGatewayMultiCreateReq
	98,  // 196: dm.DeviceManage.deviceGatewayMultiUpdate:input_type -> dm.DeviceGatewayMultiSaveReq
	96,  // 197: dm.DeviceManage.deviceGatewayIndex:input_type -> dm.DeviceGatewayIndexReq
	98,  // 198: dm.DeviceManage.deviceGatewayMultiDelete:input_type -> dm.DeviceGatewayMultiSaveReq
	154, // 199: dm.DeviceManage.deviceInfoCount:input_type -> dm.DeviceInfoCountReq
	155, // 200: dm.DeviceManage.deviceTypeCount:input_type -> dm.DeviceTypeCountReq
	151, // 201: dm.DeviceManage.deviceCount:input_type -> dm.DeviceCountReq
	144, // 202: dm.DeviceManage.deviceProfileRead:input_type -> dm.DeviceProfileReadReq
	144, // 203: dm.DeviceManage.deviceProfileDelete:input_type -> dm.DeviceProfileReadReq
	143, // 204: dm.DeviceManage.deviceProfileUpdate:input_type -> dm.DeviceProfile
	149, // 205: dm.DeviceManage.deviceProfileIndex:input_type -> dm.DeviceProfileIndexReq
	14,  // 206: dm.ProductManage.productInit:input_type -> dm.ProductInitReq
	112, // 207: dm.ProductManage.productInfoCreate:input_type -> dm.ProductInfo
	112, // 208: dm.ProductManage.productInfoUpdate:input_type -> dm.ProductInfo
	114, // 209: dm.ProductManage.productInfoDelete:input_type -> dm.ProductInfoDeleteReq
	116, // 210: dm.ProductManage.productInfoIndex:input_type -> dm.ProductInfoIndexReq
	115, // 211: dm.ProductManage.productInfoRead:input_type -> dm.ProductInfoReadReq
	133, // 212: dm.ProductManage.productSchemaUpdate:input_type -> dm.ProductSchemaUpdateReq
	135, // 213: dm.ProductManage.productSchemaCreate:input_type -> dm.ProductSchemaCreateReq
	134, // 214: dm.ProductManage.productSchemaMultiCreate:input_type -> dm.ProductSchemaMultiCreateReq
	136, // 215: dm.ProductManage.productSchemaDelete:input_type -> dm.ProductSchemaDeleteReq
	137, // 216: dm.ProductManage.productSchemaIndex:input_type -> dm.ProductSchemaIndexReq
	140, // 217: dm.ProductManage.productSchemaTslImport:input_type -> dm.ProductSchemaTslImportReq
	141, // 218: dm.ProductManage.productSchemaTslRead:input_type -> dm.ProductSchemaTslReadReq
	90,  // 219: dm.ProductManage.productCustomRead:input_type -> dm.ProductCustomReadReq
	91,  // 220: dm.ProductManage.productCustomUpdate:input_type -> dm.ProductCustom
	32,  // 221: dm.ProductManage.productCategoryCreate:input_type -> dm.ProductCategory
	32,  // 222: dm.ProductManage.productCategoryUpdate:input_type -> dm.ProductCategory
	7,   // 223: dm.ProductManage.productCategoryDelete:input_type -> dm.WithID
	36,  // 224: dm.ProductManage.productCategoryIndex:input_type -> dm.ProductCategoryIndexReq
	8,   // 225: dm.ProductManage.productCategoryRead:input_type -> dm.WithIDChildren
	34,  // 226: dm.ProductManage.productCategorySchemaIndex:input_type -> dm.ProductCategorySchemaIndexReq
	35,  // 227: dm.ProductManage.productCategorySchemaMultiUpdate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	35,  // 228: dm.ProductManage.productCategorySchemaMultiCreate:input_type -> dm.ProductCategorySchemaMultiSaveReq
	35,  // 229: dm.ProductManage.productCategorySchemaMultiDelete:input_type -> dm.ProductCategorySchemaMultiSaveReq
	0,   // 230: dm.SchemaManage.commonSchemaInit:input_type -> dm.Empty
	128, // 231: dm.SchemaManage.commonSchemaUpdate:input_type -> dm.CommonSchemaUpdateReq
	129, // 232: dm.SchemaManage.commonSchemaCreate:input_type -> dm.CommonSchemaCreateReq
	7,   // 233: dm.SchemaManage.commonSchemaDelete:input_type -> dm.WithID
	130, // 234: dm.SchemaManage.commonSchemaIndex:input_type -> dm.CommonSchemaIndexReq
	38,  // 235: dm.ProtocolManage.protocolInfoIndex:input_type -> dm.ProtocolInfoIndexReq
	6,   // 236: dm.ProtocolManage.protocolInfoRead:input_type -> dm.WithIDCode
	43,  // 237: dm.ProtocolManage.protocolInfoCreate:input_type -> dm.ProtocolInfo
	43,  // 238: dm.ProtocolManage.protocolInfoUpdate:input_type -> dm.ProtocolInfo
	7,   // 239: dm.ProtocolManage.protocolInfoDelete:input_type -> dm.WithID
	42,  // 240: dm.ProtocolManage.protocolServiceUpdate:input_type -> dm.ProtocolService
	7,   // 241: dm.ProtocolManage.protocolServiceDelete:input_type -> dm.WithID
	40,  // 242: dm.ProtocolManage.protocolServiceIndex:input_type -> dm.ProtocolServiceIndexReq
	101, // 243: dm.DeviceGroup.groupInfoCreate:input_type -> dm.GroupInfo
	103, // 244: dm.DeviceGroup.groupInfoIndex:input_type -> dm.GroupInfoIndexReq
	8,   // 245: dm.DeviceGroup.groupInfoRead:input_type -> dm.WithIDChildren
	101, // 246: dm.DeviceGroup.groupInfoUpdate:input_type -> dm.GroupInfo
	7,   // 247: dm.DeviceGroup.groupInfoDelete:input_type -> dm.WithID
	106, // 248: dm.DeviceGroup.groupDeviceMultiCreate:input_type -> dm.GroupDeviceMultiSaveReq
	106, // 249: dm.DeviceGroup.groupDeviceMultiUpdate:input_type -> dm.GroupDeviceMultiSaveReq
	107, // 250: dm.DeviceGroup.groupDeviceIndex:input_type -> dm.GroupDeviceIndexReq
	109, // 251: dm.DeviceGroup.groupDeviceMultiDelete:input_type -> dm.GroupDeviceMultiDeleteReq
	84,  // 252: dm.RemoteConfig.RemoteConfigCreate:input_type -> dm.RemoteConfigCreateReq
	85,  // 253: dm.RemoteConfig.RemoteConfigIndex:input_type -> dm.RemoteConfigIndexReq
	87,  // 254: dm.RemoteConfig.RemoteConfigPushAll:input_type -> dm.RemoteConfigPushAllReq
	88,  // 255: dm.RemoteConfig.RemoteConfigLastRead:input_type -> dm.RemoteConfigLastReadReq
	66,  // 256: dm.DeviceMsg.sdkLogIndex:input_type -> dm.SdkLogIndexReq
	57,  // 257: dm.DeviceMsg.hubLogIndex:input_type -> dm.HubLogIndexReq
	63,  // 258: dm.DeviceMsg.sendLogIndex:input_type -> dm.SendLogIndexReq
	60,  // 259: dm.DeviceMsg.statusLogIndex:input_type -> dm.StatusLogIndexReq
	51,  // 260: dm.DeviceMsg.propertyLogLatestIndex:input_type -> dm.PropertyLogLatestIndexReq
	50,  // 261: dm.DeviceMsg.propertyLogIndex:input_type -> dm.PropertyLogIndexReq
	54,  // 262: dm.DeviceMsg.eventLogIndex:input_type -> dm.EventLogIndexReq
	51,  // 263: dm.DeviceMsg.shadowIndex:input_type -> dm.PropertyLogLatestIndexReq
	99,  // 264: dm.DeviceMsg.gatewayCanBindIndex:input_type -> dm.GatewayCanBindIndexReq
	69,  // 265: dm.DeviceInteract.actionSend:input_type -> dm.ActionSendReq
	71,  // 266: dm.DeviceInteract.actionRead:input_type -> dm.RespReadReq
	74,  // 267: dm.DeviceInteract.actionResp:input_type -> dm.ActionRespReq
	48,  // 268: dm.DeviceInteract.propertyGetReportSend:input_type -> dm.PropertyGetReportSendReq
	72,  // 269: dm.DeviceInteract.propertyControlSend:input_type -> dm.PropertyControlSendReq
	80,  // 270: dm.DeviceInteract.propertyControlMultiSend:input_type -> dm.PropertyControlMultiSendReq
	71,  // 271: dm.DeviceInteract.propertyControlRead:input_type -> dm.RespReadReq
	78,  // 272: dm.DeviceInteract.sendMsg:input_type -> dm.SendMsgReq
	76,  // 273: dm.DeviceInteract.gatewayGetFoundSend:input_type -> dm.GatewayGetFoundReq
	77,  // 274: dm.DeviceInteract.gatewayNotifyBindSend:input_type -> dm.GatewayNotifyBindSendReq
	174, // 275: dm.OtaManage.otaFirmwareInfoCreate:input_type -> dm.OtaFirmwareInfoCreateReq
	175, // 276: dm.OtaManage.otaFirmwareInfoUpdate:input_type -> dm.OtaFirmwareInfoUpdateReq
	7,   // 277: dm.OtaManage.otaFirmwareInfoDelete:input_type -> dm.WithID
	176, // 278: dm.OtaManage.otaFirmwareInfoIndex:input_type -> dm.OtaFirmwareInfoIndexReq
	7,   // 279: dm.OtaManage.otaFirmwareInfoRead:input_type -> dm.WithID
	179, // 280: dm.OtaManage.otaFirmwareJobCreate:input_type -> dm.OtaFirmwareJobInfo
	182, // 281: dm.OtaManage.otaFirmwareJobIndex:input_type -> dm.OtaFirmwareJobIndexReq
	7,   // 282: dm.OtaManage.otaFirmwareJobRead:input_type -> dm.WithID
	179, // 283: dm.OtaManage.otaFirmwareJobUpdate:input_type -> dm.OtaFirmwareJobInfo
	185, // 284: dm.OtaManage.otaFirmwareDeviceIndex:input_type -> dm.OtaFirmwareDeviceIndexReq
	188, // 285: dm.OtaManage.otaFirmwareDeviceCancel:input_type -> dm.OtaFirmwareDeviceCancelReq
	189, // 286: dm.OtaManage.otaFirmwareDeviceRetry:input_type -> dm.OtaFirmwareDeviceRetryReq
	190, // 287: dm.OtaManage.otaFirmwareDeviceConfirm:input_type -> dm.OtaFirmwareDeviceConfirmReq
	13,  // 288: dm.OtaManage.otaModuleInfoCreate:input_type -> dm.OtaModuleInfo
	13,  // 289: dm.OtaManage.otaModuleInfoUpdate:input_type -> dm.OtaModuleInfo
	7,   // 290: dm.OtaManage.otaModuleInfoDelete:input_type -> dm.WithID
	11,  // 291: dm.OtaManage.otaModuleInfoIndex:input_type -> dm.OtaModuleInfoIndexReq
	6,   // 292: dm.OtaManage.otaModuleInfoRead:input_type -> dm.WithIDCode
	31,  // 293: dm.userDevice.userDeviceCollectMultiCreate:input_type -> dm.UserDeviceCollectSave
	31,  // 294: dm.userDevice.userDeviceCollectMultiDelete:input_type -> dm.UserDeviceCollectSave
	0,   // 295: dm.userDevice.userDeviceCollectIndex:input_type -> dm.Empty
	25,  // 296: dm.userDevice.userDeviceShareCreate:input_type -> dm.UserDeviceShareInfo
	25,  // 297: dm.userDevice.userDeviceShareUpdate:input_type -> dm.UserDeviceShareInfo
	21,  // 298: dm.userDevice.userDeviceShareDelete:input_type -> dm.UserDeviceShareReadReq
	24,  // 299: dm.userDevice.userDeviceShareMultiDelete:input_type -> dm.UserDeviceShareMultiDeleteReq
	22,  // 300: dm.userDevice.userDeviceShareIndex:input_type -> dm.UserDeviceShareIndexReq
	21,  // 301: dm.userDevice.userDeviceShareRead:input_type -> dm.UserDeviceShareReadReq
	20,  // 302: dm.userDevice.userDeviceTransfer:input_type -> dm.DeviceTransferReq
	28,  // 303: dm.userDevice.userDeviceShareMultiCreate:input_type -> dm.UserDeviceShareMultiInfo
	29,  // 304: dm.userDevice.userDeivceShareMultiIndex:input_type -> dm.UserDeviceShareMultiToken
	30,  // 305: dm.userDevice.userDeivceShareMultiAccept:input_type -> dm.UserDeviceShareMultiAcceptReq
	0,   // 306: dm.DeviceManage.rootCheck:output_type -> dm.Empty
	0,   // 307: dm.DeviceManage.deviceInfoCreate:output_type -> dm.Empty
	0,   // 308: dm.DeviceManage.deviceInfoUpdate:output_type -> dm.Empty
	0,   // 309: dm.DeviceManage.deviceOnlineMultiFix:output_type -> dm.Empty
	0,   // 310: dm.DeviceManage.deviceInfoDelete:output_type -> dm.Empty
	126, // 311: dm.DeviceManage.deviceInfoIndex:output_type -> dm.DeviceInfoIndexResp
	0,   // 312: dm.DeviceManage.DeviceInfoMultiUpdate:output_type -> dm.Empty
	111, // 313: dm.DeviceManage.deviceInfoRead:output_type -> dm.DeviceInfo
	0,   // 314: dm.DeviceManage.deviceInfoBind:output_type -> dm.Empty
	147, // 315: dm.DeviceManage.deviceInfoMultiBind:output_type -> dm.DeviceInfoMultiBindResp
	0,   // 316: dm.DeviceManage.deviceInfoCanBind:output_type -> dm.Empty
	0,   // 317: dm.DeviceManage.deviceInfoUnbind:output_type -> dm.Empty
	0,   // 318: dm.DeviceManage.deviceTransfer:output_type -> dm.Empty
	0,   // 319: dm.DeviceManage.deviceMove:output_type -> dm.Empty
	16,  // 320: dm.DeviceManage.deviceModuleVersionRead:output_type -> dm.DeviceModuleVersion
	18,  // 321: dm.DeviceManage.deviceModuleVersionIndex:output_type -> dm.DeviceModuleVersionIndexResp
	0,   // 322: dm.DeviceManage.deviceGatewayMultiCreate:output_type -> dm.Empty
	0,   // 323: dm.DeviceManage.deviceGatewayMultiUpdate:output_type -> dm.Empty
	97,  // 324: dm.DeviceManage.deviceGatewayIndex:output_type -> dm.DeviceGatewayIndexResp
	0,   // 325: dm.DeviceManage.deviceGatewayMultiDelete:output_type -> dm.Empty
	156, // 326: dm.DeviceManage.deviceInfoCount:output_type -> dm.DeviceInfoCount
	157, // 327: dm.DeviceManage.deviceTypeCount:output_type -> dm.DeviceTypeCountResp
	152, // 328: dm.DeviceManage.deviceCount:output_type -> dm.DeviceCountResp
	143, // 329: dm.DeviceManage.deviceProfileRead:output_type -> dm.DeviceProfile
	0,   // 330: dm.DeviceManage.deviceProfileDelete:output_type -> dm.Empty
	0,   // 331: dm.DeviceManage.deviceProfileUpdate:output_type -> dm.Empty
	150, // 332: dm.DeviceManage.deviceProfileIndex:output_type -> dm.DeviceProfileIndexResp
	0,   // 333: dm.ProductManage.productInit:output_type -> dm.Empty
	0,   // 334: dm.ProductManage.productInfoCreate:output_type -> dm.Empty
	0,   // 335: dm.ProductManage.productInfoUpdate:output_type -> dm.Empty
	0,   // 336: dm.ProductManage.productInfoDelete:output_type -> dm.Empty
	117, // 337: dm.ProductManage.productInfoIndex:output_type -> dm.ProductInfoIndexResp
	112, // 338: dm.ProductManage.productInfoRead:output_type -> dm.ProductInfo
	0,   // 339: dm.ProductManage.productSchemaUpdate:output_type -> dm.Empty
	0,   // 340: dm.ProductManage.productSchemaCreate:output_type -> dm.Empty
	0,   // 341: dm.ProductManage.productSchemaMultiCreate:output_type -> dm.Empty
	0,   // 342: dm.ProductManage.productSchemaDelete:output_type -> dm.Empty
	138, // 343: dm.ProductManage.productSchemaIndex:output_type -> dm.ProductSchemaIndexResp
	0,   // 344: dm.ProductManage.productSchemaTslImport:output_type -> dm.Empty
	142, // 345: dm.ProductManage.productSchemaTslRead:output_type -> dm.ProductSchemaTslReadResp
	91,  // 346: dm.ProductManage.productCustomRead:output_type -> dm.ProductCustom
	0,   // 347: dm.ProductManage.productCustomUpdate:output_type -> dm.Empty
	7,   // 348: dm.ProductManage.productCategoryCreate:output_type -> dm.WithID
	0,   // 349: dm.ProductManage.productCategoryUpdate:output_type -> dm.Empty
	0,   // 350: dm.ProductManage.productCategoryDelete:output_type -> dm.Empty
	37,  // 351: dm.ProductManage.productCategoryIndex:output_type -> dm.ProductCategoryIndexResp
	32,  // 352: dm.ProductManage.productCategoryRead:output_type -> dm.ProductCategory
	33,  // 353: dm.ProductManage.productCategorySchemaIndex:output_type -> dm.ProductCategorySchemaIndexResp
	0,   // 354: dm.ProductManage.productCategorySchemaMultiUpdate:output_type -> dm.Empty
	0,   // 355: dm.ProductManage.productCategorySchemaMultiCreate:output_type -> dm.Empty
	0,   // 356: dm.ProductManage.productCategorySchemaMultiDelete:output_type -> dm.Empty
	0,   // 357: dm.SchemaManage.commonSchemaInit:output_type -> dm.Empty
	0,   // 358: dm.SchemaManage.commonSchemaUpdate:output_type -> dm.Empty
	0,   // 359: dm.SchemaManage.commonSchemaCreate:output_type -> dm.Empty
	0,   // 360: dm.SchemaManage.commonSchemaDelete:output_type -> dm.Empty
	131, // 361: dm.SchemaManage.commonSchemaIndex:output_type -> dm.CommonSchemaIndexResp
	39,  // 362: dm.ProtocolManage.protocolInfoIndex:output_type -> dm.ProtocolInfoIndexResp
	43,  // 363: dm.ProtocolManage.protocolInfoRead:output_type -> dm.ProtocolInfo
	7,   // 364: dm.ProtocolManage.protocolInfoCreate:output_type -> dm.WithID
	0,   // 365: dm.ProtocolManage.protocolInfoUpdate:output_type -> dm.Empty
	0,   // 366: dm.ProtocolManage.protocolInfoDelete:output_type -> dm.Empty
	0,   // 367: dm.ProtocolManage.protocolServiceUpdate:output_type -> dm.Empty
	0,   // 368: dm.ProtocolManage.protocolServiceDelete:output_type -> dm.Empty
	41,  // 369: dm.ProtocolManage.protocolServiceIndex:output_type -> dm.ProtocolServiceIndexResp
	7,   // 370: dm.DeviceGroup.groupInfoCreate:output_type -> dm.WithID
	104, // 371: dm.DeviceGroup.groupInfoIndex:output_type -> dm.GroupInfoIndexResp
	101, // 372: dm.DeviceGroup.groupInfoRead:output_type -> dm.GroupInfo
	0,   // 373: dm.DeviceGroup.groupInfoUpdate:output_type -> dm.Empty
	0,   // 374: dm.DeviceGroup.groupInfoDelete:output_type -> dm.Empty
	0,   // 375: dm.DeviceGroup.groupDeviceMultiCreate:output_type -> dm.Empty
	0,   // 376: dm.DeviceGroup.groupDeviceMultiUpdate:output_type -> dm.Empty
	108, // 377: dm.DeviceGroup.groupDeviceIndex:output_type -> dm.GroupDeviceIndexResp
	0,   // 378: dm.DeviceGroup.groupDeviceMultiDelete:output_type -> dm.Empty
	0,   // 379: dm.RemoteConfig.RemoteConfigCreate:output_type -> dm.Empty
	86,  // 380: dm.RemoteConfig.RemoteConfigIndex:output_type -> dm.RemoteConfigIndexResp
	0,   // 381: dm.RemoteConfig.RemoteConfigPushAll:output_type -> dm.Empty
	89,  // 382: dm.RemoteConfig.RemoteConfigLastRead:output_type -> dm.RemoteConfigLastReadResp
	67,  // 383: dm.DeviceMsg.sdkLogIndex:output_type -> dm.SdkLogIndexResp
	58,  // 384: dm.DeviceMsg.hubLogIndex:output_type -> dm.HubLogIndexResp
	64,  // 385: dm.DeviceMsg.sendLogIndex:output_type -> dm.SendLogIndexResp
	61,  // 386: dm.DeviceMsg.statusLogIndex:output_type -> dm.StatusLogIndexResp
	53,  // 387: dm.DeviceMsg.propertyLogLatestIndex:output_type -> dm.PropertyLogIndexResp
	53,  // 388: dm.DeviceMsg.propertyLogIndex:output_type -> dm.PropertyLogIndexResp
	56,  // 389: dm.DeviceMsg.eventLogIndex:output_type -> dm.EventLogIndexResp
	46,  // 390: dm.DeviceMsg.shadowIndex:output_type -> dm.ShadowIndexResp
	100, // 391: dm.DeviceMsg.gatewayCanBindIndex:output_type -> dm.GatewayCanBindIndexResp
	70,  // 392: dm.DeviceInteract.actionSend:output_type -> dm.ActionSendResp
	70,  // 393: dm.DeviceInteract.actionRead:output_type -> dm.ActionSendResp
	0,   // 394: dm.DeviceInteract.actionResp:output_type -> dm.Empty
	49,  // 395: dm.DeviceInteract.propertyGetReportSend:output_type -> dm.PropertyGetReportSendResp
	75,  // 396: dm.DeviceInteract.propertyControlSend:output_type -> dm.PropertyControlSendResp
	82,  // 397: dm.DeviceInteract.propertyControlMultiSend:output_type -> dm.PropertyControlMultiSendResp
	75,  // 398: dm.DeviceInteract.propertyControlRead:output_type -> dm.PropertyControlSendResp
	79,  // 399: dm.DeviceInteract.sendMsg:output_type -> dm.SendMsgResp
	0,   // 400: dm.DeviceInteract.gatewayGetFoundSend:output_type -> dm.Empty
	0,   // 401: dm.DeviceInteract.gatewayNotifyBindSend:output_type -> dm.Empty
	7,   // 402: dm.OtaManage.otaFirmwareInfoCreate:output_type -> dm.WithID
	7,   // 403: dm.OtaManage.otaFirmwareInfoUpdate:output_type -> dm.WithID
	0,   // 404: dm.OtaManage.otaFirmwareInfoDelete:output_type -> dm.Empty
	177, // 405: dm.OtaManage.otaFirmwareInfoIndex:output_type -> dm.OtaFirmwareInfoIndexResp
	178, // 406: dm.OtaManage.otaFirmwareInfoRead:output_type -> dm.OtaFirmwareInfo
	7,   // 407: dm.OtaManage.otaFirmwareJobCreate:output_type -> dm.WithID
	183, // 408: dm.OtaManage.otaFirmwareJobIndex:output_type -> dm.OtaFirmwareJobIndexResp
	179, // 409: dm.OtaManage.otaFirmwareJobRead:output_type -> dm.OtaFirmwareJobInfo
	0,   // 410: dm.OtaManage.otaFirmwareJobUpdate:output_type -> dm.Empty
	187, // 411: dm.OtaManage.otaFirmwareDeviceIndex:output_type -> dm.OtaFirmwareDeviceIndexResp
	0,   // 412: dm.OtaManage.otaFirmwareDeviceCancel:output_type -> dm.Empty
	0,   // 413: dm.OtaManage.otaFirmwareDeviceRetry:output_type -> dm.Empty
	0,   // 414: dm.OtaManage.otaFirmwareDeviceConfirm:output_type -> dm.Empty
	7,   // 415: dm.OtaManage.otaModuleInfoCreate:output_type -> dm.WithID
	0,   // 416: dm.OtaManage.otaModuleInfoUpdate:output_type -> dm.Empty
	0,   // 417: dm.OtaManage.otaModuleInfoDelete:output_type -> dm.Empty
	12,  // 418: dm.OtaManage.otaModuleInfoIndex:output_type -> dm.OtaModuleInfoIndexResp
	13,  // 419: dm.OtaManage.otaModuleInfoRead:output_type -> dm.OtaModuleInfo
	0,   // 420: dm.userDevice.userDeviceCollectMultiCreate:output_type -> dm.Empty
	0,   // 421: dm.userDevice.userDeviceCollectMultiDelete:output_type -> dm.Empty
	31,  // 422: dm.userDevice.userDeviceCollectIndex:output_type -> dm.UserDeviceCollectSave
	7,   // 423: dm.userDevice.userDeviceShareCreate:output_type -> dm.WithID
	0,   // 424: dm.userDevice.userDeviceShareUpdate:output_type -> dm.Empty
	0,   // 425: dm.userDevice.userDeviceShareDelete:output_type -> dm.Empty
	0,   // 426: dm.userDevice.userDeviceShareMultiDelete:output_type -> dm.Empty
	23,  // 427: dm.userDevice.userDeviceShareIndex:output_type -> dm.UserDeviceShareIndexResp
	25,  // 428: dm.userDevice.userDeviceShareRead:output_type -> dm.UserDeviceShareInfo
	0,   // 429: dm.userDevice.userDeviceTransfer:output_type -> dm.Empty
	29,  // 430: dm.userDevice.userDeviceShareMultiCreate:output_type -> dm.UserDeviceShareMultiToken
	28,  // 431: dm.userDevice.userDeivceShareMultiIndex:output_type -> dm.UserDeviceShareMultiInfo
	0,   // 432: dm.userDevice.userDeivceShareMultiAccept:output_type -> dm.Empty
	306, // [306:433] is the sub-list for method output_type
	179, // [179:306] is the sub-list for method input_type
