...
const (
	...
	DeviceMsg_PropertyAgg2Index_FullMethodName       = "/dm.DeviceMsg/propertyAgg2Index"
...
func (c *deviceMsgClient) PropertyAgg2Index(ctx context.Context, in *PropertyAgg2IndexReq, opts ...grpc.CallOption) (*PropertyAggIndexResp, error) {
	out := new(PropertyAggIndexResp)
	err := c.cc.Invoke(ctx, DeviceMsg_PropertyAgg2Index_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceMsgServer interface {
	...
	PropertyAgg2Index(context.Context, *PropertyAgg2IndexReq) (*PropertyAggIndexResp, error)
	// 获取设备数据信息
...
func (UnimplementedDeviceMsgServer) PropertyAgg2Index(context.Context, *PropertyAgg2IndexReq) (*PropertyAggIndexResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PropertyAgg2Index not implemented")
}
...
func _DeviceMsg_PropertyAgg2Index_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PropertyAgg2IndexReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceMsgServer).PropertyAgg2Index(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceMsg_PropertyAgg2Index_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceMsgServer).PropertyAgg2Index(ctx, req.(*PropertyAgg2IndexReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeviceMsg_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "propertyAgg2Index",
			Handler:    _DeviceMsg_PropertyAgg2Index_Handler,
		},
		{
