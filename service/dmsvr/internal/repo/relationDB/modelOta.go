...
type DmOtaFirmwareDevice struct {
	...
	JobID           int64                          `gorm:"column:job_id;index:idx_dm_ota_firmware_device_job_deleted_device;uniqueIndex:idx_dm_ota_firmware_device_tc_un;type:BIGINT" `            // 升级批次ID
	ProductID       string                         `gorm:"column:product_id;type:varchar(20);uniqueIndex:idx_dm_ota_firmware_device_tc_un;index:idx_dm_ota_fw_device_report_lookup,priority:1"`    // 设备所属产品的productID
	DeviceName      string                         `gorm:"column:device_name;index:idx_dm_ota_firmware_device_job_deleted_device;type:varchar(100);uniqueIndex:idx_dm_ota_firmware_device_tc_un;index:idx_dm_ota_fw_device_report_lookup,priority:2" ` // 设备名称
	...
	Status          msgOta.DeviceStatus            `gorm:"column:status;index;type:BIGINT;index:idx_dm_ota_fw_device_report_lookup,priority:3"`                                                    // 设备升级作业状态。1：待确认。 2：待推送。 3：已推送。  4：升级中。 5:升级成功 6: 升级失败. 7:已取消
	...
	DeletedTime stores.DeletedTime   `gorm:"column:deleted_time;default:0;index:idx_dm_ota_firmware_device_job_deleted_device;uniqueIndex:idx_dm_ota_firmware_device_tc_un;index:idx_dm_ota_fw_device_report_lookup,priority:5"`
