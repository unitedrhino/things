...
type DmDeviceInfo struct {
	...
	ProductID       string              `gorm:"column:product_id;type:varchar(100);uniqueIndex:idx_product_id_deviceName;NOT NULL"`  // 产品id
	DeviceName      string              `gorm:"column:device_name;uniqueIndex:idx_product_id_deviceName;type:varchar(100);NOT NULL"` // 设备名称
	...
	DeletedTime stores.DeletedTime      `gorm:"column:deleted_time;default:0;uniqueIndex:idx_product_id_deviceName"`
...
type DmDeviceMsgCount struct {
	ID   int64             `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	Type deviceLog.MsgType `gorm:"column:type;index;type:VARCHAR(50);uniqueIndex:idx_date_type;NOT NULL"` // 消息类型
	Num  int64             `gorm:"column:num;type:bigint;default:0"`                                      //数量
	Date time.Time         `gorm:"column:date;NOT NULL;uniqueIndex:idx_date_type"`                        //统计的日期
	stores.OnlyTime
}
...
type DmDeviceModuleVersion struct {
	...
	ProductID  string `gorm:"column:product_id;type:varchar(100);uniqueIndex:idx_product_id_deviceName;NOT NULL"`  // 产品id
	DeviceName string `gorm:"column:device_name;uniqueIndex:idx_product_id_deviceName;type:varchar(100);NOT NULL"` // 设备名称
	ModuleCode string `gorm:"column:module_code;type:varchar(64);uniqueIndex:idx_product_id_deviceName"`           // 固件名称
	Version    string `gorm:"column:version;type:varchar(64);NOT NULL;uniqueIndex:idx_product_id_deviceName"`      // 固件版本
	stores.NoDelTime
}
...
type DmDeviceProfile struct {
	...
	ProductID  string              `gorm:"column:product_id;type:varchar(100);uniqueIndex:idx_tc_un;NOT NULL"`  // 产品id
	DeviceName string              `gorm:"column:device_name;uniqueIndex:idx_tc_un;type:varchar(100);NOT NULL"` // 设备名称
...
type DmProductCategory struct {
	ID          int64                      `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	Name        string                     `gorm:"column:name;uniqueIndex:idx_pn;type:varchar(100);NOT NULL"` // 产品品类名称
	Desc        string                     `gorm:"column:desc;type:varchar(200)"`                             // 描述
	...
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_pn"`
}
...
type DmProductCategorySchema struct {
	ID                int64  `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	ProductCategoryID int64  `gorm:"column:product_category_id;uniqueIndex:idx_pn;type:bigint;NOT NULL"` // 产品品类id
	Identifier        string `gorm:"column:identifier;type:varchar(200);uniqueIndex:idx_pn"`             // 标识符的id
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_pn"`
}
...
type DmProtocolInfo struct {
	ID                  int64                 `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	Name                string                `gorm:"column:name;uniqueIndex:idx_pn;type:varchar(100);NOT NULL"`             // 协议名称
	Code                string                `gorm:"column:code;uniqueIndex:idx_pc;type:varchar(100);NOT NULL"`             // iThings,iThings-thingsboard,wumei,aliyun,huaweiyun,tuya
	...
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_pc;uniqueIndex:idx_pn"`
}
...
type DmProtocolService struct {
	ID     int64  `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	Code   string `gorm:"column:code;uniqueIndex:idx_pc;type:varchar(100);default:iThings"` //
	Ip     string `gorm:"column:ip;uniqueIndex:idx_pc;type:varchar(100);not null"`          //
	Port   int64  `gorm:"column:port;uniqueIndex:idx_pc;type:varchar(200)"`                 //
...
type DmProtocolScript struct {
	ID   int64  `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	Name string `gorm:"column:name;uniqueIndex:idx_name;type:varchar(100);not null"` //转换名称
...
type DmProductCustom struct {
	ID              int64                        `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	ProductID       string                       `gorm:"column:product_id;uniqueIndex:idx_pn;type:varchar(100);NOT NULL"` // 产品id
...
type DmProductSchema struct {
	ID        int64  `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	ProductID string `gorm:"column:product_id;uniqueIndex:idx_identifier;index:product_id_type;type:varchar(100);NOT NULL"` // 产品id
	DmSchemaCore
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_identifier"`
	ProductInfo *DmProductInfo     `gorm:"foreignKey:ProductID;references:ProductID"`
}
...
type DmDeviceSchema struct {
	ID         int64  `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	ProductID  string `gorm:"column:product_id;uniqueIndex:idx_identifier;index:product_id_type;type:varchar(100);NOT NULL"`      // 产品id
	DeviceName string `gorm:"column:device_name;uniqueIndex:idx_identifier;index:product_id_type;type:varchar(100);default:null"` // 产品id
	DmSchemaCore
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_identifier"`
}
...
type DmSchemaInfo struct {
	ID         int64          `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	ProductID  string         `gorm:"column:product_id;uniqueIndex:idx_identifier;index:product_id_type;type:varchar(100);NOT NULL"`      // 产品id
	DeviceName sql.NullString `gorm:"column:device_name;uniqueIndex:idx_identifier;index:product_id_type;type:varchar(100);default:null"` // 产品id
	DmSchemaCore
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_identifier"`
}
...
type DmSchemaCore struct {
	...
	Identifier        string     `gorm:"column:identifier;uniqueIndex:idx_identifier;type:varchar(100);NOT NULL"` // 标识符
...
type DmGroupInfo struct {
	...
	TenantCode dataType.TenantCode `gorm:"column:tenant_code;uniqueIndex:idx_tc_ac;default:default;type:VARCHAR(50);NOT NULL"` // 租户编码
	Purpose    string              `gorm:"column:purpose;uniqueIndex:idx_tc_ac;type:varchar(100);default:'default'"`           //用途 不填默认为default
	ProjectID  dataType.ProjectID  `gorm:"column:project_id;uniqueIndex:idx_tc_ac;type:bigint;default:2;NOT NULL"`             // 项目ID(雪花ID)
	AreaID     dataType.AreaID     `gorm:"column:area_id;uniqueIndex:idx_tc_ac;type:bigint;default:2;NOT NULL"`                // 项目区域ID(雪花ID)
	...
	Name       string              `gorm:"column:name;uniqueIndex:idx_tc_ac;default:'';type:varchar(100);NOT NULL"`            // 分组名称
...
type DmGroupDevice struct {
	...
	AreaID      dataType.AreaID     `gorm:"column:area_id;index:project_id_area_id;type:bigint;default:0;NOT NULL"`                             // 项目区域ID(雪花ID)
	GroupID     int64               `gorm:"column:group_id;uniqueIndex:idx_group_id_product_id_device_name;type:bigint;NOT NULL"`               // 分组ID
	GroupIDPath string              `gorm:"column:group_id_path;type:varchar(100);default:''"`                                                  // 1-2-3-的格式记录顶级区域到当前区域的路径
	Purpose     string              `gorm:"column:purpose;uniqueIndex:idx_group_id_product_id_device_name;type:varchar(100);default:'default'"` //用途 不填默认为default
	ProductID   string              `gorm:"column:product_id;uniqueIndex:idx_group_id_product_id_device_name;type:varchar(100);NOT NULL"`       // 产品id
	DeviceName  string              `gorm:"column:device_name;uniqueIndex:idx_group_id_product_id_device_name;type:varchar(100);NOT NULL"`      // 设备名称
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_group_id_product_id_device_name"`
	ProductInfo *DmProductInfo     `gorm:"foreignKey:ProductID;references:ProductID"`
...
type DmGatewayDevice struct {
	...
	ProductID         string `gorm:"column:product_id;uniqueIndex:idx_gpi_pdn_pi_dn;type:varchar(100);NOT NULL"`  // 子设备产品id
	DeviceName        string `gorm:"column:device_name;uniqueIndex:idx_gpi_pdn_pi_dn;type:varchar(100);NOT NULL"` // 子设备名称
	stores.NoDelTime
	DeletedTime stores.DeletedTime `gorm:"column:deleted_time;default:0;uniqueIndex:idx_gpi_pdn_pi_dn"`
	Device      *DmDeviceInfo      `gorm:"foreignKey:ProductID,DeviceName;references:ProductID,DeviceName"`
...
type DmDeviceShadow struct {
	ID                int64        `gorm:"column:id;type:BIGINT;primary_key;AUTO_INCREMENT"`
	ProductID         string       `gorm:"column:product_id;uniqueIndex:idx_pi_dn_di;type:varchar(100);NOT NULL"`
	DeviceName        string       `gorm:"column:device_name;uniqueIndex:idx_pi_dn_di;type:VARCHAR(100);NOT NULL"`
	DataID            string       `gorm:"column:data_id;uniqueIndex:idx_pi_dn_di;type:VARCHAR(100);NOT NULL"`
