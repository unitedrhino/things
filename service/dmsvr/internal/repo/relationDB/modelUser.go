...
type DmUserDeviceCollect struct {
	...
	UserID     int64               `gorm:"column:user_id;type:BIGINT;uniqueIndex:idx_product_id_deviceName;NOT NULL"`           // 问题提出的用户
...
type DmUserDeviceShare struct {
	ID                int64               `gorm:"column:id;type:bigint;primary_key;AUTO_INCREMENT"`
	TenantCode        dataType.TenantCode `gorm:"column:tenant_code;index;type:VARCHAR(50);NOT NULL"`                               // 租户编码
	SharedUserID      int64               `gorm:"column:shared_user_id;type:BIGINT;uniqueIndex:idx_product_id_deviceName;NOT NULL"` // 分享对象的用户ID
